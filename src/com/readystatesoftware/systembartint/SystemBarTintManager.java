...
_L3:
        ...
        SystemBarConfig(Activity activity, boolean flag, boolean flag1, SystemBarConfig systembarconfig)
        {
    ...
    public SystemBarTintManager(Activity activity)
    {
        ...
        mConfig = new SystemBarConfig(activity, mStatusBarAvailable, mNavBarAvailable, null);
