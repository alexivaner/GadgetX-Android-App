...
_L10:
        ...
        if ((j != 3 || xmlpullparser.getDepth() > k) && j != 1) goto _L2; else goto _L1
_L1:
...
_L8:
        if (xmlpullparser.hasNext()) goto _L6; else goto _L5
_L5:
        if (i != 0)
        {
...
_L2:
        if (j == 2)
        {
            ...
            if (((String) (obj)).equals("set"))
            {
                ...
                createAnimatorFromXml(context, xmlpullparser, attributeset, (AnimatorSet)obj, j);
...
_L6:
        context[j] = (Animator)xmlpullparser.next();
        j++;
...
_L9:
        ...
        throws android.content.res.Resources.NotFoundException
    {
        ...
        context;
        obj = obj1;
        obj2 = new android.content.res.Resources.NotFoundException((new StringBuilder("Can't load animation resource ID #0x")).append(Integer.toHexString(i)).toString());
        obj = obj1;
        ...
        context;
        obj = obj2;
        obj1 = new android.content.res.Resources.NotFoundException((new StringBuilder("Can't load animation resource ID #0x")).append(Integer.toHexString(i)).toString());
        obj = obj2;
