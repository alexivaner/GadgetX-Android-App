    ...
    implements android.content.ask._cls1._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/KomentarPonsel$KomentarReplyAsycTask$1

/* anonymous class */
    class KomentarPonsel.KomentarReplyAsycTask._cls1
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                KomentarPonsel.KomentarReplyAsycTask.access$2(KomentarPonsel.KomentarReplyAsycTask.this).statuslike = "1";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new KomentarPonsel.KomentarReplyAsycTask._cls1._cls1());
                view.setNeutralButton("Register", new KomentarPonsel.KomentarReplyAsycTask._cls1._cls2());
                view.setNegativeButton("Login", new KomentarPonsel.KomentarReplyAsycTask._cls1._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/KomentarPonsel$KomentarReplyAsycTask$1$1

/* anonymous class */
        class KomentarPonsel.KomentarReplyAsycTask._cls1._cls1
        ...
        // Unreferenced inner class com/inponsel/android/v2/KomentarPonsel$KomentarReplyAsycTask$1$2

/* anonymous class */
        class KomentarPonsel.KomentarReplyAsycTask._cls1._cls2
            implements android.content.DialogInterface.OnClickListener
        {
