...
_L1:
        if (RSSFeedByTag.access$0(RSSFeedByTag.this).size() < 10)
        {
...
_L9:
        ...
        try
        {
            ...
            {
                this$1 = RSSFeedByTag.RSSAsycTask.this;
                super();
            }
                });
...
_L10:
        if (!fav_stat.toString().equals("1")) goto _L8; else goto _L7
_L7:
...
_L12:
        ...
        RSSFeedByTag.access$3(RSSFeedByTag.this).addView(void1);
