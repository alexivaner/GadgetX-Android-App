    ...
    implements android.widget.kListener
{
    ...
    public void onItemClick(AdapterView adapterview, View view, int i, long l)
    {
        ...
        id_hph = topRateAdapter.getListModel(i).getId_hp().toString();
        model = topRateAdapter.getListModel(i).getModel().toString();
        merk = topRateAdapter.getListModel(i).getMerk().toString();
        gambar = topRateAdapter.getListModel(i).getGambar().toString();
        tot_like = topRateAdapter.getListModel(i).getTotal_like().toString();
        tot_dislike = topRateAdapter.getListModel(i).getTotal_dislike().toString();
        tot_komen = topRateAdapter.getListModel(i).getTotal_kom().toString();
        hrg_baru = topRateAdapter.getListModel(i).getHrg_baru().toString();
        hrg_bekas = topRateAdapter.getListModel(i).getHrg_bekas().toString();
        codename = topRateAdapter.getListModel(i).getCodename().toString();
