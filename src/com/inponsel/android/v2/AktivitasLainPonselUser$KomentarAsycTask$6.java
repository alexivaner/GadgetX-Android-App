    ...
    implements android.view.AsycTask._cls6
{
    ...
    public void onClick(View view)
    {
        try
        {
            ...
            cess._mth2(this._cls1.this).urlKomenLast = (new StringBuilder(String.valueOf(Util.BASE_PATH2))).append("user_aktivitas_ponsel").append(Utility.BASE_FORMAT).append("?lmt=").append(cess._mth2(this._cls1.this).limit).append("&t=").append(cess._mth2(this._cls1.this).t).append("&idusr=").append(cess._mth2(this._cls1.this).str_id_user).append("&top_id=").append(cess._mth2(this._cls1.this).top_id).toString();
