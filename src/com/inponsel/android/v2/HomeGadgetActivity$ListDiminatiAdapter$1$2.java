    ...
    implements android.content.ter._cls1._cls2
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/HomeGadgetActivity$ListDiminatiAdapter$1

/* anonymous class */
    class HomeGadgetActivity.ListDiminatiAdapter._cls1
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new HomeGadgetActivity.ListDiminatiAdapter._cls1._cls1());
                view.setNeutralButton("Register", new HomeGadgetActivity.ListDiminatiAdapter._cls1._cls2());
                view.setNegativeButton("Login", new HomeGadgetActivity.ListDiminatiAdapter._cls1._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/HomeGadgetActivity$ListDiminatiAdapter$1$1

/* anonymous class */
        class HomeGadgetActivity.ListDiminatiAdapter._cls1._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final HomeGadgetActivity.ListDiminatiAdapter._cls1 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = HomeGadgetActivity.ListDiminatiAdapter._cls1.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/v2/HomeGadgetActivity$ListDiminatiAdapter$1$3

/* anonymous class */
        class HomeGadgetActivity.ListDiminatiAdapter._cls1._cls3
            implements android.content.DialogInterface.OnClickListener
        {
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface = new Intent(HomeGadgetActivity.ListDiminatiAdapter.access$0(this$1), com/inponsel/android/v2/LoginActivity);
