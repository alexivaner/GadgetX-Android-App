...
class this._cls2
    implements android.content.ask._cls2._cls2
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/PlaystoreKategoriKomen$KomentarNextAsycTask$2

/* anonymous class */
    class PlaystoreKategoriKomen.KomentarNextAsycTask._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                PlaystoreKategoriKomen.KomentarNextAsycTask.access$2(PlaystoreKategoriKomen.KomentarNextAsycTask.this).statuslike = "0";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new PlaystoreKategoriKomen.KomentarNextAsycTask._cls2._cls1());
                view.setNeutralButton("Register", new PlaystoreKategoriKomen.KomentarNextAsycTask._cls2._cls2());
                view.setNegativeButton("Login", new PlaystoreKategoriKomen.KomentarNextAsycTask._cls2._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/PlaystoreKategoriKomen$KomentarNextAsycTask$2$1

/* anonymous class */
        class PlaystoreKategoriKomen.KomentarNextAsycTask._cls2._cls1
        ...
        // Unreferenced inner class com/inponsel/android/v2/PlaystoreKategoriKomen$KomentarNextAsycTask$2$3

/* anonymous class */
        class PlaystoreKategoriKomen.KomentarNextAsycTask._cls2._cls3
            implements android.content.DialogInterface.OnClickListener
        {
