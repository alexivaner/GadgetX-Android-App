...
class this._cls2
    implements android.content.ter._cls1._cls5
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/MerekActivity$ListPendatangAdapter$1

/* anonymous class */
    class MerekActivity.ListPendatangAdapter._cls1
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            if (userFunctions.isUserLoggedIn(MerekActivity.ListPendatangAdapter.access$0(MerekActivity.ListPendatangAdapter.this)))
            {
                ...
                view.setPositiveButton("Ya", new MerekActivity.ListPendatangAdapter._cls1._cls1());
                view.setNegativeButton("Tidak", new MerekActivity.ListPendatangAdapter._cls1._cls2());
                view.show();
                return;
            } else
            {
                ...
                view.setPositiveButton("Tutup", new MerekActivity.ListPendatangAdapter._cls1._cls3());
                view.setNeutralButton("Register", new MerekActivity.ListPendatangAdapter._cls1._cls4());
                view.setNegativeButton("Login", new MerekActivity.ListPendatangAdapter._cls1._cls5());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/MerekActivity$ListPendatangAdapter$1$1

/* anonymous class */
        class MerekActivity.ListPendatangAdapter._cls1._cls1
        ...
        // Unreferenced inner class com/inponsel/android/v2/MerekActivity$ListPendatangAdapter$1$2

/* anonymous class */
        class MerekActivity.ListPendatangAdapter._cls1._cls2
            implements android.content.DialogInterface.OnClickListener
        {
        ...
        // Unreferenced inner class com/inponsel/android/v2/MerekActivity$ListPendatangAdapter$1$3

/* anonymous class */
        class MerekActivity.ListPendatangAdapter._cls1._cls3
            implements android.content.DialogInterface.OnClickListener
        {
        ...
        // Unreferenced inner class com/inponsel/android/v2/MerekActivity$ListPendatangAdapter$1$4

/* anonymous class */
        class MerekActivity.ListPendatangAdapter._cls1._cls4
            implements android.content.DialogInterface.OnClickListener
        {
