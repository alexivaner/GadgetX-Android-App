...
_L1:
    ...
    protected void onPostExecute(String s)
    {
        ...
        RoomShareLocationActivity.access$0(RoomShareLocationActivity.this).addMarker((new MarkerOptions()).position(latLng).title(s).snippet(String.valueOf((new StringBuilder()).append(getlatitude).append(",").append(getlongitude).toString()))).showInfoWindow();
        RoomShareLocationActivity.access$0(RoomShareLocationActivity.this).setOnInfoWindowClickListener(new com.google.android.gms.maps.GoogleMap.OnInfoWindowClickListener() {
