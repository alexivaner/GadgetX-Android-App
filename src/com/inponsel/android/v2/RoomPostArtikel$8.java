    ...
    public void onClick(View view)
    {
        if (netInfo != null && netInfo.isConnected())
        {
            ...
            if (photo_upload == null)
            {
                ...
                RoomPostArtikel.access$0(RoomPostArtikel.this).setContentTitle(edtJudulAskHp.getText().toString()).setContentText("Mengirim artikel... - 0%").setSmallIcon(0x7f0201e4);
                try
                {
            ...
            if (android.os.INT >= 11)
            {
                try
                {
                    (new loadImage(RoomPostArtikel.this, null)).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Void[0]).get(90L, TimeUnit.SECONDS);
                    return;
                }
                // Misplaced declaration of an exception variable
                catch (View view)
            ...
            try
            {
                (new loadImage(RoomPostArtikel.this, null)).execute(new Void[0]).get(90L, TimeUnit.SECONDS);
                return;
            }
            // Misplaced declaration of an exception variable
            catch (View view)
