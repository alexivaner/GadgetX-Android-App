    ...
    implements android.content.ask._cls3._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/PlaystoreKategoriKomen$KomentarAsycAfterTask$3

/* anonymous class */
    class PlaystoreKategoriKomen.KomentarAsycAfterTask._cls3
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                PlaystoreKategoriKomen.KomentarAsycAfterTask.access$2(PlaystoreKategoriKomen.KomentarAsycAfterTask.this).statuslike = "1";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new PlaystoreKategoriKomen.KomentarAsycAfterTask._cls3._cls1());
                view.setNeutralButton("Register", new PlaystoreKategoriKomen.KomentarAsycAfterTask._cls3._cls2());
                view.setNegativeButton("Login", new PlaystoreKategoriKomen.KomentarAsycAfterTask._cls3._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/PlaystoreKategoriKomen$KomentarAsycAfterTask$3$1

/* anonymous class */
        class PlaystoreKategoriKomen.KomentarAsycAfterTask._cls3._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final PlaystoreKategoriKomen.KomentarAsycAfterTask._cls3 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = PlaystoreKategoriKomen.KomentarAsycAfterTask._cls3.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/v2/PlaystoreKategoriKomen$KomentarAsycAfterTask$3$2

/* anonymous class */
        class PlaystoreKategoriKomen.KomentarAsycAfterTask._cls3._cls2
            implements android.content.DialogInterface.OnClickListener
        {
