    ...
    implements android.widget.kListener
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/RegisterActivity$10

/* anonymous class */
    class RegisterActivity._cls10
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            if (providerArray.size() != 0)
            {
                ...
                listHp.setOnItemClickListener(new RegisterActivity._cls10._cls1());
            } else
            {
                ...
                listHp.setOnItemClickListener(new RegisterActivity._cls10._cls2());
            }
            dialog = view.create();
            dialog.show();
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/RegisterActivity$10$2

/* anonymous class */
        class RegisterActivity._cls10._cls2
