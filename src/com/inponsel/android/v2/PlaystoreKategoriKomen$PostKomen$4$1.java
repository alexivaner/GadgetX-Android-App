...
class this._cls2
    implements android.content.men._cls4._cls1
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/PlaystoreKategoriKomen$PostKomen$4

/* anonymous class */
    class PlaystoreKategoriKomen.PostKomen._cls4
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                PlaystoreKategoriKomen.PostKomen.access$2(PlaystoreKategoriKomen.PostKomen.this).statuslike = "0";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new PlaystoreKategoriKomen.PostKomen._cls4._cls1());
                view.setNeutralButton("Register", new PlaystoreKategoriKomen.PostKomen._cls4._cls2());
                view.setNegativeButton("Login", new PlaystoreKategoriKomen.PostKomen._cls4._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/PlaystoreKategoriKomen$PostKomen$4$2

/* anonymous class */
        class PlaystoreKategoriKomen.PostKomen._cls4._cls2
            implements android.content.DialogInterface.OnClickListener
        {

            final PlaystoreKategoriKomen.PostKomen._cls4 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                ...
                PlaystoreKategoriKomen.PostKomen.access$2(this$1).startActivity(dialoginterface);
                    ...
                    {
                        this$2 = PlaystoreKategoriKomen.PostKomen._cls4.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/v2/PlaystoreKategoriKomen$PostKomen$4$3

/* anonymous class */
        class PlaystoreKategoriKomen.PostKomen._cls4._cls3
            implements android.content.DialogInterface.OnClickListener
        {
