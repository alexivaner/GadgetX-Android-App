...
public class ReplyFormActivity extends SherlockFragmentActivity
    implements Observer
{
    private static class EmoticonAdapter extends BaseAdapter
    {
        ...
        public int getCount()
        {
            return ReplyFormActivity.emotname.length;
        }
        ...
        public View getView(int j, View view, ViewGroup viewgroup)
        {
            ...
            ((ViewHolder) (viewgroup)).mTextView.setText(ReplyFormActivity.emotname[j]);
            return view;
        }
    ...
    public class SendMailTask extends AsyncTask
    {
        ...
        protected transient Void doInBackground(Void avoid[])
        {
            try
            {
                ...
                avoid = (new StringBuilder(String.valueOf(Util.BASE_PATH2))).append("mail_tanggap_com").append(Utility.BASE_FORMAT).append("?").append(querypopkomen).append("&dens=").append(getResources().getDisplayMetrics().density).toString();
...
_L8:
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        try
        {
            ...
            bundle.setScreenName("Tanggapan Komentar Ponsel");
        ...
        listEmot.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
            ...
            {
                edt_pop_komen.setImageInsertGrid(ReplyFormActivity.emotname[l]);
            }
        ...
        userpict = (new StringBuilder(String.valueOf(Util.BASE_PATH_AVATAR))).append(extras.getString("userpict")).toString();
        t = Utility.session(t);
        Log.e("nmlngkap", (new StringBuilder(String.valueOf(nmlengkap))).append("|").append(userpict).toString());
            ...
            public void onClick(View view)
            {
                if (photo_upload == null)
                {
                    if (imgAskHp.getVisibility() == 0)
                    {
                        ...
                        mBuilder = new android.support.v4.app.NotificationCompat.Builder(ReplyFormActivity.this);
