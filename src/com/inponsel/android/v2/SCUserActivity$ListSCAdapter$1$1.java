    ...
    implements android.content.ter._cls1._cls1
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/SCUserActivity$ListSCAdapter$1

/* anonymous class */
    class SCUserActivity.ListSCAdapter._cls1
        implements android.view.View.OnClickListener
    {
        ...
        {
            view = new android.app.AlertDialog.Builder(SCUserActivity.ListSCAdapter.access$0(SCUserActivity.ListSCAdapter.this));
            view.setTitle("Nomor Telepon :");
            view.setSingleChoiceItems(no_telp_array, -1, new SCUserActivity.ListSCAdapter._cls1._cls1());
            view.show();
        }
