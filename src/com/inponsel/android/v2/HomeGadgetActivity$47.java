...
class r extends AsyncHttpResponseHandler
{
    ...
    public void onSuccess(int i, Header aheader[], byte abyte0[])
    {
        ...
        image_news1.setLayoutParams(new android.widget.arams((int)final_width, (int)final_height));
        rl_root_news.setLayoutParams(new android.widget.arams((int)final_width, (int)final_height));
