    ...
    implements android.widget.ItemClickListener
{
    ...
    public void onItemClick(final AdapterView i, View view, int j, long l)
    {
        ...
        i.putExtra("tag_code", "4");
        i.putExtra("tag_key", langganOpAdapter.getListModel(j).getId_hp());
        i.putExtra("kategori_tag", langganOpAdapter.getListModel(j).getMerk());
        mDrawerLayout.closeDrawers();
        (new Handler()).postDelayed(new Runnable() {

            final BaseDrawer._cls21 this$1;
