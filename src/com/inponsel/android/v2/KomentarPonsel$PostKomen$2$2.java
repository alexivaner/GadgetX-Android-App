    ...
    implements android.content.er
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/KomentarPonsel$PostKomen$2

/* anonymous class */
    class KomentarPonsel.PostKomen._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                KomentarPonsel.PostKomen.access$2(KomentarPonsel.PostKomen.this).statuslike = "0";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new KomentarPonsel.PostKomen._cls2._cls1());
                view.setNeutralButton("Register", new KomentarPonsel.PostKomen._cls2._cls2());
                view.setNegativeButton("Login", new KomentarPonsel.PostKomen._cls2._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/KomentarPonsel$PostKomen$2$1

/* anonymous class */
        class KomentarPonsel.PostKomen._cls2._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final KomentarPonsel.PostKomen._cls2 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = KomentarPonsel.PostKomen._cls2.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/v2/KomentarPonsel$PostKomen$2$3

/* anonymous class */
        class KomentarPonsel.PostKomen._cls2._cls3
            implements android.content.DialogInterface.OnClickListener
        {
