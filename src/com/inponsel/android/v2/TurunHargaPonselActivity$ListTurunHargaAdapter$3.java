...
//            TurunHargaPonselActivity, KomentarPonsel

class val.position
    implements android.view.aAdapter._cls3
{
    ...
    {
        view = new Intent(cess._mth1(this._cls1.this).getApplicationContext(), com/inponsel/android/v2/KomentarPonsel);
