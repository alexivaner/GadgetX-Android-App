...
//            HomeSelengkapActivity, RegisterActivity, LoginActivity
    ...
    implements android.content.ter._cls3._cls1
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/HomeSelengkapActivity$ListSelengkapAdapter$3

/* anonymous class */
    class HomeSelengkapActivity.ListSelengkapAdapter._cls3
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new HomeSelengkapActivity.ListSelengkapAdapter._cls3._cls1());
                view.setNeutralButton("Register", new HomeSelengkapActivity.ListSelengkapAdapter._cls3._cls2());
                view.setNegativeButton("Login", new HomeSelengkapActivity.ListSelengkapAdapter._cls3._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/HomeSelengkapActivity$ListSelengkapAdapter$3$2

/* anonymous class */
        class HomeSelengkapActivity.ListSelengkapAdapter._cls3._cls2
            implements android.content.DialogInterface.OnClickListener
        {

            final HomeSelengkapActivity.ListSelengkapAdapter._cls3 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                ...
                HomeSelengkapActivity.ListSelengkapAdapter.access$0(this$1).startActivity(dialoginterface);
                    ...
                    {
                        this$2 = HomeSelengkapActivity.ListSelengkapAdapter._cls3.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/v2/HomeSelengkapActivity$ListSelengkapAdapter$3$3

/* anonymous class */
        class HomeSelengkapActivity.ListSelengkapAdapter._cls3._cls3
            implements android.content.DialogInterface.OnClickListener
        {
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface = new Intent(HomeSelengkapActivity.ListSelengkapAdapter.access$0(this$1), com/inponsel/android/v2/LoginActivity);
