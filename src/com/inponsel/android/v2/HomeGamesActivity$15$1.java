    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/HomeGamesActivity$15

/* anonymous class */
    class HomeGamesActivity._cls15 extends AsyncHttpResponseHandler
    {
...
_L1:
            ...
            (new Handler()).postDelayed(new HomeGamesActivity._cls15._cls1(), 1000L);
            return;
_L2:
