        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            if (userFunctions.isUserLoggedIn(AppsByCategory.this))
            {
                ...
                (new AsyncHttpClient()).get(view, view. new AppsByCategory._cls5._cls1());
                return;
            } else
            {
                ...
                view.setPositiveButton("Tutup", new AppsByCategory._cls5._cls2());
                view.setNeutralButton("Register", new AppsByCategory._cls5._cls3());
                view.setNegativeButton("Login", new AppsByCategory._cls5._cls4());
                view.show();
                return;
            }
        }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/inponsel/android/v2/AppsByCategory$5$4

/* anonymous class */
        class AppsByCategory._cls5._cls4
            implements android.content.DialogInterface.OnClickListener
        {
