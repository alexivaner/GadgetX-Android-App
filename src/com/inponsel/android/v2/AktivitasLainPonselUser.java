...
public class AktivitasLainPonselUser extends SherlockFragmentActivity
    implements Observer
{
...
_L2:
            ...
            aktifitas_name = ((ItemKomenHp)mArrayListData.get(i)).getNama_komentar();
...
_L6:
    ...
    public AktivitasLainPonselUser()
    {
        dataNotifOnOff = "0";
        inponsel = null;
        suc = "";
...
_L2:
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        try
        {
            urlKomen = (new StringBuilder(String.valueOf(Util.BASE_PATH2))).append("user_aktivitas_ponsel").append(Utility.BASE_FORMAT).append("?lmt=").append(limit).append("&t=").append(t).append("&idusr=").append(str_id_user).toString();
