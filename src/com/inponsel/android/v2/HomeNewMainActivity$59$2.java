...
class this._cls1
    implements android.view.ivity._cls59._cls2
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/HomeNewMainActivity$59

/* anonymous class */
    class HomeNewMainActivity._cls59 extends AsyncHttpResponseHandler
    {
        ...
        public void onSuccess(int i, Header aheader[], byte abyte0[])
        {
            ...
            Picasso.with(HomeNewMainActivity.this).load(img_urlnews1).into(image_news1, new HomeNewMainActivity._cls59._cls1());
            image_news1.setOnClickListener(new HomeNewMainActivity._cls59._cls2());
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/HomeNewMainActivity$59$1

/* anonymous class */
        class HomeNewMainActivity._cls59._cls1
            implements Callback
        {
