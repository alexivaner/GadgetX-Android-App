...
_L5:
        Log.e("mArrayListData", String.valueOf(HomeForumActivity.access$0(HomeForumActivity.this).size()));
        Log.e("index_komposlike", idkom_pos);
        updateViewLikeDis(idkom_pos);
        if (android.os.os >= 11)
        {
            (new k(HomeForumActivity.this)).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Void[0]);
            return;
        }
...
label0:
        ...
        notificationLikeHelper.completed("Artikel Ponsel", notificationLikeHelper.dislikefrontKomen);
          goto _L5
        (new k(HomeForumActivity.this)).execute(new Void[0]);
        return;
