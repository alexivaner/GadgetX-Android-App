    ...
    implements android.content.ner
{
    ...
    public void onClick(DialogInterface dialoginterface, int i)
    {
        ...
        {
            MessageLocationActivity.access$1(_fld0, id_from, id_to, String.valueOf((new StringBuilder()).append(getlatitude).append(",").append(getlongitude).toString()), "", t, bottom_id);
            return;
        }
        try
        {
            MessageLocationActivity.access$1(_fld0, id_from, id_to, (new StringBuilder(String.valueOf(dress))).append("\n").append(String.valueOf((new StringBuilder(String.valueOf(latitude))).append(",").append(longitude).toString())).toString(), "", t, bottom_id);
            return;
        }
...
/* anonymous class */
        ...
        implements android.view.View.OnClickListener
    {
        ...
        // Unreferenced inner class com/inponsel/android/v2/MessageLocationActivity$5$2

/* anonymous class */
        class MessageLocationActivity._cls5._cls2
