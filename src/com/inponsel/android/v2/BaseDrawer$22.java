    ...
    implements android.widget.ItemClickListener
{
    ...
    public void onItemClick(final AdapterView i, View view, int j, long l)
    {
        ...
        i.putExtra("tag_code", "0");
        i.putExtra("tag_key", langganKatKhususAdapter.getListModel(j).getId_hp());
        i.putExtra("kategori_tag", langganKatKhususAdapter.getListModel(j).getMerk());
        mDrawerLayout.closeDrawers();
        (new Handler()).postDelayed(new Runnable() {

            final BaseDrawer._cls22 this$1;
