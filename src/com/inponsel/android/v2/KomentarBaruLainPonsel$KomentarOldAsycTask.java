...
_L3:
        ...
        if (!((ItemKomenHp)KomentarBaruLainPonsel.access$1(KomentarBaruLainPonsel.this).get(i)).getReply_to().toString().trim().equals("0")) goto _L6; else goto _L5
_L5:
...
_L9:
        ...
        img_kom_picture.setOnLongClickListener(new android.view.View.OnLongClickListener() {
            ...
            final KomentarBaruLainPonsel.KomentarOldAsycTask this$1;
            ...
            {
                this$1 = KomentarBaruLainPonsel.KomentarOldAsycTask.this;
                usr_pict_komen = s;
                super();
            }
        });
