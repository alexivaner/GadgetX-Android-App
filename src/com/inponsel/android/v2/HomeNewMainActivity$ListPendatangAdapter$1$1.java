    ...
    implements android.content.ter._cls1._cls1
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/HomeNewMainActivity$ListPendatangAdapter$1

/* anonymous class */
    class HomeNewMainActivity.ListPendatangAdapter._cls1
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new HomeNewMainActivity.ListPendatangAdapter._cls1._cls1());
                view.setNeutralButton("Register", new HomeNewMainActivity.ListPendatangAdapter._cls1._cls2());
                view.setNegativeButton("Login", new HomeNewMainActivity.ListPendatangAdapter._cls1._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/HomeNewMainActivity$ListPendatangAdapter$1$2

/* anonymous class */
        class HomeNewMainActivity.ListPendatangAdapter._cls1._cls2
            implements android.content.DialogInterface.OnClickListener
        {

            final HomeNewMainActivity.ListPendatangAdapter._cls1 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                ...
                HomeNewMainActivity.ListPendatangAdapter.access$1(this$1).overridePendingTransition(0x7f040003, 0x7f040004);
                    ...
                    {
                        this$2 = HomeNewMainActivity.ListPendatangAdapter._cls1.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/v2/HomeNewMainActivity$ListPendatangAdapter$1$3

/* anonymous class */
        class HomeNewMainActivity.ListPendatangAdapter._cls1._cls3
            implements android.content.DialogInterface.OnClickListener
        {
