...
//            HomeAppsActivity, RegisterActivity, LoginActivity, AppsByCategory

class <init> extends AsyncHttpResponseHandler
{

    final val.txt_fav_kat_apps_1 this$2;
    ...
    public void onStart()
    {
        ...
        {
            notificationLikeHelper.createNotification(val$kategori, "Menambahkan ke favorit");
            return;
        } else
        {
            notificationLikeHelper.createNotification(val$kategori, "Menghapus ke favorit");
            return;
        }
    }
    ...
    public void onSuccess(int i, Header aheader[], byte abyte0[])
    {
        ...
        try
        {
            ...
            val$txt_fav_kat_apps_1.setText(fav_stat);
        }
        // Misplaced declaration of an exception variable
        catch (Header aheader[]) { }
        Log.e("fav_stat2725", fav_stat);
        if (val$txt_fav_kat_apps_1.getText().toString().equals("0"))
        {
            val$img_fav_apps_1.setBackgroundResource(0x7f020302);
        } else
        {
            val$img_fav_apps_1.setBackgroundResource(0x7f020303);
        }
        if (val$txt_fav_kat_apps_1.getText().toString().equals("1"))
        {
            notificationLikeHelper.completed(val$kategori, "Berhasil menambahkan ke favorit");
        } else
        {
            notificationLikeHelper.completed(val$kategori, "Berhasil menghapus dari favorit");
        }
        ponselBaseApp.setObserver().setIndexHp(val$id);
        ponselBaseApp.setObserver().setUpdateType("favappsstore");
        ponselBaseApp.setObserver().setStatus_like_ponsel(val$txt_fav_kat_apps_1.getText().toString());
    }

    <init>()
    {
        this$2 = final_<init>1;
        val$kategori = s;
        val$txt_fav_kat_apps_1 = textview;
        val$img_fav_apps_1 = imageview;
        val$id = String.this;
        super();
    }
...
_L13:
            ...
            listAppsAdapter = (ImageView)aheader.findViewById(0x7f0b0863);
            ...
            abyte0.setOnClickListener(((HomeAppsActivity._cls13._cls3) (listAppsAdapter)). new HomeAppsActivity._cls13._cls3());
            i++;
              goto _L9
_L8:
...
_L11:
            ...
            listApps.setOnItemClickListener(new HomeAppsActivity._cls13._cls1());
              goto _L13
            abyte0;
...
_L12:
        ...
        // Unreferenced inner class com/inponsel/android/v2/HomeAppsActivity$13$1

/* anonymous class */
        class HomeAppsActivity._cls13._cls1
