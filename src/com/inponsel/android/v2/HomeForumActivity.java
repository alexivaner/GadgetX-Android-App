...
import com.inponsel.android.globalforum.ForumInteraksiActivity;
...
//            RegisterActivity, LoginActivity, ProfileOtherUser, ImagePagerActivity

public class HomeForumActivity extends SherlockFragmentActivity
    implements Observer
{
    ...
    public class ListPendatangAdapter extends BaseAdapter
    {
        ...
        public ListPendatangAdapter(Activity activity1, int j, ArrayList arraylist)
        {
            ...
            // Misplaced declaration of an exception variable
            catch (HomeForumActivity homeforumactivity)
            {
                return;
            }
        }
    ...
    public class PostBagusKurangTask extends AsyncTask
    {
        ...
        protected transient Void doInBackground(Void avoid[])
        {
            try
            {
                ...
                avoid = (new StringBuilder(String.valueOf(Util.BASE_PATH2))).append("likedis_artanya").append(Utility.BASE_FORMAT).append("?").append(querylike).toString();
                Log.e("pushURL", avoid);
...
label0:
    ...
    public class SubsNewsTask extends AsyncTask
    {
        ...
        protected transient Void doInBackground(Void avoid[])
        {
            try
            {
                querySubs = (new StringBuilder("idhp=")).append(id_hp_del).append("&idusr=").append(HomeForumActivity.user_id).append("&type=").append("all").append("&stat=").append("0").append("&t=").append(t).toString();
        ...
        protected void onPostExecute(Void void1)
        {
            ...
            {
                Toast.makeText(HomeForumActivity.this, postMessageSubsNews, 1).show();
    ...
    int limit;
    ExpandableHeightGridView listHpForum;
    ...
    ProgressBar progbar_roomhp;
    CircularProgressBar progressbar_TimelineHP;
    CircularProgressBar progressbar_footerOLD;
    ...
    RelativeLayout rl_forumlist;
    RelativeLayout rl_forumlistFoto;
    RelativeLayout rl_forumlistbenchmark;
    RelativeLayout rl_hfor_diikuti;
    RelativeLayout rl_hfor_kategori;
    RelativeLayout rl_hfor_trending;
...
_L3:
        ...
        imageAvatar.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            {
                view1 = new Intent(HomeForumActivity.this, com/inponsel/android/v2/ProfileOtherUser);
        ...
        list_lay_flag.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(View view1)
            {
                idkom_pos = tl_id;
                id_type = tl_type;
                view1 = new android.app.AlertDialog.Builder(HomeForumActivity.this);
        ...
        list_lay_kom.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            {
                idkom_pos = tl_id;
                view1 = new Intent(HomeForumActivity.this, com/inponsel/android/timelinedetail/TLKomenTab);
        ...
        view.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            {
                idkom_pos = tl_id;
                view1 = new Intent(HomeForumActivity.this, com/inponsel/android/timelinedetail/Hal1TLDetailActivity);
                view1.putExtra("id_artanya", idkom_pos);
...
_L2:
        ...
        {
            Picasso.with(this).load((new StringBuilder(String.valueOf(Util.BASE_URL_THUMB2))).append(Utility.BASE_FORMAT).append("?w=").append(300).append("&src=").append(((ItemTimelineHP)mArrayListData.get(j)).getTimeline_img_url()).toString()).into(imageMedia, new Callback() {
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        rl_hfor_diikuti = (RelativeLayout)findViewById(0x7f0b08c6);
        rl_hfor_trending = (RelativeLayout)findViewById(0x7f0b08c8);
        rl_hfor_kategori = (RelativeLayout)findViewById(0x7f0b08ca);
        rl_forumlist = (RelativeLayout)findViewById(0x7f0b08cc);
        rl_forumlistbenchmark = (RelativeLayout)findViewById(0x7f0b08ce);
        rl_forumlistFoto = (RelativeLayout)findViewById(0x7f0b08cd);
        ...
        ll_forumlist = (RelativeLayout)findViewById(0x7f0b08cc);
        ll_forumlistFoto = (RelativeLayout)findViewById(0x7f0b08cd);
        ll_forumlistbenchmark = (RelativeLayout)findViewById(0x7f0b08ce);
        btn_sort_benchmark = (Button)findViewById(0x7f0b06cb);
        ...
        rl_hfor_diikuti.setOnClickListener(new android.view.View.OnClickListener() {

            final HomeForumActivity this$0;

            public void onClick(View view)
            {
                view = new Intent(getApplicationContext(), com/inponsel/android/favorit/IkutiForumPonsel);
        ...
        rl_hfor_kategori.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            
            {
                ...
                ponselOsAdapter = new ListPendatangAdapter(HomeForumActivity.this, 0x7f030119, ponselMerekArray);
                ...
                listHpForum.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
                    ...
                    {
                        adapterview = ponselOsAdapter.getListModel(j).getId_hp();
                        view = ponselOsAdapter.getListModel(j).getMerk();
                        String s = ponselOsAdapter.getListModel(j).getModel();
                        String s1 = ponselOsAdapter.getListModel(j).getCodename();
                        String s2 = ponselOsAdapter.getListModel(j).getGambar();
                        Intent intent = new Intent(_fld0, com/inponsel/android/tlforum/ForumHPActivity);
        ...
        grid_benchmark.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
            ...
            {
                adapterview = new Intent(HomeForumActivity.this, com/inponsel/android/timelinedetail/Hal1TLDetailActivity);
        ...
        getSupportActionBar().setTitle(Html.fromHtml("<font color='#FFFFFF'>Forum Global</font>"));
        t = Utility.session(t);
        t = Utility.session(t);
        ...
        int j = getResources().getColor(0x7f08016e);
        btnAddArtikel.setColor(j);
        scroll_artikel.setOnTouchListener(new ShowHideOnScroll(btnAddArtikel));
        progressbar_TimelineHP = (CircularProgressBar)findViewById(0x7f0b068a);
