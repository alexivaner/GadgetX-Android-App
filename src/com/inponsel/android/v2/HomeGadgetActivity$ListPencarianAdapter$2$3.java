    ...
    implements android.content.ter._cls2._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/HomeGadgetActivity$ListPencarianAdapter$2

/* anonymous class */
    class HomeGadgetActivity.ListPencarianAdapter._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new HomeGadgetActivity.ListPencarianAdapter._cls2._cls1());
                view.setNeutralButton("Register", new HomeGadgetActivity.ListPencarianAdapter._cls2._cls2());
                view.setNegativeButton("Login", new HomeGadgetActivity.ListPencarianAdapter._cls2._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/HomeGadgetActivity$ListPencarianAdapter$2$1

/* anonymous class */
        class HomeGadgetActivity.ListPencarianAdapter._cls2._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final HomeGadgetActivity.ListPencarianAdapter._cls2 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = HomeGadgetActivity.ListPencarianAdapter._cls2.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/v2/HomeGadgetActivity$ListPencarianAdapter$2$2

/* anonymous class */
        class HomeGadgetActivity.ListPencarianAdapter._cls2._cls2
            implements android.content.DialogInterface.OnClickListener
        {
