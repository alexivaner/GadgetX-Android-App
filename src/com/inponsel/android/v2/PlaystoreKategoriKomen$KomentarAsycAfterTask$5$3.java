    ...
    implements android.content.ask._cls5._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/PlaystoreKategoriKomen$KomentarAsycAfterTask$5

/* anonymous class */
    class PlaystoreKategoriKomen.KomentarAsycAfterTask._cls5
...
label0:
            ...
            view.setPositiveButton("Tutup", new PlaystoreKategoriKomen.KomentarAsycAfterTask._cls5._cls1());
            view.setNeutralButton("Register", new PlaystoreKategoriKomen.KomentarAsycAfterTask._cls5._cls2());
            view.setNegativeButton("Login", new PlaystoreKategoriKomen.KomentarAsycAfterTask._cls5._cls3());
            view.show();
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/PlaystoreKategoriKomen$KomentarAsycAfterTask$5$1

/* anonymous class */
        class PlaystoreKategoriKomen.KomentarAsycAfterTask._cls5._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final PlaystoreKategoriKomen.KomentarAsycAfterTask._cls5 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = PlaystoreKategoriKomen.KomentarAsycAfterTask._cls5.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/v2/PlaystoreKategoriKomen$KomentarAsycAfterTask$5$2

/* anonymous class */
        class PlaystoreKategoriKomen.KomentarAsycAfterTask._cls5._cls2
            implements android.content.DialogInterface.OnClickListener
        {
