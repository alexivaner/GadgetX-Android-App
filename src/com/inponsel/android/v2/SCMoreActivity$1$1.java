    ...
    implements android.widget.lickListener
{
    ...
    public void onItemClick(AdapterView adapterview, View view, int i, long l)
    {
        ...
        if (Connectivity.isConnectedWifi(_fld0))
        {
            try
            {
                ...
                SCMoreActivity.access$0(_fld0).setProgressBarIndeterminateVisibility(true);
                SCMoreActivity.access$0(_fld0).setProgressBarVisibility(true);
            }
    ...
    // Unreferenced inner class com/inponsel/android/v2/SCMoreActivity$1

/* anonymous class */
    class SCMoreActivity._cls1
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            if (cm.getActiveNetworkInfo() != null && cm.getActiveNetworkInfo().isAvailable() && cm.getActiveNetworkInfo().isConnected())
            {
                ...
                if (merkArray.size() != 0)
                {
                    ...
                    listHp.setOnItemClickListener(new SCMoreActivity._cls1._cls1());
                } else
                {
                    listMerkAdapter = new ListMerkAdapter(SCMoreActivity.this, 0x7f03006e, listProvArrayList);
                    listHp.setAdapter(listMerkAdapter);
                    (new SCMoreActivity.ProvinsiSync(SCMoreActivity.this, null)).execute(new String[] {
                    ...
                    listHp.setOnItemClickListener(new SCMoreActivity._cls1._cls2());
                }
                mDialog = view.create();
                mDialog.show();
                return;
        ...
        // Unreferenced inner class com/inponsel/android/v2/SCMoreActivity$1$2

/* anonymous class */
        class SCMoreActivity._cls1._cls2
