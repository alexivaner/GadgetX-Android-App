...
_L1:
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        if (KomentarAktivitasUser.access$1(KomentarAktivitasUser.this).size() < 10)
        {
...
_L2:
        ...
        img_kom_picture.setOnLongClickListener(new android.view.View.OnLongClickListener() {
            ...
            final KomentarAktivitasUser.KomentarAsycTask this$1;
            ...
            {
                this$1 = KomentarAktivitasUser.KomentarAsycTask.this;
                usr_pict_komen = s;
                super();
            }
        });
