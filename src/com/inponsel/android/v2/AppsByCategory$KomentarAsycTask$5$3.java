...
//            AppsByCategory, LoginActivity, KatAppsReplyFormActivity, RegisterActivity
    ...
    implements android.content.ask._cls5._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/AppsByCategory$KomentarAsycTask$5

/* anonymous class */
    class AppsByCategory.KomentarAsycTask._cls5
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new AppsByCategory.KomentarAsycTask._cls5._cls1());
                view.setNeutralButton("Register", new AppsByCategory.KomentarAsycTask._cls5._cls2());
                view.setNegativeButton("Login", new AppsByCategory.KomentarAsycTask._cls5._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/AppsByCategory$KomentarAsycTask$5$1

/* anonymous class */
        class AppsByCategory.KomentarAsycTask._cls5._cls1
        ...
        // Unreferenced inner class com/inponsel/android/v2/AppsByCategory$KomentarAsycTask$5$2

/* anonymous class */
        class AppsByCategory.KomentarAsycTask._cls5._cls2
            implements android.content.DialogInterface.OnClickListener
        {
