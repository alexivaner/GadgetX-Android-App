...
//            DaftarPonselMerkActivity, RegisterActivity, LoginActivity
    ...
    implements android.content.ter._cls2._cls2
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/DaftarPonselMerkActivity$ListPendatangAdapter$2

/* anonymous class */
    class DaftarPonselMerkActivity.ListPendatangAdapter._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new DaftarPonselMerkActivity.ListPendatangAdapter._cls2._cls1());
                view.setNeutralButton("Register", new DaftarPonselMerkActivity.ListPendatangAdapter._cls2._cls2());
                view.setNegativeButton("Login", new DaftarPonselMerkActivity.ListPendatangAdapter._cls2._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/DaftarPonselMerkActivity$ListPendatangAdapter$2$1

/* anonymous class */
        class DaftarPonselMerkActivity.ListPendatangAdapter._cls2._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final DaftarPonselMerkActivity.ListPendatangAdapter._cls2 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = DaftarPonselMerkActivity.ListPendatangAdapter._cls2.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/v2/DaftarPonselMerkActivity$ListPendatangAdapter$2$3

/* anonymous class */
        class DaftarPonselMerkActivity.ListPendatangAdapter._cls2._cls3
            implements android.content.DialogInterface.OnClickListener
        {
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface = new Intent(DaftarPonselMerkActivity.ListPendatangAdapter.access$0(this$1), com/inponsel/android/v2/LoginActivity);
