...
_L13:
        ...
        aheader.setOnClickListener(new android.view.View.OnClickListener() {
        ...
        abyte0.setOnClickListener(new android.view.View.OnClickListener() {
...
_L11:
        ...
        listApps.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
            ...
            {
                startActivity(new Intent("android.intent.action.VIEW", Uri.parse(listAppsAdapter.getListModel(l).getAppurl())));
            }
