...
class val.usr_pict_komen
    implements android.view.ostKomen._cls3
{
    ...
    public void onClick(View view)
    {
        ...
        {
            view = new android.app.access._cls5(cess._mth2(this._cls1.this));
            view.age("Untuk memberi penilaian harus login terlebih dahulu.");
            view.tiveButton("Tutup", new android.content.DialogInterface.OnClickListener() {
            ...
            view.ralButton("Register", new android.content.DialogInterface.OnClickListener() {
            ...
            view.tiveButton("Login", new android.content.DialogInterface.OnClickListener() {
