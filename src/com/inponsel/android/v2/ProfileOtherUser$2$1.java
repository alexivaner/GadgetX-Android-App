    ...
    implements android.content.ckListener
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/ProfileOtherUser$2

/* anonymous class */
    class ProfileOtherUser._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new ProfileOtherUser._cls2._cls1());
                view.setNeutralButton("Register", new ProfileOtherUser._cls2._cls2());
                view.setNegativeButton("Login", new ProfileOtherUser._cls2._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/ProfileOtherUser$2$2

/* anonymous class */
        class ProfileOtherUser._cls2._cls2
            implements android.content.DialogInterface.OnClickListener
        {

            final ProfileOtherUser._cls2 this$1;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                ...
                overridePendingTransition(0x7f040003, 0x7f040004);
                    ...
                    {
                        this$1 = ProfileOtherUser._cls2.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/v2/ProfileOtherUser$2$3

/* anonymous class */
        class ProfileOtherUser._cls2._cls3
            implements android.content.DialogInterface.OnClickListener
        {
