...
class val.id_kat
    implements android.view.fterTask._cls3
{
    ...
    public void onClick(View view)
    {
        ...
        } else
        {
            ...
            view.AfterTask("Untuk memberi penilaian harus login terlebih dahulu.");
            view.AfterTask("Tutup", new android.content.DialogInterface.OnClickListener() {
