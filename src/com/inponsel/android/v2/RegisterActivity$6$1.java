    ...
    implements android.widget.ckListener
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/RegisterActivity$6
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            if (provinsiArray.size() != 0)
            {
                ...
                listHp.setOnItemClickListener(new RegisterActivity._cls6._cls1());
            } else
            {
                ...
                (new RegisterActivity.ProvinsiSync(RegisterActivity.this, null)).execute(new String[] {
                ...
                listHp.setOnItemClickListener(new RegisterActivity._cls6._cls2());
            }
            dialog = view.create();
            dialog.show();
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/RegisterActivity$6$2

/* anonymous class */
        class RegisterActivity._cls6._cls2
