        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            if (userFunctions.isUserLoggedIn(getApplicationContext()))
            {
                ...
                (new AsyncHttpClient()).get(view, id. new HomeGamesActivity._cls19._cls3._cls1());
                return;
            } else
            {
...
/* anonymous class */
        ...
        // Unreferenced inner class com/inponsel/android/v2/HomeGamesActivity$19$3$4

/* anonymous class */
        class HomeGamesActivity._cls19._cls3._cls4
            implements android.content.DialogInterface.OnClickListener
        {
