...
class this._cls2
    implements android.content.ask._cls1._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/PlaystoreKategoriKomen$KomentarReplyAsycTask$1

/* anonymous class */
    class PlaystoreKategoriKomen.KomentarReplyAsycTask._cls1
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                PlaystoreKategoriKomen.KomentarReplyAsycTask.access$2(PlaystoreKategoriKomen.KomentarReplyAsycTask.this).statuslike = "1";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new PlaystoreKategoriKomen.KomentarReplyAsycTask._cls1._cls1());
                view.setNeutralButton("Register", new PlaystoreKategoriKomen.KomentarReplyAsycTask._cls1._cls2());
                view.setNegativeButton("Login", new PlaystoreKategoriKomen.KomentarReplyAsycTask._cls1._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/PlaystoreKategoriKomen$KomentarReplyAsycTask$1$1

/* anonymous class */
        class PlaystoreKategoriKomen.KomentarReplyAsycTask._cls1._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final PlaystoreKategoriKomen.KomentarReplyAsycTask._cls1 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = PlaystoreKategoriKomen.KomentarReplyAsycTask._cls1.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/v2/PlaystoreKategoriKomen$KomentarReplyAsycTask$1$2

/* anonymous class */
        class PlaystoreKategoriKomen.KomentarReplyAsycTask._cls1._cls2
            implements android.content.DialogInterface.OnClickListener
        {
