    ...
    implements android.view.AsycTask._cls4
{
    ...
    public void onClick(View view)
    {
        ...
        {
            view = new android.app.tyForResult(cess._mth2(this._cls1.this).wrapperLight);
            view.t("Untuk memberi penilaian harus login terlebih dahulu.");
            view.t("Tutup", new android.content.DialogInterface.OnClickListener() {
