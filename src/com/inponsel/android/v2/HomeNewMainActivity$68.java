...
_L1:
        ...
        rl_menubottom_conv.setLayoutParams(new android.widget.ms((int)f1 / 2, (int)f / 2));
        rl_menubottom_forum.setLayoutParams(new android.widget.ms((int)f1 / 2, (int)f / 2));
        rl_menubottom_hprumor.setLayoutParams(new android.widget.ms((int)f1 / 2, (int)f / 2));
        rl_menubottom_panduanbel.setLayoutParams(new android.widget.ms((int)f1 / 2, (int)f / 2));
        rl_menubottom_pencrinci.setLayoutParams(new android.widget.ms((int)f1 / 2, (int)f / 2));
        rl_menubottom_rekomendasi.setLayoutParams(new android.widget.ms((int)f1 / 2, (int)f / 2));
        img_menubottom_conv.setLayoutParams(new android.widget.rams((int)f1 / 2, (int)f / 2));
        img_menubottom_forum.setLayoutParams(new android.widget.rams((int)f1 / 2, (int)f / 2));
        img_menubottom_hprumor.setLayoutParams(new android.widget.rams((int)f1 / 2, (int)f / 2));
        img_menubottom_panduanbel.setLayoutParams(new android.widget.rams((int)f1 / 2, (int)f / 2));
        img_menubottom_pencrinci.setLayoutParams(new android.widget.rams((int)f1 / 2, (int)f / 2));
        img_menubottom_rekomendasi.setLayoutParams(new android.widget.rams((int)f1 / 2, (int)f / 2));
