...
//            TurunHargaPonselActivity, RegisterActivity, LoginActivity
    ...
    implements android.content.ter._cls1._cls2
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/TurunHargaPonselActivity$ListTurunHargaAdapter$1

/* anonymous class */
    class TurunHargaPonselActivity.ListTurunHargaAdapter._cls1
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new TurunHargaPonselActivity.ListTurunHargaAdapter._cls1._cls1());
                view.setNeutralButton("Register", new TurunHargaPonselActivity.ListTurunHargaAdapter._cls1._cls2());
                view.setNegativeButton("Login", new TurunHargaPonselActivity.ListTurunHargaAdapter._cls1._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/TurunHargaPonselActivity$ListTurunHargaAdapter$1$1

/* anonymous class */
        class TurunHargaPonselActivity.ListTurunHargaAdapter._cls1._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final TurunHargaPonselActivity.ListTurunHargaAdapter._cls1 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = TurunHargaPonselActivity.ListTurunHargaAdapter._cls1.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/v2/TurunHargaPonselActivity$ListTurunHargaAdapter$1$3

/* anonymous class */
        class TurunHargaPonselActivity.ListTurunHargaAdapter._cls1._cls3
            implements android.content.DialogInterface.OnClickListener
        {
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface = new Intent(TurunHargaPonselActivity.ListTurunHargaAdapter.access$0(this$1), com/inponsel/android/v2/LoginActivity);
