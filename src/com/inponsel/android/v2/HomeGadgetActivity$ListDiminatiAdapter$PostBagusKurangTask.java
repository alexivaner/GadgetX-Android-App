...
public class this._cls1 extends AsyncTask
{
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        if (.equals("1"))
        {
            .getObserver().setStatus_like_ponsel("1");
            return;
        }
        try
        {
            .getObserver().setStatus_like_ponsel("0");
            return;
        }
        // Misplaced declaration of an exception variable
        catch (Void void1)
        ...
        (this._cls1.this).notificationLikeHelper.gagal(this._mth1(this._cls1.this).namalengkapbgskrg, this._mth1(this._cls1.this).notificationLikeHelper.gagallikeStatement);
        return;
    }
    ...
    protected void onPreExecute()
    {
        ...
        if (.equals("1"))
        {
            (this._cls1.this).notificationLikeHelper.createNotification(this._mth1(this._cls1.this).namalengkapbgskrg, this._mth1(this._cls1.this).notificationLikeHelper.likeStatement);
            return;
        } else
        {
