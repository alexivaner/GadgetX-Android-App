...
//            PlaystoreKategoriKomen, ImagePagerActivity

class val.img_media
    implements android.view.iKomen._cls9._cls1
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/PlaystoreKategoriKomen$9

/* anonymous class */
    class PlaystoreKategoriKomen._cls9
        implements Callback
    {
        ...
        public void onSuccess()
        {
            ...
            imgKomentar.setOnClickListener(img_media. new PlaystoreKategoriKomen._cls9._cls1());
        }


            
            {
                this$0 = final_playstorekategorikomen;
