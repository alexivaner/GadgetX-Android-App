    ...
    implements android.widget.ckListener
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/ProfileActivity$17

/* anonymous class */
    class ProfileActivity._cls17
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            if (providerArray.size() != 0)
            {
                ...
                listHp.setOnItemClickListener(new ProfileActivity._cls17._cls1());
            } else
            {
                ...
                (new ProfileActivity.OperatorSync(ProfileActivity.this, null)).execute(new String[] {
                ...
                listHp.setOnItemClickListener(new ProfileActivity._cls17._cls2());
            }
            dialog = view.create();
            dialog.show();
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/ProfileActivity$17$1

/* anonymous class */
        class ProfileActivity._cls17._cls1
            implements android.widget.AdapterView.OnItemClickListener
        {

            final ProfileActivity._cls17 this$1;
            ...
            public void onItemClick(AdapterView adapterview, View view, int i, long l)
            {
                ...
                dialog.dismiss();
                    ...
                    {
                        this$1 = ProfileActivity._cls17.this;
                        super();
                    }
        }
