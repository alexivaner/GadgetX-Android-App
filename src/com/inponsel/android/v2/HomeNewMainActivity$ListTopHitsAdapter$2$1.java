    ...
    implements android.content.ter._cls2._cls1
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/HomeNewMainActivity$ListTopHitsAdapter$2

/* anonymous class */
    class HomeNewMainActivity.ListTopHitsAdapter._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new HomeNewMainActivity.ListTopHitsAdapter._cls2._cls1());
                view.setNeutralButton("Register", new HomeNewMainActivity.ListTopHitsAdapter._cls2._cls2());
                view.setNegativeButton("Login", new HomeNewMainActivity.ListTopHitsAdapter._cls2._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/HomeNewMainActivity$ListTopHitsAdapter$2$2

/* anonymous class */
        class HomeNewMainActivity.ListTopHitsAdapter._cls2._cls2
            implements android.content.DialogInterface.OnClickListener
        {

            final HomeNewMainActivity.ListTopHitsAdapter._cls2 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                ...
                HomeNewMainActivity.ListTopHitsAdapter.access$1(this$1).overridePendingTransition(0x7f040003, 0x7f040004);
                    ...
                    {
                        this$2 = HomeNewMainActivity.ListTopHitsAdapter._cls2.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/v2/HomeNewMainActivity$ListTopHitsAdapter$2$3

/* anonymous class */
        class HomeNewMainActivity.ListTopHitsAdapter._cls2._cls3
            implements android.content.DialogInterface.OnClickListener
        {
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface = new Intent(HomeNewMainActivity.ListTopHitsAdapter.access$0(this$1), com/inponsel/android/v2/LoginActivity);
