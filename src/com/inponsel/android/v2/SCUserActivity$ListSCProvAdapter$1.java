    ...
    implements android.view.vAdapter._cls1
{
    ...
    public void onClick(View view)
    {
        ...
        view.ovAdapter("Nomor Telepon :");
        view.Items(_telp_array, -1, new android.content.DialogInterface.OnClickListener() {

            final SCUserActivity.ListSCProvAdapter._cls1 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                ...
                SCUserActivity.ListSCProvAdapter.access$0(this$1).startActivity(dialoginterface);
            }

            
            {
                this$2 = SCUserActivity.ListSCProvAdapter._cls1.this;
                super();
            }
        });
        view._mth1();
