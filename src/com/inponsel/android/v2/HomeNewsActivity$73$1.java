    ...
    implements Callback
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/HomeNewsActivity$73

/* anonymous class */
    class HomeNewsActivity._cls73
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            if (userFunctions.isUserLoggedIn(getApplicationContext()))
            {
                ...
                Picasso.with(HomeNewsActivity.this).load(user_photo.trim()).tag(HomeNewsActivity.this).into(menu_imgProfil, new HomeNewsActivity._cls73._cls1());
                menu_profil.setVisibility(0);
                ...
                HomeNewsActivity.access$7(HomeNewsActivity.this);
