...
_L4:
        ...
        } else
        {
            ...
            final String id_komrss = ((ItemRSSKomen)PlaystoreKategoriKomen.access$1(PlaystoreKategoriKomen.this).get(i)).getId_komrss();
            final String id_kat = ((ItemRSSKomen)PlaystoreKategoriKomen.access$1(PlaystoreKategoriKomen.this).get(i)).getId_rss();
            final String id_user = ((ItemRSSKomen)PlaystoreKategoriKomen.access$1(PlaystoreKategoriKomen.this).get(i)).getId_user();
            ((ItemRSSKomen)PlaystoreKategoriKomen.access$1(PlaystoreKategoriKomen.this).get(i)).getId_user_to();
            final String komen_rss = ((ItemRSSKomen)PlaystoreKategoriKomen.access$1(PlaystoreKategoriKomen.this).get(i)).getKomen_rss();
            final String tanggal_kom = ((ItemRSSKomen)PlaystoreKategoriKomen.access$1(PlaystoreKategoriKomen.this).get(i)).getTanggal_kom();
            final String user_photo = ((ItemRSSKomen)PlaystoreKategoriKomen.access$1(PlaystoreKategoriKomen.this).get(i)).getUser_photo();
            final String user_name = ((ItemRSSKomen)PlaystoreKategoriKomen.access$1(PlaystoreKategoriKomen.this).get(i)).getUser_name();
            ...
            if (((ItemRSSKomen)PlaystoreKategoriKomen.access$1(PlaystoreKategoriKomen.this).get(i)).getUser_name_to().toString().trim().equals("-") || ((ItemRSSKomen)PlaystoreKategoriKomen.access$1(PlaystoreKategoriKomen.this).get(i)).getUser_name_to().toString().trim().equals(""))
            {
            ...
            if (((ItemRSSKomen)PlaystoreKategoriKomen.access$1(PlaystoreKategoriKomen.this).get(i)).getMy_like_kom().toString().equals("1"))
            {
            ...
            {
                this$1 = PlaystoreKategoriKomen.PostKomen.this;
                user_photo = s;
                super();
            }
            });
...
_L2:
        btn_send_komen.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                if (android.os.Build.VERSION.SDK_INT >= 11)
                {
                    (new PlaystoreKategoriKomen.PostKomen()).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Void[0]);
                    return;
                } else
                {
                    (new PlaystoreKategoriKomen.PostKomen()).execute(new Void[0]);
                    return;
                }
            }
        ...
        if (postStatus.equals("1"))
        {
            ...
            if (android.os.ext.setText >= 11)
            {
                (new sk(PlaystoreKategoriKomen.this)).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Void[0]);
                return;
            } else
            {
                (new sk(PlaystoreKategoriKomen.this)).execute(new Void[0]);
                return;
            }
        }
        layout_empty.setVisibility(8);
...
_L3:
    ...
    protected void onPreExecute()
    {
        ...
        Log.e("mArrayListDataPostKomen", String.valueOf(PlaystoreKategoriKomen.access$1(PlaystoreKategoriKomen.this).size()));
        ...
        Log.e("clearmArrayKomen", String.valueOf(PlaystoreKategoriKomen.access$1(PlaystoreKategoriKomen.this).size()));
    }
