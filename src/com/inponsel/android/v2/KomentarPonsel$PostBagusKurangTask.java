...
_L1:
        Log.e("mArrayListData", String.valueOf(KomentarPonsel.access$1(KomentarPonsel.this).size()));
        Log.e("index_komposlike", idkom_pos);
        updateViewLikeDis(idkom_pos);
        if (android.os.os >= 11)
        {
            (new <init>(KomentarPonsel.this)).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Void[0]);
            return;
        }
        ...
        catch (Void void1)
        {
          ...
          goto _L1
        (new <init>(KomentarPonsel.this)).execute(new Void[0]);
        return;
        if (statuslike.equals("1"))
        {
