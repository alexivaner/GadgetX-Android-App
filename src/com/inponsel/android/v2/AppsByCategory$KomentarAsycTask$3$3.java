    ...
    implements android.content.ask._cls3._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/AppsByCategory$KomentarAsycTask$3

/* anonymous class */
    class AppsByCategory.KomentarAsycTask._cls3
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                AppsByCategory.KomentarAsycTask.access$2(AppsByCategory.KomentarAsycTask.this).statuslike = "1";
                ...
                Log.e("querylike", AppsByCategory.KomentarAsycTask.access$2(AppsByCategory.KomentarAsycTask.this).querylikeKomen);
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new AppsByCategory.KomentarAsycTask._cls3._cls1());
                view.setNeutralButton("Register", new AppsByCategory.KomentarAsycTask._cls3._cls2());
                view.setNegativeButton("Login", new AppsByCategory.KomentarAsycTask._cls3._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/AppsByCategory$KomentarAsycTask$3$1

/* anonymous class */
        class AppsByCategory.KomentarAsycTask._cls3._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final AppsByCategory.KomentarAsycTask._cls3 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = AppsByCategory.KomentarAsycTask._cls3.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/v2/AppsByCategory$KomentarAsycTask$3$2

/* anonymous class */
        class AppsByCategory.KomentarAsycTask._cls3._cls2
            implements android.content.DialogInterface.OnClickListener
        {
