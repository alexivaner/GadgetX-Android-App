...
private class <init> extends AsyncTask
{
    ...
    private String uploadFile()
    {
        ...
        try
        {
            AndroidMultiPartEntity androidmultipartentity = new AndroidMultiPartEntity(new com.inponsel.android.utils.AndroidMultiPartEntity.ProgressListener() {
                ...
                final ReplyFormActivity.UploadImage this$1;
            ...
            {
                this$1 = ReplyFormActivity.UploadImage.this;
                super();
            }
            });
    ...
    protected void onPostExecute(String s)
    {
        ...
        if (resp.contains(".jpeg") || resp.contains(".jpg"))
        {
            ...
            (new nit>(ReplyFormActivity.this)).ecute(new Void[0]);
            return;
        } else
        {
            notifGagal();
    ...
    protected void onPreExecute()
    {
        ...
        ReplyFormActivity.access$0(ReplyFormActivity.this).Progress(99, 0, false);
        ReplyFormActivity.access$1(ReplyFormActivity.this).notify(notif_id, ReplyFormActivity.access$0(ReplyFormActivity.this).ld());
    }
    ...
    protected transient void onProgressUpdate(Integer ainteger[])
    {
        ...
        {
            ReplyFormActivity.access$0(ReplyFormActivity.this).Progress(99, 99, false);
            ReplyFormActivity.access$0(ReplyFormActivity.this).ContentTitle("InPonsel").Ongoing(true).ContentText((new StringBuilder("Mengirim komentar... - ")).append(String.valueOf(99)).append("%").toString()).SmallIcon(0x7f0201e4);
        } else
        {
            ReplyFormActivity.access$0(ReplyFormActivity.this).Progress(99, ainteger[0].intValue(), false);
            ReplyFormActivity.access$0(ReplyFormActivity.this).ContentTitle("InPonsel").Ongoing(true).ContentText((new StringBuilder("Mengunggah gambar... - ")).append(String.valueOf(ainteger[0])).append("%").toString()).SmallIcon(0x7f0201e4);
        }
        ReplyFormActivity.access$1(ReplyFormActivity.this).notify(notif_id, ReplyFormActivity.access$0(ReplyFormActivity.this).ld());
    }
