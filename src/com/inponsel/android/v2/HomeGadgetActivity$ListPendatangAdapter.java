...
//            HomeGadgetActivity, RegisterActivity, LoginActivity, KomentarPonsel
    ...
    public class PostBagusKurangTask extends AsyncTask
    {
        ...
        protected transient Void doInBackground(Void avoid[])
        {
            try
            {
                ...
                {
                    StrictMode.setThreadPolicy((new android.os.StrictMode.ThreadPolicy.Builder()).permitAll().buil