    ...
    implements android.widget.ckListener
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/RegisterActivity$9
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            if (providerArray.size() != 0)
            {
                ...
                listHp.setOnItemClickListener(new RegisterActivity._cls9._cls1());
            } else
            {
                ...
                (new RegisterActivity.OperatorSync(RegisterActivity.this, null)).execute(new String[] {
                ...
                listHp.setOnItemClickListener(new RegisterActivity._cls9._cls2());
            }
            dialog = view.create();
            dialog.show();
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/RegisterActivity$9$1

/* anonymous class */
        class RegisterActivity._cls9._cls1
            implements android.widget.AdapterView.OnItemClickListener
        {

            final RegisterActivity._cls9 this$1;
            ...
            public void onItemClick(AdapterView adapterview, View view, int i, long l)
            {
                ...
                dialog.dismiss();
                    ...
                    {
                        this$1 = RegisterActivity._cls9.this;
                        super();
                    }
        }
