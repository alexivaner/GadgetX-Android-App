...
//            HomeNewsActivity, LoginActivity, RegisterActivity

class this._cls2
    implements android.content.ask._cls3._cls7
{
...
/* anonymous class */
        ...
        // Unreferenced inner class com/inponsel/android/v2/HomeNewsActivity$RSSAsycTask$3$6

/* anonymous class */
        class HomeNewsActivity.RSSAsycTask._cls3._cls6
            implements android.content.DialogInterface.OnClickListener
        {
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface = new Intent(HomeNewsActivity.RSSAsycTask.access$2(this$1), com/inponsel/android/v2/RegisterActivity);
