    ...
    implements android.content.ter._cls1._cls1
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/HomeNewMainActivity$ListRilisTerbaruAdapter$1

/* anonymous class */
    class HomeNewMainActivity.ListRilisTerbaruAdapter._cls1
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new HomeNewMainActivity.ListRilisTerbaruAdapter._cls1._cls1());
                view.setNeutralButton("Register", new HomeNewMainActivity.ListRilisTerbaruAdapter._cls1._cls2());
                view.setNegativeButton("Login", new HomeNewMainActivity.ListRilisTerbaruAdapter._cls1._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/HomeNewMainActivity$ListRilisTerbaruAdapter$1$2

/* anonymous class */
        class HomeNewMainActivity.ListRilisTerbaruAdapter._cls1._cls2
            implements android.content.DialogInterface.OnClickListener
        {

            final HomeNewMainActivity.ListRilisTerbaruAdapter._cls1 this$2;

            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface = new Intent(HomeNewMainActivity.ListRilisTerbaruAdapter.access$0(this$1), com/inponsel/android/v2/RegisterActivity);
                ...
                HomeNewMainActivity.ListRilisTerbaruAdapter.access$1(this$1).overridePendingTransition(0x7f040003, 0x7f040004);
                    ...
                    {
                        this$2 = HomeNewMainActivity.ListRilisTerbaruAdapter._cls1.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/v2/HomeNewMainActivity$ListRilisTerbaruAdapter$1$3

/* anonymous class */
        class HomeNewMainActivity.ListRilisTerbaruAdapter._cls1._cls3
            implements android.content.DialogInterface.OnClickListener
        {
