            ...
            txtbtnheader.setOnClickListener(new android.view.View.OnClickListener() {
                ...
                public void onClick(View view)
                {
                    try
                    {
                        ...
                        {
                            (new RSSFeedByTag.RSSNextAsycTask()).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
                            return;
                        }
                    }
                    ...
                    (new RSSFeedByTag.RSSNextAsycTask()).execute(new String[0]);
                    return;
                }

            
            {
                this$1 = RSSFeedByTag.RSSNextAsycTask.this;
                super();
            }
            });
            txtbtnfooter.setOnClickListener(new android.view.View.OnClickListener() {
                ...
                public void onClick(View view)
                {
                    try
                    {
                        ...
                        if (android.os.Build.VERSION.SDK_INT >= 11)
                        {
                            (new RSSFeedByTag.RSSOldAsycTask(this$0)).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
                            return;
                        }
                    }
                    // Misplaced declaration of an exception variable
                    ...
                    (new RSSFeedByTag.RSSOldAsycTask(this$0)).execute(new String[0]);
                    return;
                }
...
_L3:
        ...
        RSSFeedByTag.access$3(RSSFeedByTag.this).addView(void1, countnext);
        obj = RSSFeedByTag.this;
