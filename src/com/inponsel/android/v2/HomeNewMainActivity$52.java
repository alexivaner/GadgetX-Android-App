...
_L1:
        ...
        img_head_banner.setLayoutParams(new android.widget.rams((int)final_width, (int)final_height));
        ...
        btn_doodle_action.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            final HomeNewMainActivity._cls52 this$1;
            ...
            {
                this$1 = HomeNewMainActivity._cls52.this;
                super();
            }
        });
