...
//            BaseDrawer, LoginActivity, RegisterActivity
    ...
    implements android.content.ter._cls1._cls5
{
    ...
    {
        dialoginterface = new Intent(ss._mth0(_fld1).getApplicationContext(), com/inponsel/android/v2/LoginActivity);
...
/* anonymous class */
        ...
        // Unreferenced inner class com/inponsel/android/v2/BaseDrawer$ListHPFavAdapter$1$3

/* anonymous class */
        class BaseDrawer.ListHPFavAdapter._cls1._cls3
            implements android.content.DialogInterface.OnClickListener
        {
