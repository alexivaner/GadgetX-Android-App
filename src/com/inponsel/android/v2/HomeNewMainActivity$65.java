...
class .SimpleImageLoadingListener extends SimpleImageLoadingListener
{
    ...
    public void onLoadingFailed(String s, View view, FailReason failreason)
    {
        ...
        btn_head_banner_refresh.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            final HomeNewMainActivity._cls65 this$1;

            public void onClick(View view1)
            {
                HomeNewMainActivity.access$6(this$0);
            }

            
            {
                this$1 = HomeNewMainActivity._cls65.this;
                super();
            }
        });
    }
