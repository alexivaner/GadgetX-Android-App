...
public class HomeAppsActivity extends SherlockFragmentActivity
    implements Observer, com.nirhart.parallaxscroll.views.ParallaxScrollView.ScrollViewListener, android.view.animation.Animation.AnimationListener
{
        ...
        try
        {
            ImageLoader.getInstance().displayImage(str_doodle_img, img_head_banner, optionsDoodle, new SimpleImageLoadingListener() {
                ...
                public void onLoadingComplete(String s, View view, Bitmap bitmap)
                {
                    ...
                    rl_head_banner.setVisibility(0);
                }
    ...
    {
        sendRequestHeadNews();
        String s = (new StringBuilder(String.valueOf(Util.BASE_PATH2))).append("home_head_banner").append(Utility.BASE_FORMAT).append("?t=").append(t).append("&id_user=").append(user_id).append("&page=2").toString();
...
_L2:
        ...
        s = (new StringBuilder(String.valueOf(Util.BASE_PATH_STORE))).append("apps_custom").append(Utility.BASE_FORMAT).append("?t=").append(t).append("&id_user=").append(user_id).append("&cat=apps&pos=2").toString();
        Log.e("urlTrending", s);
        (new AsyncHttpClient()).get(s, new AsyncHttpResponseHandler() {
...
_L2:
        ...
        sendRequestAds();
        sv_root.scrollTo(0, 0);
        (new AsyncHttpClient()).get((new StringBuilder(String.valueOf(Util.BASE_PATH_STORE))).append("apps_custom").append(Utility.BASE_FORMAT).append("?t=").append(t).append("&id_user=").append(user_id).append("&cat=apps&pos=1").toString(), new AsyncHttpResponseHandler() {
...
_L1:
                ...
                aheader.scroll_count = ((HomeAppsActivity) (aheader)).scroll_count + 1;
_L4:
                listAppsTrendingAdapter.notifyDataSetChanged();
                sv_root.scrollTo(0, 0);
                if (Utility.screen_inch(HomeAppsActivity.this) >= 6D)
                {
                    aheader = HomeAppsActivity.this;
                    aheader.scroll_count = ((HomeAppsActivity) (aheader)).scroll_count + 1;
                    load_segmen_2();
...
_L2:
    ...
    private void load_segmen_2()
    {
        ...
        if (arrayListEditorApps.size() > 0)
        {
            ll_segmen_2.setVisibility(0);
            return;
        } else
        {
            (new AsyncHttpClient()).get((new StringBuilder(String.valueOf(Util.BASE_PATH_STORE))).append("apps_custom").append(Utility.BASE_FORMAT).append("?t=").append(t).append("&id_user=").append(user_id).append("&cat=apps&pos=3").toString(), new AsyncHttpResponseHandler() {
...
_L3:
                    abyte0 = aheader.getJSONObject(i);
                    mArrayListRSSData.add(new ItemKategoriAppsGames(abyte0.getString("id"), abyte0.getString("kategori"), abyte0.getString("tag"), abyte0.getString("type"), abyte0.getString("deskripsi"), abyte0.getString("place"), abyte0.getString("position"), abyte0.getString("background"), abyte0.getString("background_img"), abyte0.getString("width"), abyte0.getString("height"), abyte0.getString("myfav"), abyte0.getString("mod_date"), abyte0.getString("total_like"), abyte0.getString("kategori_apps")));
                    i++;
...
_L13:
                    ...
                    Object obj = (ImageView)aheader.findViewById(0x7f0b0863);
                    Object obj1 = (TextView)aheader.findViewById(0x7f0b08f0);
                    Object obj2 = (TextView)aheader.findViewById(0x7f0b0860);
                    Object obj3 = (TextView)aheader.findViewById(0x7f0b0861);
                    ...
                    ((TextView) (obj1)).setText(id);
                    Log.e((new StringBuilder("myfav")).append(id).toString(), s);
                    txt_fav_kat_apps_1.setText(s);
                    ((TextView) (obj2)).setText(kategori);
                    ((TextView) (obj3)).setText(deskripsi);
                    ...
                    aheader.setOnClickListener(txt_fav_kat_apps_1. new android.view.View.OnClickListener() {
            ...
            
            {
                ...
                height = s9;
                type = s10;
                txt_fav_kat_apps_1 = TextView.this;
                super();
            }
                    });
                    abyte0.setOnClickListener(((_cls3) (obj)). new android.view.View.OnClickListener() {
...
_L8:
                    ...
                    obj = new ListAppsAdapter(HomeAppsActivity.this, 0x7f030137, abyte0);
                    obj1 = new JSONArray(new String(((ItemKategoriAppsGames)mArrayListRSSData.get(i)).getJsonarray()));
                    Log.e("jsonArray", (new StringBuilder("applist")).append(String.valueOf(((JSONArray) (obj1)).length())).toString());
                    if (((JSONArray) (obj1)).length() == 0) goto _L11; else goto _L10
_L10:
                    k = 0;
_L14:
                    if (k < ((JSONArray) (obj1)).length()) goto _L12; else goto _L11
_L11:
                    Log.e("arrayAppsList", (new StringBuilder("arrayAppsList")).append(String.valueOf(abyte0.size())).toString());
                    listApps.setAdapter(((android.widget.ListAdapter) (obj)));
                    listApps.setOnItemClickListener(((_cls1) (obj)). new android.widget.AdapterView.OnItemClickListener() {
            ...
            
            {
                ...
                super();
                    ...
                    abyte0.printStackTrace();
                      goto _L13
_L12:
                    obj2 = ((JSONArray) (obj1)).getJSONObject(k);
                    Log.e("iLength", (new StringBuilder(String.valueOf(String.valueOf(k)))).append("-").append(((JSONObject) (obj2)).getString("app_name")).toString());
                    obj3 = new ListModel();
                    ((ListModel) (obj3)).setApppackage(((JSONObject) (obj2)).getString("app_package"));
                    ((ListModel) (obj3)).setAppname(((JSONObject) (obj2)).getString("app_name"));
                    ((ListModel) (obj3)).setAppcover(((JSONObject) (obj2)).getString("icon_image"));
                    ((ListModel) (obj3)).setAvgrate(((JSONObject) (obj2)).getString("app_rate"));
                    ((ListModel) (obj3)).setBanner_image(((JSONObject) (obj2)).getString("banner_image"));
                    ((ListModel) (obj3)).setAppsize(((JSONObject) (obj2)).getString("app_size"));
                    ((ListModel) (obj3)).setDownloadcount(((JSONObject) (obj2)).getString("app_download"));
                    ((ListModel) (obj3)).setAppurl(((JSONObject) (obj2)).getString("app_url"));
                    abyte0.add(obj3);
                    k++;
                      goto _L14
_L5:
...
_L15:
    ...
    private void load_segmen_morekataaps()
    {
        ...
        {
            ll_segmen_2.setVisibility(0);
            Log.e("ll_segmen_2", (new StringBuilder("ll_segmen_2=")).append(String.valueOf(arrayListEditorApps.size())).append("=").append(String.valueOf(ll_segmen_2.getVisibility())).toString());
        } else
        {
            Log.e("ll_segmen_2", (new StringBuilder("kosong:")).append(String.valueOf(arrayListEditorApps.size())).toString());
        }
        s = (new StringBuilder(String.valueOf(Util.BASE_PATH_STORE))).append("list_kategori_ads").append(Utility.BASE_FORMAT).append("?t=").append(t).append("&id_user=").append(user_id).append("&bottom_id=").append(bottom_id).toString();
...
_L13:
                abyte0 = (LinearLayout)aheader.findViewById(0x7f0b0865);
                abyte0 = (LinearLayout)aheader.findViewById(0x7f0b0862);
                obj = (ImageView)aheader.findViewById(0x7f0b0863);
                obj1 = (TextView)aheader.findViewById(0x7f0b08f0);
                obj2 = (TextView)aheader.findViewById(0x7f0b0860);
                obj3 = (TextView)aheader.findViewById(0x7f0b0861);
                ...
                type = ((ItemKategoriAppsGames)mArrayListRSSData.get(i)).gettype();
                ...
                linearlayout.setVisibility(0);
                ((TextView) (obj1)).setText(id);
                Log.e((new StringBuilder("myfav")).append(id).toString(), s1);
...
_L12:
    ...
    {
        url2Ads = (new StringBuilder(String.valueOf(Util.BASE_PATH2))).append("list_ads_home").append(Utility.BASE_FORMAT).append("?hal=48").append("&pver=").append(SplashScreen.curVersion).append("&t=").append(t).append("&idusr=").append(user_id).append("&tag=tagall").toString();
...
_L4:
    ...
    {
        urlAds = (new StringBuilder(String.valueOf(Util.BASE_PATH2))).append("list_ads_home").append(Utility.BASE_FORMAT).append("?hal=47").append("&pver=").append(SplashScreen.curVersion).append("&t=").append(t).append("&idusr=").append(user_id).append("&tag=tagall").toString();
        AsyncHttpClient asynchttpclient = new AsyncHttpClient();
        asynchttpclient.setMaxRetriesAndTimeout(5, 10000);
...
_L4:
    ...
    {
        urlHeadline = (new StringBuilder(String.valueOf(Util.BASE_PATH2))).append("rss_random").append(Utility.BASE_FORMAT).append("?lmt=0&t=").append(t).append("&idusr=").append(user_id).append("&tag=aplikasi").toString();
    ...
    private void updateViewFavApps(String s)
    {
        ...
        Log.e("listKategoriAdsApps", String.valueOf(listKategoriAdsApps.getChildCount()));
        int i = 0;
        do
        {
...
_L2:
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        rl_background_headnews.setBackgroundResource(0x7f0201bc);
        ...
        Log.e("ll_segmen_2", (new StringBuilder("=")).append(String.valueOf(ll_segmen_2.getVisibility())).toString());
        progressbar_segmen1.setVisibility(8);
        progressbar_segmen2.setVisibility(8);
        ...
        rl_more_editorapps.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            {
                view = new Intent(HomeAppsActivity.this, com/inponsel/android/v2/AppsSelengkap);
                view.putExtra("category", "editorapps");
        ...
        urlKategori = (new StringBuilder(String.valueOf(Util.BASE_PATH_STORE))).append("list_kategori_apps").append(Utility.BASE_FORMAT).append("?t=").append(t).toString();
        Log.e("urlKategori", urlKategori);
        urlKategori2 = (new StringBuilder(String.valueOf(Util.BASE_PATH_STORE))).append("list_kategori_ads").append(Utility.BASE_FORMAT).append("?t=").append(t).append("&id_user=").append(user_id).append("&bottom_id=0").toString();
        load_segmen_1();
