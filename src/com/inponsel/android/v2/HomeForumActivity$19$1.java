    ...
    implements android.content.Listener
{
    ...
    public void onClick(DialogInterface dialoginterface, int i)
    {
        ...
        {
            queryFlag = (new StringBuilder("id_artanya=")).append(idkom_pos).append("&id_usr=").append(HomeForumActivity.user_id).append("&type=").append(val$tl_type).append("&t=").append(t).toString();
            Log.e("queryFlag", queryFlag);
            if (android.os.ctivity.queryFlag >= 11)
            {
        ...
        {
            dialoginterface = new android.app.it>(_fld0);
            dialoginterface.Message("Untuk memberi laporan harus login terlebih dahulu.");
            dialoginterface.PositiveButton("Tutup", new android.content.DialogInterface.OnClickListener() {
            ...
            dialoginterface.NeutralButton("Register", new android.content.DialogInterface.OnClickListener() {
            ...
            dialoginterface.NegativeButton("Login", new android.content.DialogInterface.OnClickListener() {
