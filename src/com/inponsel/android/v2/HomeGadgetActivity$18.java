    ...
    implements android.widget.kListener
{
    ...
    public void onItemClick(AdapterView adapterview, View view, int i, long l)
    {
        ...
        id_hph = latestBrandAdapter.getListModel(i).getId_hp().toString();
        model = latestBrandAdapter.getListModel(i).getModel().toString();
        merk = latestBrandAdapter.getListModel(i).getMerk().toString();
        gambar = latestBrandAdapter.getListModel(i).getGambar().toString();
        tot_like = latestBrandAdapter.getListModel(i).getTotal_like().toString();
        tot_dislike = latestBrandAdapter.getListModel(i).getTotal_dislike().toString();
        tot_komen = latestBrandAdapter.getListModel(i).getTotal_kom().toString();
        hrg_baru = latestBrandAdapter.getListModel(i).getHrg_baru().toString();
        hrg_bekas = latestBrandAdapter.getListModel(i).getHrg_bekas().toString();
        codename = latestBrandAdapter.getListModel(i).getCodename().toString();
