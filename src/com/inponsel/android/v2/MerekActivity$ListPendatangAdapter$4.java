...
class val.position
    implements android.view.gAdapter._cls4
{
    ...
    public void onClick(View view)
    {
        ...
        if (erFunctions.isUserLoggedIn(cess._mth0(this._cls1.this)))
        {
            ...
            view.ngAdapter("Favoritkan merek ini?");
            ...
            view._mth4("Tidak", new android.content.DialogInterface.OnClickListener() {
        ...
        {
            view = new android.app.ngAdapter._cls4(cess._mth0(this._cls1.this));
