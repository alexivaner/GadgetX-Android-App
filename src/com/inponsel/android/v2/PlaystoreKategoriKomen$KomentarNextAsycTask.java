...
_L13:
        txtbtnheader.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            {
                this$1 = PlaystoreKategoriKomen.KomentarNextAsycTask.this;
                super();
            }
        });
        txtbtnfooter.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                try
                {
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= 11)
                    {
                        (new PlaystoreKategoriKomen.KomentarNextAsycTask()).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
                        return;
                    }
                }
                // Misplaced declaration of an exception variable
                ...
                (new PlaystoreKategoriKomen.KomentarNextAsycTask()).execute(new String[0]);
                return;
            }
