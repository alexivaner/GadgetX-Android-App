    ...
    implements android.content.ter._cls2._cls2
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/HomeGadgetActivity$ListSegeraAdapter$2

/* anonymous class */
    class HomeGadgetActivity.ListSegeraAdapter._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new HomeGadgetActivity.ListSegeraAdapter._cls2._cls1());
                view.setNeutralButton("Register", new HomeGadgetActivity.ListSegeraAdapter._cls2._cls2());
                view.setNegativeButton("Login", new HomeGadgetActivity.ListSegeraAdapter._cls2._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/HomeGadgetActivity$ListSegeraAdapter$2$1

/* anonymous class */
        class HomeGadgetActivity.ListSegeraAdapter._cls2._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final HomeGadgetActivity.ListSegeraAdapter._cls2 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = HomeGadgetActivity.ListSegeraAdapter._cls2.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/v2/HomeGadgetActivity$ListSegeraAdapter$2$3

/* anonymous class */
        class HomeGadgetActivity.ListSegeraAdapter._cls2._cls3
            implements android.content.DialogInterface.OnClickListener
        {
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface = new Intent(HomeGadgetActivity.ListSegeraAdapter.access$0(this$1), com/inponsel/android/v2/LoginActivity);
