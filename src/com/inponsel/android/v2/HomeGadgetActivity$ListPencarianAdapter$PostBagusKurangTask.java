...
public class this._cls1 extends AsyncTask
{
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        if (n.equals("1"))
        {
            n.getObserver().setStatus_like_ponsel("1");
            return;
        }
        try
        {
            n.getObserver().setStatus_like_ponsel("0");
            return;
        }
        // Misplaced declaration of an exception variable
        catch (Void void1)
        ...
        n(this._cls1.this).notificationLikeHelper.gagal(this._mth1(this._cls1.this).namalengkapbgskrg, this._mth1(this._cls1.this).notificationLikeHelper.gagallikeStatement);
        return;
    }
    ...
    protected void onPreExecute()
    {
        ...
        if (n.equals("1"))
        {
            n(this._cls1.this).notificationLikeHelper.createNotification(this._mth1(this._cls1.this).namalengkapbgskrg, this._mth1(this._cls1.this).notificationLikeHelper.likeStatement);
            return;
        } else
        {
