...
//            HomeGamesActivity, RegisterActivity, LoginActivity, AppsByCategory

class val.kategori
    implements android.view.ivity._cls13._cls3
{
    ...
    public void onClick(View view)
    {
        if (userFunctions.isUserLoggedIn(getApplicationContext()))
        {
            ...
            view = (new StringBuilder(String.valueOf(Util.BASE_PATH_STORE))).append("add_fav_applist.php?").append("t=").append(t).append("&id_user=").append(user_id).append("&status=").append(fav_stat).append("&id_kat=").append(val$id).toString();
            Log.e("urlPost2657", view);
            (new AsyncHttpClient()).get(view, new AsyncHttpResponseHandler() {
        ...
        {
            view = new android.app.it>(_fld0);
            view.Message("Untuk menambah ke favorit harus login terlebih dahulu.");
...
_L13:
            ...
            type = ((ItemKategoriAppsGames)HomeGamesActivity.access$1(HomeGamesActivity.this).get(i)).gettype();
            ...
            aheader.setOnClickListener(new HomeGamesActivity._cls13._cls2());
            ll_fav_apps.setOnClickListener(kategori. new HomeGamesActivity._cls13._cls3());
            i++;
              goto _L9
_L8:
...
/* anonymous class */
        ...
        // Unreferenced inner class com/inponsel/android/v2/HomeGamesActivity$13$2

/* anonymous class */
        class HomeGamesActivity._cls13._cls2
