...
_L4:
        img_head_banner.setLayoutParams(new android.widget.Params((int)final_width, (int)final_height));
        ...
        btn_doodle_action.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            final HomeGamesActivity._cls14 this$1;
            ...
            {
                this$1 = HomeGamesActivity._cls14.this;
                super();
            }
        });
