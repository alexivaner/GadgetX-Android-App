    ...
    implements android.content.ask._cls3._cls2
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/KomentarPonsel$KomentarNextAsycTask$3

/* anonymous class */
    class KomentarPonsel.KomentarNextAsycTask._cls3
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                KomentarPonsel.KomentarNextAsycTask.access$2(KomentarPonsel.KomentarNextAsycTask.this).statuslike = "1";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new KomentarPonsel.KomentarNextAsycTask._cls3._cls1());
                view.setNeutralButton("Register", new KomentarPonsel.KomentarNextAsycTask._cls3._cls2());
                view.setNegativeButton("Login", new KomentarPonsel.KomentarNextAsycTask._cls3._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/KomentarPonsel$KomentarNextAsycTask$3$1

/* anonymous class */
        class KomentarPonsel.KomentarNextAsycTask._cls3._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final KomentarPonsel.KomentarNextAsycTask._cls3 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = KomentarPonsel.KomentarNextAsycTask._cls3.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/v2/KomentarPonsel$KomentarNextAsycTask$3$3

/* anonymous class */
        class KomentarPonsel.KomentarNextAsycTask._cls3._cls3
            implements android.content.DialogInterface.OnClickListener
        {
