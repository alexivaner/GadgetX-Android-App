...
public class this._cls0 extends AsyncTask
{
    ...
    protected transient Void doInBackground(Void avoid[])
    {
        try
        {
            ...
            {
                StrictMode.setThreadPolicy((new android.os.usKurangTask()).ll().ll());
            }
...
_L1:
        (new Handler()).postDelayed(new Runnable() {
            ...
            final HomeGadgetActivity.PostBagusKurangTask this$1;

            public void run()
            {
                HomeGadgetActivity.access$1(this$0);
            }

            
            {
                this$1 = HomeGadgetActivity.PostBagusKurangTask.this;
                super();
            }
        }, 2000L);
        return;
