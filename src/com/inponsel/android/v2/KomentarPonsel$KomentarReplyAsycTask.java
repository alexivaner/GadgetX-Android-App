...
_L1:
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        Log.e("mArrayListDataRep", String.valueOf(KomentarPonsel.access$1(KomentarPonsel.this).size()));
        jum_komen.equals("-");
...
_L3:
        ...
        Log.e("mArrayListDataAfterRep", String.valueOf(KomentarPonsel.access$1(KomentarPonsel.this).size()));
        KomentarPonsel.access$0(KomentarPonsel.this).removeViewAt(KomentarPonsel.access$0(KomentarPonsel.this).getChildCount());
_L13:
        txtbtnfooter.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            {
                this$1 = KomentarPonsel.KomentarReplyAsycTask.this;
                super();
            }
        });
...
_L11:
        Log.e("avatarpict", ((ItemKomenHp)KomentarPonsel.access$1(KomentarPonsel.this).get(i)).getUsr_pict_komen().toString().trim());
