    ...
    implements android.content.ter._cls1._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/HomeGadgetActivity$ListRumorAdapter$1

/* anonymous class */
    class HomeGadgetActivity.ListRumorAdapter._cls1
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new HomeGadgetActivity.ListRumorAdapter._cls1._cls1());
                view.setNeutralButton("Register", new HomeGadgetActivity.ListRumorAdapter._cls1._cls2());
                view.setNegativeButton("Login", new HomeGadgetActivity.ListRumorAdapter._cls1._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/HomeGadgetActivity$ListRumorAdapter$1$1

/* anonymous class */
        class HomeGadgetActivity.ListRumorAdapter._cls1._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final HomeGadgetActivity.ListRumorAdapter._cls1 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = HomeGadgetActivity.ListRumorAdapter._cls1.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/v2/HomeGadgetActivity$ListRumorAdapter$1$2

/* anonymous class */
        class HomeGadgetActivity.ListRumorAdapter._cls1._cls2
            implements android.content.DialogInterface.OnClickListener
        {
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface = new Intent(HomeGadgetActivity.ListRumorAdapter.access$0(this$1), com/inponsel/android/v2/RegisterActivity);
