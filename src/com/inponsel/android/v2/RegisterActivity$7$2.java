    ...
    implements android.widget.ckListener
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/RegisterActivity$7

/* anonymous class */
    class RegisterActivity._cls7
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            if (kotaArray.size() != 0)
            {
                ...
                listHp.setOnItemClickListener(new RegisterActivity._cls7._cls1());
            } else
            {
                ...
                (new RegisterActivity.KotaSync(RegisterActivity.this, null)).execute(new String[] {
                ...
                listHp.setOnItemClickListener(new RegisterActivity._cls7._cls2());
            }
            dialog = view.create();
            dialog.show();
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/RegisterActivity$7$1

/* anonymous class */
        class RegisterActivity._cls7._cls1
