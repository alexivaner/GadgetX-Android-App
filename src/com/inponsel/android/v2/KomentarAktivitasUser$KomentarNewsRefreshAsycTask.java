...
_L2:
        ...
        {
            imageLoader2.displayImage((new StringBuilder()).append(((ItemKomenNews)mArrayListKomNewsData.get(i)).getUsr_pict_komen().toString().trim()).toString(), img_kom_picture, KomentarAktivitasUser.access$2(KomentarAktivitasUser.this), KomentarAktivitasUser.access$3(KomentarAktivitasUser.this));
        } else
        {
        ...
        img_kom_picture.setOnLongClickListener(new android.view.View.OnLongClickListener() {
            ...
            final KomentarAktivitasUser.KomentarNewsRefreshAsycTask this$1;
            ...
            {
                this$1 = KomentarAktivitasUser.KomentarNewsRefreshAsycTask.this;
                usr_pict_komen = s;
                super();
            }
        });
