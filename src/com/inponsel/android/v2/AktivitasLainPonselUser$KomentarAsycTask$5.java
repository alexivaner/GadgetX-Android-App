    ...
    implements android.view.AsycTask._cls5
{
    ...
    public void onClick(View view)
    {
        try
        {
            ...
            cess._mth2(this._cls1.this).urlKomenOld = (new StringBuilder(String.valueOf(Util.BASE_PATH2))).append("user_aktivitas_ponsel").append(Utility.BASE_FORMAT).append("?lmt=").append(cess._mth2(this._cls1.this).limit).append("&t=").append(cess._mth2(this._cls1.this).t).append("&idusr=").append(cess._mth2(this._cls1.this).str_id_user).append("&bottom_id=").append(cess._mth2(this._cls1.this).bottom_id).toString();
