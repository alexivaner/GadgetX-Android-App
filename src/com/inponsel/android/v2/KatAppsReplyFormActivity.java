...
public class KatAppsReplyFormActivity extends SherlockFragmentActivity
    implements Observer
{
    private static class EmoticonAdapter extends BaseAdapter
    {
        ...
        public View getView(int j, View view, ViewGroup viewgroup)
        {
            ...
            ((ViewHolder) (viewgroup)).mTextView.setText(KatAppsReplyFormActivity.emotname[j]);
            return view;
        }
    ...
    public KatAppsReplyFormActivity()
    {
        useLogo = false;
...
_L8:
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        try
        {
            ...
            bundle.setScreenName("Tanggapan Komentar Applist");
        ...
        listEmot.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
            ...
            {
                edt_pop_komen.setImageInsertGrid(KatAppsReplyFormActivity.emotname[j]);
            }
            ...
            public void onClick(View view)
            {
                if (photo_upload == null)
                {
                    if (imgAskHp.getVisibility() == 0)
                    {
                        ...
                        mBuilder = new android.support.v4.app.NotificationCompat.Builder(KatAppsReplyFormActivity.this);
