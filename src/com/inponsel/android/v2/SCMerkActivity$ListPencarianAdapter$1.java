    ...
    implements android.view.nAdapter._cls1
{
    ...
    public void onClick(View view)
    {
        ...
        view.ms(_telp_array, -1, new android.content.DialogInterface.OnClickListener() {
            ...
            final SCMerkActivity.ListPencarianAdapter._cls1 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                ...
                SCMerkActivity.ListPencarianAdapter.access$0(this$1).startActivity(dialoginterface);
            }

            
            {
                this$2 = SCMerkActivity.ListPencarianAdapter._cls1.this;
                super();
            }
        });
        view._mth1();
