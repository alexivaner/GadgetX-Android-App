...
//            TurunHargaPonselActivity, SCUserActivity

class this._cls1
    implements android.view.nAdsTask._cls3
{
    ...
    public void onClick(View view)
    {
        ...
        {
            view = new Intent(cess._mth3(this._cls1.this), com/inponsel/android/v2/SCUserActivity);
