...
class val.position
    implements android.view.lAdapter._cls1
{
    ...
    public void onClick(View view)
    {
        ...
        view = new android.app.elAdapter(cess._mth0(this._cls1.this));
        view.elAdapter("Peringatan");
        view.elAdapter("Hapus artikel ini?");
