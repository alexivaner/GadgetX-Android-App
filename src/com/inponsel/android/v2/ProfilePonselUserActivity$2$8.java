...
//            ProfilePonselUserActivity, RoomPostArtikel, RoomPostHasilFotoNoCrop, RoomPostBenchmark, 
//            RoomPostPertanyaan, RSSFeedByTag, RoomPenggunaHp, KomentarPonsel, 
//            RoomChatActivity

class this._cls1
    implements android.view.tivity._cls2._cls8
{
    ...
    {
        view = new android.app.tener(_fld0);
        view._mth0(URLDecoder.decode((new StringBuilder("Kirim Konten ")).append(merk_1).append(" ").append(model_1).toString()));
        view.model_1(tambah_artikel, new android.content.DialogInterface.OnClickListener() {
