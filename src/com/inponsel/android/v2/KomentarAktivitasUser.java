...
//            ImagePagerActivity, AktivitasLainPonselUser, KomentarBaruLainNews, KomentarBaruLainPonsel

public class KomentarAktivitasUser extends SherlockFragmentActivity
    implements Observer
{
...
_L2:
            ...
            ((ItemKomenHp)mArrayListData.get(i)).getNama_komentar();
            ...
            String s1 = ((ItemKomenHp)mArrayListData.get(i)).getUsr_pict_komen();
...
_L2:
            ...
            ((ItemKomenNews)mArrayListKomNewsData.get(i)).getNama_komentar();
            String s = ((ItemKomenNews)mArrayListKomNewsData.get(i)).getEmail_komentar();
            ...
            String s1 = ((ItemKomenNews)mArrayListKomNewsData.get(i)).getUsr_pict_komen();
...
_L2:
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        try
        {
            ...
            bundle.setScreenName("Aktivitas Pengguna");
        ...
        getSupportActionBar().setTitle(Html.fromHtml((new StringBuilder("<font color='#FFFFFF'>")).append(URLDecoder.decode("Aktivitas Pengguna")).append("</font>").toString()));
        bundle = (TextView)findViewById(i);
        bundle.setSelected(true);
        bundle.setTextColor(Color.parseColor("#FFFFFF"));
        bundle.setText(URLDecoder.decode("Aktivitas Pengguna"));
        ...
        try
        {
            urlKomen = (new StringBuilder(String.valueOf(Util.BASE_PATH2))).append("profile_komhp").append(Utility.BASE_FORMAT).append("?lmt=").append(limit).append("&t=").append(t).append("&id=").append(str_id_user).toString();
            urlKomenNews = (new StringBuilder(String.valueOf(Util.BASE_PATH2))).append("profile_komnews").append(Utility.BASE_FORMAT).append("?lmt=").append(limit).append("&t=").append(t).append("&id=").append(str_id_user).toString();
