    ...
    implements android.widget.ckListener
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/ProfileActivity$18

/* anonymous class */
    class ProfileActivity._cls18
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            if (providerArray.size() != 0)
            {
                ...
                listHp.setOnItemClickListener(new ProfileActivity._cls18._cls1());
            } else
            {
                ...
                listHp.setOnItemClickListener(new ProfileActivity._cls18._cls2());
            }
            dialog = view.create();
            dialog.show();
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/ProfileActivity$18$1

/* anonymous class */
        class ProfileActivity._cls18._cls1
            implements android.widget.AdapterView.OnItemClickListener
        {

            final ProfileActivity._cls18 this$1;
            ...
            public void onItemClick(AdapterView adapterview, View view, int i, long l)
            {
                ...
                dialog.dismiss();
                    ...
                    {
                        this$1 = ProfileActivity._cls18.this;
                        super();
                    }
        }
