    ...
    implements android.content.ter._cls2._cls1
{
    ...
    // Unreferenced inner class com/inponsel/android/v2/HomeGadgetActivity$ListRilisTerbaruAdapter$2

/* anonymous class */
    class HomeGadgetActivity.ListRilisTerbaruAdapter._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new HomeGadgetActivity.ListRilisTerbaruAdapter._cls2._cls1());
                view.setNeutralButton("Register", new HomeGadgetActivity.ListRilisTerbaruAdapter._cls2._cls2());
                view.setNegativeButton("Login", new HomeGadgetActivity.ListRilisTerbaruAdapter._cls2._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/v2/HomeGadgetActivity$ListRilisTerbaruAdapter$2$2

/* anonymous class */
        class HomeGadgetActivity.ListRilisTerbaruAdapter._cls2._cls2
            implements android.content.DialogInterface.OnClickListener
        {

            final HomeGadgetActivity.ListRilisTerbaruAdapter._cls2 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                ...
                HomeGadgetActivity.ListRilisTerbaruAdapter.access$1(this$1).overridePendingTransition(0x7f040003, 0x7f040004);
                    ...
                    {
                        this$2 = HomeGadgetActivity.ListRilisTerbaruAdapter._cls2.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/v2/HomeGadgetActivity$ListRilisTerbaruAdapter$2$3

/* anonymous class */
        class HomeGadgetActivity.ListRilisTerbaruAdapter._cls2._cls3
            implements android.content.DialogInterface.OnClickListener
        {
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface = new Intent(HomeGadgetActivity.ListRilisTerbaruAdapter.access$0(this$1), com/inponsel/android/v2/LoginActivity);
