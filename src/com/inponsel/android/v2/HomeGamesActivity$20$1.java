...
class this._cls1
    implements android.view.ivity._cls20._cls1
{
    ...
    {
        HomeGamesActivity.access$2(_fld0);
    }
    ...
    // Unreferenced inner class com/inponsel/android/v2/HomeGamesActivity$20

/* anonymous class */
    class HomeGamesActivity._cls20 extends SimpleImageLoadingListener
    {
        ...
        public void onLoadingFailed(String s, View view, FailReason failreason)
        {
            ...
            btn_head_banner_refresh.setOnClickListener(new HomeGamesActivity._cls20._cls1());
        }
