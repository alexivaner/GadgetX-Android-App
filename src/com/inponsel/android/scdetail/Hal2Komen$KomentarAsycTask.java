...
_L1:
            ...
            {
                this$1 = Hal2Komen.KomentarAsycTask.this;
                super();
            }
        });
...
_L4:
        ...
        String s = ((ItemRSSKomen)Hal2Komen.access$1(Hal2Komen.this).get(i)).getImg_media();
        String s1 = ((ItemRSSKomen)Hal2Komen.access$1(Hal2Komen.this).get(i)).getImg_media_to();
        Hal2Komen.access$2(Hal2Komen.this, ll_img_komen, ll_img_komen_rep, txtTapImage, txtTapImageRep, imgKomentar, imgKomentar_rep, progressbar_imgkomen, progressbar_imgkomenrep, s, s1);
        if (!((ItemRSSKomen)Hal2Komen.access$1(Hal2Komen.this).get(i)).getUser_name_to().toString().trim().equals("-") && !((ItemRSSKomen)Hal2Komen.access$1(Hal2Komen.this).get(i)).getUser_name_to().toString().trim().equals("")) goto _L7; else goto _L6
_L6:
        lay_quote.setVisibility(8);
_L13:
        if (!((ItemRSSKomen)Hal2Komen.access$1(Hal2Komen.this).get(i)).getMy_like_kom().toString().equals("1")) goto _L9; else goto _L8
_L8:
...
_L14:
        if (!((ItemRSSKomen)Hal2Komen.access$1(Hal2Komen.this).get(i)).getUser_photo().trim().contains(".jpg") && !((ItemRSSKomen)Hal2Komen.access$1(Hal2Komen.this).get(i)).getUser_photo().toString().trim().contains(".png") && !((ItemRSSKomen)Hal2Komen.access$1(Hal2Komen.this).get(i)).getUser_photo().toString().trim().contains(".jpeg")) goto _L11; else goto _L10
_L10:
...
_L15:
        ...
        Hal2Komen.access$0(Hal2Komen.this).addView(void1);
...
_L1:
    ...
    protected void onPreExecute()
    {
        ...
        Log.e("KomentarAsycTask", "onPreExecute");
        layout_empty.setVisibility(0);
        Hal2Komen.access$0(Hal2Komen.this).removeAllViewsInLayout();
