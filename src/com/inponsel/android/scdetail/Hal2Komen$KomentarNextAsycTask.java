...
_L1:
            ...
            {
                this$1 = Hal2Komen.KomentarNextAsycTask.this;
                super();
            }
        });
...
_L1:
                ...
                if (android.os.Build.VERSION.SDK_INT >= 11)
                {
                    (new Hal2Komen.KomentarNextAsycTask()).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
                    return;
                }
                ...
                catch (View view)
                {
                  ...
                  goto _L1
                (new Hal2Komen.KomentarNextAsycTask()).execute(new String[0]);
                return;
            }
...
_L12:
        ...
        Hal2Komen.access$6(Hal2Komen.this, (LinearLayout)void1.findViewById(0x7f0b0766));
        if (i != 0)
        {
            break MISSING_BLOCK_LABEL_1520;
        }
        Hal2Komen.access$7(Hal2Komen.this).setVisibility(0);
        Hal2Komen.access$7(Hal2Komen.this).setBackgroundColor(0xffff0000);
