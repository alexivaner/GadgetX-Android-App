...
class this._cls2
    implements android.content.rAsycTask._cls6._cls2
{
    ...
    // Unreferenced inner class com/inponsel/android/scdetail/Hal1SCDetail$KomentarAsycTask$6

/* anonymous class */
    class Hal1SCDetail.KomentarAsycTask._cls6
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            if (Hal1SCDetail.KomentarAsycTask.access$2(Hal1SCDetail.KomentarAsycTask.this).userFunctions.isUserLoggedIn(Hal1SCDetail.KomentarAsycTask.access$2(Hal1SCDetail.KomentarAsycTask.this).getActivity()))
            {
                ...
                view.putExtra("user_id", Hal1SCDetail.KomentarAsycTask.access$2(Hal1SCDetail.KomentarAsycTask.this).user_id);
                ...
                Hal1SCDetail.KomentarAsycTask.access$2(Hal1SCDetail.KomentarAsycTask.this).startActivityForResult(view, Hal1SCDetail.access$6());
                return;
            } else
            {
                ...
                view.setPositiveButton("Tutup", new Hal1SCDetail.KomentarAsycTask._cls6._cls1());
                view.setNeutralButton("Register", new Hal1SCDetail.KomentarAsycTask._cls6._cls2());
                view.setNegativeButton("Login", new Hal1SCDetail.KomentarAsycTask._cls6._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/scdetail/Hal1SCDetail$KomentarAsycTask$6$1

/* anonymous class */
        class Hal1SCDetail.KomentarAsycTask._cls6._cls1
        ...
        // Unreferenced inner class com/inponsel/android/scdetail/Hal1SCDetail$KomentarAsycTask$6$3

/* anonymous class */
        class Hal1SCDetail.KomentarAsycTask._cls6._cls3
            implements android.content.DialogInterface.OnClickListener
        {
