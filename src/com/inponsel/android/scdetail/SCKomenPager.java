...
public class SCKomenPager extends SherlockFragmentActivity
{
    ...
    private SCKomenAdapter adapter;
    Button btnHASIL;
    Button btnPENCARIAN;
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        mViewPager = (ViewPager)findViewById(0x7f0b0059);
        adapter = new SCKomenAdapter(getSupportFragmentManager());
        ...
        btnPENCARIAN.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            final SCKomenPager this$0;

            public void onClick(View view)
            {
                SCKomenPager.mViewPager.setCurrentItem(0, true);
        ...
        btnHASIL.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                SCKomenPager.mViewPager.setCurrentItem(1, true);
