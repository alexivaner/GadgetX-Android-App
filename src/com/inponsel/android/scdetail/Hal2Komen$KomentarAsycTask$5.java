    ...
    implements android.view.mentarAsycTask._cls5
{
    ...
    public void onClick(View view)
    {
        ...
        } else
        {
            ...
            view.e("Untuk memberi penilaian harus login terlebih dahulu.");
            view.veButton("Tutup", new android.content.DialogInterface.OnClickListener() {
            ...
            view.lButton("Register", new android.content.DialogInterface.OnClickListener() {
            ...
            view.veButton("Login", new android.content.DialogInterface.OnClickListener() {
