...
class this._cls1
    implements android.view.mentarAsycTask._cls9
{
    ...
    public void onClick(View view)
    {
        ...
        if (android.os.ntStackTrace >= 11)
        {
            (new this._cls1(cess._mth2(this._cls1.this))).Executor(AsyncTask.THREAD_POOL_EXECUTOR, new Void[0]);
            return;
        } else
        {
            (new Executor(cess._mth2(this._cls1.this)))._mth1(new Void[0]);
            return;
        }
    }
