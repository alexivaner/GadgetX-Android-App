    ...
    implements android.content.sycTask._cls5._cls1
{
    ...
    // Unreferenced inner class com/inponsel/android/rsstab/RSSInteraksiActivity$KomentarAsycTask$5

/* anonymous class */
    class RSSInteraksiActivity.KomentarAsycTask._cls5
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                RSSInteraksiActivity.KomentarAsycTask.access$2(RSSInteraksiActivity.KomentarAsycTask.this).statuslike = "0";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new RSSInteraksiActivity.KomentarAsycTask._cls5._cls1());
                view.setNeutralButton("Register", new RSSInteraksiActivity.KomentarAsycTask._cls5._cls2());
                view.setNegativeButton("Login", new RSSInteraksiActivity.KomentarAsycTask._cls5._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/rsstab/RSSInteraksiActivity$KomentarAsycTask$5$2

/* anonymous class */
        class RSSInteraksiActivity.KomentarAsycTask._cls5._cls2
            implements android.content.DialogInterface.OnClickListener
        {

            final RSSInteraksiActivity.KomentarAsycTask._cls5 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                ...
                RSSInteraksiActivity.KomentarAsycTask.access$2(this$1).startActivity(dialoginterface);
                    ...
                    {
                        this$2 = RSSInteraksiActivity.KomentarAsycTask._cls5.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/rsstab/RSSInteraksiActivity$KomentarAsycTask$5$3

/* anonymous class */
        class RSSInteraksiActivity.KomentarAsycTask._cls5._cls3
            implements android.content.DialogInterface.OnClickListener
        {
