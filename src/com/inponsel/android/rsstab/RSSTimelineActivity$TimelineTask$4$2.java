...
class this._cls2
    implements android.content.ineTask._cls4._cls2
{
...
/* anonymous class */
        ...
        // Unreferenced inner class com/inponsel/android/rsstab/RSSTimelineActivity$TimelineTask$4$3

/* anonymous class */
        class RSSTimelineActivity.TimelineTask._cls4._cls3
            implements android.content.DialogInterface.OnClickListener
        {
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                RSSTimelineActivity.TimelineTask.access$2(this$1).stat = "1";
                (new RSSTimelineActivity.FavoritTask(RSSTimelineActivity.TimelineTask.access$2(this$1))).execute(new Void[0]);
            }
