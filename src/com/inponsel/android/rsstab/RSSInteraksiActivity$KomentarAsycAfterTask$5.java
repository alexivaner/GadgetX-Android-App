...
class val.user_photo
    implements android.view.sycAfterTask._cls5
{
    ...
    public void onClick(View view)
    {
        ...
        {
            view = new android.app.(cess._mth2(this._cls1.this).wrapperLight);
            view.ight("Untuk membalas komentar harus login terlebih dahulu.");
            view.ight("Tutup", new android.content.DialogInterface.OnClickListener() {
