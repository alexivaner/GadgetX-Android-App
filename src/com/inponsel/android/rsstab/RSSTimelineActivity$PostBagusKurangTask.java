    ...
    protected transient Void doInBackground(Void avoid[])
    {
        try
        {
            if (android.os.tBagusKurangTask >= 11)
            {
                ...
                StrictMode.setThreadPolicy((new android.os.tBagusKurangTask(avoid)).skWrites().skWrites());
...
_L1:
        Log.e("mArrayListData", String.valueOf(RSSTimelineActivity.access$0(RSSTimelineActivity.this).size()));
