...
class this._cls2
    implements android.content.sycTask._cls4._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/rsstab/RSSInteraksiActivity$KomentarReplyAsycTask$4

/* anonymous class */
    class RSSInteraksiActivity.KomentarReplyAsycTask._cls4
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                RSSInteraksiActivity.KomentarReplyAsycTask.access$2(RSSInteraksiActivity.KomentarReplyAsycTask.this).statuslike = "0";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new RSSInteraksiActivity.KomentarReplyAsycTask._cls4._cls1());
                view.setNeutralButton("Register", new RSSInteraksiActivity.KomentarReplyAsycTask._cls4._cls2());
                view.setNegativeButton("Login", new RSSInteraksiActivity.KomentarReplyAsycTask._cls4._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/rsstab/RSSInteraksiActivity$KomentarReplyAsycTask$4$1

/* anonymous class */
        class RSSInteraksiActivity.KomentarReplyAsycTask._cls4._cls1
        ...
        // Unreferenced inner class com/inponsel/android/rsstab/RSSInteraksiActivity$KomentarReplyAsycTask$4$2

/* anonymous class */
        class RSSInteraksiActivity.KomentarReplyAsycTask._cls4._cls2
            implements android.content.DialogInterface.OnClickListener
        {
