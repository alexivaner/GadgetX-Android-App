...
class val.tl_id
    implements android.view.sycAfterTask._cls2
{
    ...
    public void onClick(View view)
    {
        ...
        } else
        {
            ...
            view.AsycAfterTask("Untuk memberi penilaian harus login terlebih dahulu.");
            view.AsycAfterTask("Tutup", new android.content.DialogInterface.OnClickListener() {
