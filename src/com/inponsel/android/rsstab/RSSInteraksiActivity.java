...
public class RSSInteraksiActivity extends SherlockFragmentActivity
    implements Observer
{
...
_L4:
            ...
            s = ((ItemInteraksiKomen)mArrayListData.get(i)).getJudul();
...
_L15:
            ...
            txtUsername.setText(((ItemInteraksiKomen)mArrayListData.get(i)).getUser_name());
            ...
            list_lay_rep.setOnClickListener(s2. new android.view.View.OnClickListener() {
                ...
                public void onClick(View view)
                {
                    if (userFunctions.isUserLoggedIn(_fld0))
                    {
                        ...
                        Log.e("tl_id", tl_id);
                        startActivityForResult(view, RSSInteraksiActivity.POST_STAT);
                        return;
                    } else
                    {
...
_L1:
    ...
    public void KomentarNextAsycTask()
    {
        if (mLinearListView.getChildCount() == 0)
        {
            try
            {
                urlKomen = (new StringBuilder(String.valueOf(Util.BASE_PATH2))).append("timeline_interaksi_rss").append(Utility.BASE_FORMAT).append("?type=").append(type_art).append("&tag=").append(tag_art).append("&t=").append(t).append("&id_usr=").append(user_id).append("&sortkom=").append(sortkom).toString();
...
_L2:
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        bundle.setText("Interaksi di berita");
        bundle.setEllipsize(android.text.TextUtils.TruncateAt.MARQUEE);
        getSupportActionBar().setTitle(Html.fromHtml("<font color='#FFFFFF'>Interaksi di berita</font>"));
        ...
        try
        {
            ...
            bundle.setScreenName("RSS Interaksi");
