...
class this._cls2
    implements android.content.sycTask._cls5._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/rsstab/RSSInteraksiActivity$KomentarOldAsycTask$5

/* anonymous class */
    class RSSInteraksiActivity.KomentarOldAsycTask._cls5
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                RSSInteraksiActivity.KomentarOldAsycTask.access$2(RSSInteraksiActivity.KomentarOldAsycTask.this).statuslike = "0";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new RSSInteraksiActivity.KomentarOldAsycTask._cls5._cls1());
                view.setNeutralButton("Register", new RSSInteraksiActivity.KomentarOldAsycTask._cls5._cls2());
                view.setNegativeButton("Login", new RSSInteraksiActivity.KomentarOldAsycTask._cls5._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/rsstab/RSSInteraksiActivity$KomentarOldAsycTask$5$1

/* anonymous class */
        class RSSInteraksiActivity.KomentarOldAsycTask._cls5._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final RSSInteraksiActivity.KomentarOldAsycTask._cls5 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = RSSInteraksiActivity.KomentarOldAsycTask._cls5.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/rsstab/RSSInteraksiActivity$KomentarOldAsycTask$5$2

/* anonymous class */
        class RSSInteraksiActivity.KomentarOldAsycTask._cls5._cls2
            implements android.content.DialogInterface.OnClickListener
        {
