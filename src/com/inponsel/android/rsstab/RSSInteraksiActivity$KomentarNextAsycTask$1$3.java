...
class this._cls2
    implements android.content.sycTask._cls1._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/rsstab/RSSInteraksiActivity$KomentarNextAsycTask$1

/* anonymous class */
    class RSSInteraksiActivity.KomentarNextAsycTask._cls1
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                RSSInteraksiActivity.KomentarNextAsycTask.access$2(RSSInteraksiActivity.KomentarNextAsycTask.this).statuslike = "1";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new RSSInteraksiActivity.KomentarNextAsycTask._cls1._cls1());
                view.setNeutralButton("Register", new RSSInteraksiActivity.KomentarNextAsycTask._cls1._cls2());
                view.setNegativeButton("Login", new RSSInteraksiActivity.KomentarNextAsycTask._cls1._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/rsstab/RSSInteraksiActivity$KomentarNextAsycTask$1$1

/* anonymous class */
        class RSSInteraksiActivity.KomentarNextAsycTask._cls1._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final RSSInteraksiActivity.KomentarNextAsycTask._cls1 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = RSSInteraksiActivity.KomentarNextAsycTask._cls1.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/rsstab/RSSInteraksiActivity$KomentarNextAsycTask$1$2

/* anonymous class */
        class RSSInteraksiActivity.KomentarNextAsycTask._cls1._cls2
            implements android.content.DialogInterface.OnClickListener
        {
