...
class this._cls2
    implements android.content.terTask._cls2._cls2
{
    ...
    // Unreferenced inner class com/inponsel/android/rsstab/RSSInteraksiActivity$KomentarAsycAfterTask$2

/* anonymous class */
    class RSSInteraksiActivity.KomentarAsycAfterTask._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                RSSInteraksiActivity.KomentarAsycAfterTask.access$2(RSSInteraksiActivity.KomentarAsycAfterTask.this).statuslike = "1";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new RSSInteraksiActivity.KomentarAsycAfterTask._cls2._cls1());
                view.setNeutralButton("Register", new RSSInteraksiActivity.KomentarAsycAfterTask._cls2._cls2());
                view.setNegativeButton("Login", new RSSInteraksiActivity.KomentarAsycAfterTask._cls2._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/rsstab/RSSInteraksiActivity$KomentarAsycAfterTask$2$1

/* anonymous class */
        class RSSInteraksiActivity.KomentarAsycAfterTask._cls2._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final RSSInteraksiActivity.KomentarAsycAfterTask._cls2 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = RSSInteraksiActivity.KomentarAsycAfterTask._cls2.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/rsstab/RSSInteraksiActivity$KomentarAsycAfterTask$2$3

/* anonymous class */
        class RSSInteraksiActivity.KomentarAsycAfterTask._cls2._cls3
            implements android.content.DialogInterface.OnClickListener
        {
