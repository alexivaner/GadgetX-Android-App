...
class val.tl_id
    implements android.view.rOldAsycTask._cls5
{
    ...
    public void onClick(View view)
    {
        ...
        } else
        {
            ...
            view.arOldAsycTask("Untuk memberi penilaian harus login terlebih dahulu.");
            view.arOldAsycTask("Tutup", new android.content.DialogInterface.OnClickListener() {
