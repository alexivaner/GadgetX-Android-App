...
class val.fav_stat
    implements android.view.TimelineTask._cls5
{

    final Transition this$1;
    ...
    public void onClick(View view)
    {
        ...
        view = new Intent(cess._mth2(this._cls1.this), com/inponsel/android/rssfeeddetail/RSSKomenTab);
        view.putExtra("kategori_tag", cess._mth2(this._cls1.this).kategori_tag);
