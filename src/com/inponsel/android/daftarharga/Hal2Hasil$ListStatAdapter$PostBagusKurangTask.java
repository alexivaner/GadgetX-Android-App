...
public class this._cls1 extends AsyncTask
{
    ...
    protected transient Void doInBackground(Void avoid[])
    {
        try
        {
            if (android.os.r.PostBagusKurangTask > 9)
            {
                StrictMode.setThreadPolicy((new android.os.r.PostBagusKurangTask()).PostBagusKurangTask().PostBagusKurangTask());
            }
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        this._mth1(this._cls1.this).notificationLikeHelper.completed(this._mth1(this._cls1.this).namalengkapbgskrg, "Berhasil terkirim");
        if (_fld1.equals("1"))
        {
        ...
        this._mth1(this._cls1.this).notificationLikeHelper.gagal(this._mth1(this._cls1.this).namalengkapbgskrg, this._mth1(this._cls1.this).postMessageLikePon);
        return;
    }
