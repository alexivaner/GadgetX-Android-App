    ...
    implements Observer
{
    public class PostBagusKurangTask extends AsyncTask
    {
        ...
        {
            this$1 = Hal2Hasil.ListStatAdapter.this;
            super();
        }
    }
    ...
    public View getView(final int position, View view, final ViewGroup holder)
    {
        ...
        if (lm != null)
        {
            ...
            ((ViewHolder) (holder)).list_txtBigRight.setTextColor(Color.parseColor("#f2dfc7"));
            ((ViewHolder) (holder)).list_txtBigRight.setVisibility(8);
            ...
            try
            {
                Picasso.with(activity).load((new StringBuilder(String.valueOf(Util.BASE_PATH_NEWIMAGE))).append(lms.getGambar().trim()).toString()).tag(activity).into(((ViewHolder) (holder)).imageHp, new Callback() {
