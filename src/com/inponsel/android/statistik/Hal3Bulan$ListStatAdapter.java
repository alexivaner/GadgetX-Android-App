    ...
    implements Observer
{
    public class PostBagusKurangTask extends AsyncTask
    {
        ...
        {
            this$1 = Hal3Bulan.ListStatAdapter.this;
            super();
        }
    }
...
_L4:
    ...
    public ype(Activity activity1, int i, ArrayList arraylist)
    {
        ...
        try
        {
            ...
            options = (new com.nostra13.universalimageloader.core.r()).showImageForEmptyUri(0x7f020208).cacheInMemory(true).imageScaleType(ImageScaleType.EXACTLY).bitmapConfig(android.graphics.tmapConfig).build();
