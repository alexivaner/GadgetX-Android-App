    ...
    implements Observer
{
    public class PostBagusKurangTask extends AsyncTask
    {
        ...
        {
            this$1 = Hal1Hari.ListStatAdapter.this;
            super();
        }
    }
...
_L4:
    ...
    public Type(Activity activity1, int i, ArrayList arraylist)
    {
        ...
        try
        {
            ...
            options = (new com.nostra13.universalimageloader.core.er()).showImageForEmptyUri(0x7f020208).cacheInMemory(true).imageScaleType(ImageScaleType.EXACTLY).bitmapConfig(android.graphics.bitmapConfig).build();
