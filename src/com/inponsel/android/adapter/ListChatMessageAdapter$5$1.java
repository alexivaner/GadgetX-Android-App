    ...
    implements android.content.ener
{
    ...
    // Unreferenced inner class com/inponsel/android/adapter/ListChatMessageAdapter$5

/* anonymous class */
    class ListChatMessageAdapter._cls5
        implements android.view.View.OnLongClickListener
    {
        ...
        public boolean onLongClick(View view)
        {
            ...
            view.setPositiveButton("Ya", lms. new ListChatMessageAdapter._cls5._cls1());
            view.setNegativeButton("Tidak", new ListChatMessageAdapter._cls5._cls2());
            view.show();
            return false;
        }
        ...
        // Unreferenced inner class com/inponsel/android/adapter/ListChatMessageAdapter$5$2

/* anonymous class */
        class ListChatMessageAdapter._cls5._cls2
            implements android.content.DialogInterface.OnClickListener
        {

            final ListChatMessageAdapter._cls5 this$1;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$1 = ListChatMessageAdapter._cls5.this;
                        super();
                    }
        }
