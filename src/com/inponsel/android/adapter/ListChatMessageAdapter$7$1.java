    ...
    implements android.content.ener
{
    ...
    // Unreferenced inner class com/inponsel/android/adapter/ListChatMessageAdapter$7

/* anonymous class */
    class ListChatMessageAdapter._cls7
        implements android.view.View.OnLongClickListener
    {
        ...
        public boolean onLongClick(View view)
        {
            ...
            view.setPositiveButton("Ya", lms. new ListChatMessageAdapter._cls7._cls1());
            view.setNegativeButton("Tidak", new ListChatMessageAdapter._cls7._cls2());
            view.show();
            return false;
        }
        ...
        // Unreferenced inner class com/inponsel/android/adapter/ListChatMessageAdapter$7$2

/* anonymous class */
        class ListChatMessageAdapter._cls7._cls2
