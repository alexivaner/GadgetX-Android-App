...
public class ListKategoriApps2Adapter extends BaseAdapter
    implements Observer
{
    ...
    public ListKategoriApps2Adapter(Activity activity1, int i, ArrayList arraylist)
    {
        fav_stat = "";
        count_number = 0;
        user_id = "";
    ...
    public View getView(final int position, final View holder, ViewGroup viewgroup)
    {
        ...
        if (lm != null)
        {
            ...
            ((ViewHolder) (holder)).img_kat_apps_1.setLayoutParams(new android.widget.RelativeLayout.LayoutParams(i, Math.min((int)(((double)i / (double)Integer.parseInt(listmodel.getKat_img_width())) * (double)Integer.parseInt(listmodel.getKat_img_height())), (j - k) / 3)));
            if (listmodel.getKat_apps_background_img().contains(".jpeg") || listmodel.getKat_apps_background_img().contains(".jpg") || listmodel.getKat_apps_background_img().contains(".png"))
            {
                ...
                String s = listmodel.getKat_apps_background_img().trim();
                Log.e("url_image", s);
                Picasso.with(activity).load(s).tag(this).into(((ViewHolder) (holder)).img_kat_apps_1, new Callback() {
            ...
            {
                this$0 = ListKategoriApps2Adapter.this;
                holder = viewholder;
                super();
            }
                });
...
_L2:
            ...
            
            {
                ...
                super();
                    ...
                    {
                        urlPost = new android.app.AlertDialog.Builder(activity);
