...
//            ListKategoriApps3Adapter, ListModel, PonselBaseApp, ModelObserver

class val.position
    implements android.view.iApps3Adapter._cls2
{
    ...
    public void onClick(final View urlPost)
    {
        ...
        (new AsyncHttpClient()).get(urlPost, new AsyncHttpResponseHandler() {
            ...
            final ListKategoriApps3Adapter._cls2 this$1;
            private final int val$position;
...
_L2:
            ...
            {
                this$1 = ListKategoriApps3Adapter._cls2.this;
                urlPost = s;
                position = i;
                super();
            }
