...
class Holder extends AsyncHttpResponseHandler
{
    ...
    final Holder.txt_fav_kat_apps_1 this$1;
    ...
    public void onSuccess(int i, Header aheader[], byte abyte0[])
    {
        ...
        try
        {
            ...
            val$holder.txt_fav_kat_apps_1.setText(fav_stat);
        }
        ...
        ponselBaseApp.setObserver().setStatus_like_ponsel(val$holder.txt_fav_kat_apps_1.getText().toString());
    }
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(final View urlPost)
        {
            if (userFunctions.isUserLoggedIn(ListKategoriApps2Adapter.access$0(ListKategoriApps2Adapter.this)))
            {
                ...
                (new AsyncHttpClient()).get(urlPost, holder. new ListKategoriApps2Adapter._cls3._cls1());
                return;
            } else
            {
