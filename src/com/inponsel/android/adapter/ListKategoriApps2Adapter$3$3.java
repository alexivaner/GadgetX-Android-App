    ...
    implements android.content.er
{
    ...
    {
        dialoginterface = new Intent(ListKategoriApps2Adapter.access$0(_fld0), com/inponsel/android/v2/RegisterActivity);
        ListKategoriApps2Adapter.access$0(_fld0).startActivityForResult(dialoginterface, 0);
        ListKategoriApps2Adapter.access$0(_fld0).overridePendingTransition(0x7f040003, 0x7f040004);
    }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/inponsel/android/adapter/ListKategoriApps2Adapter$3$2

/* anonymous class */
        class ListKategoriApps2Adapter._cls3._cls2
