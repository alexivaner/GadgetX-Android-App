...
public class NewsSlideAdapter extends PagerAdapter
{
    ...
    public NewsSlideAdapter(FragmentActivity fragmentactivity, List list)
    {
    ...
    {
        View view = ((LayoutInflater)activity.getSystemService("layout_inflater")).inflate(0x7f030144, viewgroup, false);
        final Product product = (Product)products.get(i);
        final ImageView imageMedia = (ImageView)view.findViewById(0x7f0b046c);
        TextView textview = (TextView)view.findViewById(0x7f0b05ec);
        TextView textview1 = (TextView)view.findViewById(0x7f0b0419);
        RelativeLayout relativelayout = (RelativeLayout)view.findViewById(0x7f0b0911);
        textview.setText(product.getName());
        textview1.setText(product.getSumber());
        ...
        try
        {
            Picasso.with(activity).load((new StringBuilder(String.valueOf(Util.BASE_URL_THUMB_ORI))).append("w=").append(j).append("&src=").append(((Product)products.get(i)).getImageUrl()).toString()).into(imageMedia, new Callback() {
                ...
                public void onError()
                {
                    imageMedia.setImageResource(0x7f020209);
                }
