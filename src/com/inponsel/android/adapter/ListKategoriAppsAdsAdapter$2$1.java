...
//            ListKategoriAppsAdsAdapter, PonselBaseApp, ListModel, ModelObserver
...
_L2:
    ...
    // Unreferenced inner class com/inponsel/android/adapter/ListKategoriAppsAdsAdapter$2

/* anonymous class */
    class ListKategoriAppsAdsAdapter._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(final View urlPost)
        {
            ...
            (new AsyncHttpClient()).get(urlPost, position. new ListKategoriAppsAdsAdapter._cls2._cls1());
        }
