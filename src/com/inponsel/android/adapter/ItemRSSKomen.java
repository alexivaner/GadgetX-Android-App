...
public class ItemRSSKomen
{
    ...
    public ItemRSSKomen(String s, String s1, String s2, String s3, String s4, String s5, String s6, 
    ...
    public void setImg_media(String s)
    {
        img_media = s;
    }

    public void setImg_media_to(String s)
    {
        img_media_to = s;
    }
