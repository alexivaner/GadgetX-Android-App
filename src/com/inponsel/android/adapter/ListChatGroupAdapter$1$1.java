    ...
    implements android.content.stener
{
    ...
    // Unreferenced inner class com/inponsel/android/adapter/ListChatGroupAdapter$1

/* anonymous class */
    class ListChatGroupAdapter._cls1
        implements android.view.View.OnLongClickListener
    {
        ...
        public boolean onLongClick(View view)
        {
            ...
            view.setPositiveButton("Ya", lms. new ListChatGroupAdapter._cls1._cls1());
            view.setNegativeButton("Tidak", new ListChatGroupAdapter._cls1._cls2());
            view.show();
            return false;
        }
        ...
        // Unreferenced inner class com/inponsel/android/adapter/ListChatGroupAdapter$1$2

/* anonymous class */
        class ListChatGroupAdapter._cls1._cls2
            implements android.content.DialogInterface.OnClickListener
        {

            final ListChatGroupAdapter._cls1 this$1;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$1 = ListChatGroupAdapter._cls1.this;
                        super();
                    }
        }
