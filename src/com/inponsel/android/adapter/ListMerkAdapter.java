...
public class ListMerkAdapter extends BaseAdapter
{
    ...
    public ListMerkAdapter(Activity activity1, int i, ArrayList arraylist)
    {
        lm = arraylist;
        activity = activity1;
        resource = i;
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        if (lm != null)
        {
            ((ViewHolder) (view)).homeMerek.setText(listmodel.getMerk());
            ((ViewHolder) (view)).headImage.setVisibility(8);
        }
        return viewgroup;
    }
