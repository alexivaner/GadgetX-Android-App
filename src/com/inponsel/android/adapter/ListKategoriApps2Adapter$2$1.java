...
//            ListKategoriApps2Adapter, PonselBaseApp, ListModel, ModelObserver
...
_L2:
    ...
    // Unreferenced inner class com/inponsel/android/adapter/ListKategoriApps2Adapter$2

/* anonymous class */
    class ListKategoriApps2Adapter._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(final View urlPost)
        {
            ...
            (new AsyncHttpClient()).get(urlPost, position. new ListKategoriApps2Adapter._cls2._cls1());
        }
