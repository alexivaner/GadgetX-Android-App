...
class this._cls2
    implements android.content.NextAsycTask._cls1._cls1
{
    ...
    // Unreferenced inner class com/inponsel/android/globalforum/ForumInteraksiActivity$KomentarNextAsycTask$1

/* anonymous class */
    class ForumInteraksiActivity.KomentarNextAsycTask._cls1
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                ForumInteraksiActivity.KomentarNextAsycTask.access$2(ForumInteraksiActivity.KomentarNextAsycTask.this).statuslike = "1";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new ForumInteraksiActivity.KomentarNextAsycTask._cls1._cls1());
                view.setNeutralButton("Register", new ForumInteraksiActivity.KomentarNextAsycTask._cls1._cls2());
                view.setNegativeButton("Login", new ForumInteraksiActivity.KomentarNextAsycTask._cls1._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/globalforum/ForumInteraksiActivity$KomentarNextAsycTask$1$2

/* anonymous class */
        class ForumInteraksiActivity.KomentarNextAsycTask._cls1._cls2
            implements android.content.DialogInterface.OnClickListener
        {

            final ForumInteraksiActivity.KomentarNextAsycTask._cls1 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                ...
                ForumInteraksiActivity.KomentarNextAsycTask.access$2(this$1).startActivity(dialoginterface);
                    ...
                    {
                        this$2 = ForumInteraksiActivity.KomentarNextAsycTask._cls1.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/globalforum/ForumInteraksiActivity$KomentarNextAsycTask$1$3

/* anonymous class */
        class ForumInteraksiActivity.KomentarNextAsycTask._cls1._cls3
            implements android.content.DialogInterface.OnClickListener
        {
