...
class val.user_photo
    implements android.view.ntarAsycAfterTask._cls5
{
    ...
    public void onClick(View view)
    {
        ...
        {
            view = new android.app.ess._cls4(cess._mth2(this._cls1.this).wrapperLight);
            view.pperLight("Untuk membalas komentar harus login terlebih dahulu.");
            view.pperLight("Tutup", new android.content.DialogInterface.OnClickListener() {
