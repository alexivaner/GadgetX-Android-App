...
class this._cls2
    implements android.content.rOldAsycTask._cls3._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/globalforum/ForumInteraksiActivity$KomentarOldAsycTask$3

/* anonymous class */
    class ForumInteraksiActivity.KomentarOldAsycTask._cls3
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                ForumInteraksiActivity.KomentarOldAsycTask.access$2(ForumInteraksiActivity.KomentarOldAsycTask.this).statuslike = "1";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new ForumInteraksiActivity.KomentarOldAsycTask._cls3._cls1());
                view.setNeutralButton("Register", new ForumInteraksiActivity.KomentarOldAsycTask._cls3._cls2());
                view.setNegativeButton("Login", new ForumInteraksiActivity.KomentarOldAsycTask._cls3._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/globalforum/ForumInteraksiActivity$KomentarOldAsycTask$3$1

/* anonymous class */
        class ForumInteraksiActivity.KomentarOldAsycTask._cls3._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final ForumInteraksiActivity.KomentarOldAsycTask._cls3 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = ForumInteraksiActivity.KomentarOldAsycTask._cls3.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/globalforum/ForumInteraksiActivity$KomentarOldAsycTask$3$2

/* anonymous class */
        class ForumInteraksiActivity.KomentarOldAsycTask._cls3._cls2
            implements android.content.DialogInterface.OnClickListener
        {
