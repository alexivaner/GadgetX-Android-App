...
class this._cls2
    implements android.content.sycAfterTask._cls2._cls1
{
    ...
    // Unreferenced inner class com/inponsel/android/globalforum/ForumInteraksiActivity$KomentarAsycAfterTask$2

/* anonymous class */
    class ForumInteraksiActivity.KomentarAsycAfterTask._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                ForumInteraksiActivity.KomentarAsycAfterTask.access$2(ForumInteraksiActivity.KomentarAsycAfterTask.this).statuslike = "1";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new ForumInteraksiActivity.KomentarAsycAfterTask._cls2._cls1());
                view.setNeutralButton("Register", new ForumInteraksiActivity.KomentarAsycAfterTask._cls2._cls2());
                view.setNegativeButton("Login", new ForumInteraksiActivity.KomentarAsycAfterTask._cls2._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/globalforum/ForumInteraksiActivity$KomentarAsycAfterTask$2$2

/* anonymous class */
        class ForumInteraksiActivity.KomentarAsycAfterTask._cls2._cls2
            implements android.content.DialogInterface.OnClickListener
        {

            final ForumInteraksiActivity.KomentarAsycAfterTask._cls2 this$2;

            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface = new Intent(ForumInteraksiActivity.KomentarAsycAfterTask.access$2(this$1), com/inponsel/android/v2/RegisterActivity);
                ForumInteraksiActivity.KomentarAsycAfterTask.access$2(this$1).startActivity(dialoginterface);
            }

                    
                    {
                        this$2 = ForumInteraksiActivity.KomentarAsycAfterTask._cls2.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/globalforum/ForumInteraksiActivity$KomentarAsycAfterTask$2$3

/* anonymous class */
        class ForumInteraksiActivity.KomentarAsycAfterTask._cls2._cls3
            implements android.content.DialogInterface.OnClickListener
        {
