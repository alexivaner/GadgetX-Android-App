...
class val.like_stat
    implements android.view.umGlobalActivity._cls38
{
    ...
    {
        idkom_pos = val$tl_id;
        view = new Intent(ForumGlobalActivity.this, com/inponsel/android/timelinedetail/Hal1TLDetailActivity);
        ...
        view.putExtra("tl_kota", val$tl_kota);
        Log.e("tl_tags", val$tl_tag);
        ...
        view.putExtra("resolution", resolution);
