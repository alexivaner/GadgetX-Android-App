...
_L9:
        ...
        try
        {
            if (i >= ForumInteraksiActivity.access$1(ForumInteraksiActivity.this).size())
            {
...
_L12:
        ...
        ForumInteraksiActivity.access$0(ForumInteraksiActivity.this).addView(void1, 0);
        img_kom_picture.setOnLongClickListener(new android.view.View.OnLongClickListener() {
            ...
            {
                this$1 = ForumInteraksiActivity.KomentarOldAsycTask.this;
                user_photo = s;
                super();
            }
        });
