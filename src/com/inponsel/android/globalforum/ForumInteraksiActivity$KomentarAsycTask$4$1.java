...
class this._cls2
    implements android.content.ntarAsycTask._cls4._cls1
{
    ...
    // Unreferenced inner class com/inponsel/android/globalforum/ForumInteraksiActivity$KomentarAsycTask$4

/* anonymous class */
    class ForumInteraksiActivity.KomentarAsycTask._cls4
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                ForumInteraksiActivity.KomentarAsycTask.access$2(ForumInteraksiActivity.KomentarAsycTask.this).statuslike = "1";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new ForumInteraksiActivity.KomentarAsycTask._cls4._cls1());
                view.setNeutralButton("Register", new ForumInteraksiActivity.KomentarAsycTask._cls4._cls2());
                view.setNegativeButton("Login", new ForumInteraksiActivity.KomentarAsycTask._cls4._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/globalforum/ForumInteraksiActivity$KomentarAsycTask$4$2

/* anonymous class */
        class ForumInteraksiActivity.KomentarAsycTask._cls4._cls2
            implements android.content.DialogInterface.OnClickListener
        {

            final ForumInteraksiActivity.KomentarAsycTask._cls4 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                ...
                ForumInteraksiActivity.KomentarAsycTask.access$2(this$1).startActivity(dialoginterface);
                    ...
                    {
                        this$2 = ForumInteraksiActivity.KomentarAsycTask._cls4.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/globalforum/ForumInteraksiActivity$KomentarAsycTask$4$3

/* anonymous class */
        class ForumInteraksiActivity.KomentarAsycTask._cls4._cls3
            implements android.content.DialogInterface.OnClickListener
        {
