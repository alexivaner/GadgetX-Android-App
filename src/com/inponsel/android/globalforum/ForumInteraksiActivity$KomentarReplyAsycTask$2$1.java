...
class this._cls2
    implements android.content.eplyAsycTask._cls2._cls1
{
    ...
    // Unreferenced inner class com/inponsel/android/globalforum/ForumInteraksiActivity$KomentarReplyAsycTask$2

/* anonymous class */
    class ForumInteraksiActivity.KomentarReplyAsycTask._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                ForumInteraksiActivity.KomentarReplyAsycTask.access$2(ForumInteraksiActivity.KomentarReplyAsycTask.this).statuslike = "1";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new ForumInteraksiActivity.KomentarReplyAsycTask._cls2._cls1());
                view.setNeutralButton("Register", new ForumInteraksiActivity.KomentarReplyAsycTask._cls2._cls2());
                view.setNegativeButton("Login", new ForumInteraksiActivity.KomentarReplyAsycTask._cls2._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/globalforum/ForumInteraksiActivity$KomentarReplyAsycTask$2$2

/* anonymous class */
        class ForumInteraksiActivity.KomentarReplyAsycTask._cls2._cls2
            implements android.content.DialogInterface.OnClickListener
        {

            final ForumInteraksiActivity.KomentarReplyAsycTask._cls2 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                ...
                ForumInteraksiActivity.KomentarReplyAsycTask.access$2(this$1).startActivity(dialoginterface);
                    ...
                    {
                        this$2 = ForumInteraksiActivity.KomentarReplyAsycTask._cls2.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/globalforum/ForumInteraksiActivity$KomentarReplyAsycTask$2$3

/* anonymous class */
        class ForumInteraksiActivity.KomentarReplyAsycTask._cls2._cls3
            implements android.content.DialogInterface.OnClickListener
        {
