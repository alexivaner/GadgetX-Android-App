...
_L1:
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        if (ForumInteraksiActivity.access$1(ForumInteraksiActivity.this).size() < 15)
        {
...
_L3:
        txtbtnheader.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            {
                this$1 = ForumInteraksiActivity.KomentarAsycAfterTask.this;
                super();
            }
        });
...
_L4:
        ...
        id_user = ((ItemInteraksiKomen)ForumInteraksiActivity.access$1(ForumInteraksiActivity.this).get(i)).getId_user();
        ...
        if (!((ItemInteraksiKomen)ForumInteraksiActivity.access$1(ForumInteraksiActivity.this).get(i)).getUser_name_to().toString().trim().equals("-") && !((ItemInteraksiKomen)ForumInteraksiActivity.access$1(ForumInteraksiActivity.this).get(i)).getUser_name_to().toString().trim().equals("")) goto _L7; else goto _L6
_L6:
        lay_quote.setVisibility(8);
_L13:
        if (!((ItemInteraksiKomen)ForumInteraksiActivity.access$1(ForumInteraksiActivity.this).get(i)).getMy_like_kom().toString().equals("1")) goto _L9; else goto _L8
_L8:
...
_L2:
    ...
    protected void onPreExecute()
    {
        ...
        mPullRefreshScrollView.setVisibility(8);
        layout_empty.setVisibility(0);
        ForumInteraksiActivity.access$0(ForumInteraksiActivity.this).removeAllViewsInLayout();
