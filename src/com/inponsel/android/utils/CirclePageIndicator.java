    ...
    implements PageIndicator
{
    ...
    {
        this(context, attributeset, 0x7f0100ac);
    }
    ...
    public CirclePageIndicator(Context context, AttributeSet attributeset, int i)
    {
        ...
        int j = ((Resources) (obj)).getColor(0x7f080029);
        int k = ((Resources) (obj)).getColor(0x7f08017e);
        int l = ((Resources) (obj)).getInteger(0x7f0a0006);
        int i1 = ((Resources) (obj)).getColor(0x7f08002a);
        float f = ((Resources) (obj)).getDimension(0x7f090013);
        float f1 = ((Resources) (obj)).getDimension(0x7f090012);
        boolean flag = ((Resources) (obj)).getBoolean(0x7f070009);
        boolean flag1 = ((Resources) (obj)).getBoolean(0x7f07000a);
        attributeset = context.obtainStyledAttributes(attributeset, com.inponsel.android.R.styleable.CirclePageIndicator, i, 0);
