    ...
    protected transient Void doInBackground(Void avoid[])
    {
        try
        {
            if (android.os.agusKurangRSSTask >= 11)
            {
                ...
                StrictMode.setThreadPolicy((new android.os.agusKurangRSSTask(avoid)).Writes().Writes());
...
_L1:
        Log.e("mArrayListDataTW", String.valueOf(FavoritPonselMerek.access$0(FavoritPonselMerek.this).size()));
