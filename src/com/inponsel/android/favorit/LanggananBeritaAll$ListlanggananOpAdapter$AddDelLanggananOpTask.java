...
public class this._cls1 extends AsyncTask
{
    ...
    protected transient Void doInBackground(Void avoid[])
    {
        try
        {
            doInBackground(this._cls1.this).querydel = (new StringBuilder("idhp=")).append(this._mth1(this._cls1.this).id_hp_del).append("&idusr=").append(this._mth1(this._cls1.this).user_id).append("&stat=").append("0").append("&type=op").append("&t=").append(_fld1).toString();
...
_L3:
        this._mth1(this._cls1.this).langgananOpAdapter._mth1();
        return;
_L2:
label0:
        {
