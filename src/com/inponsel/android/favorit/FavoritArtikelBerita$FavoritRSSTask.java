...
_L1:
        ...
        FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).add(new ItemRSS(((JSONObject) (obj)).getString("id"), ((JSONObject) (obj)).getString("rss_id"), ((JSONObject) (obj)).getString("rss_title"), ((JSONObject) (obj)).getString("rss_portal"), ((JSONObject) (obj)).getString("rss_desc"), ((JSONObject) (obj)).getString("rss_content"), ((JSONObject) (obj)).getString("rss_srclink"), ((JSONObject) (obj)).getString("rss_date"), ((JSONObject) (obj)).getString("rss_img_ava"), ((JSONObject) (obj)).getString("rss_img"), ((JSONObject) (obj)).getJSONObject("likedislike").getString("total_like"), ((JSONObject) (obj)).getJSONObject("likedislike").getString("total_komen"), "", ((JSONObject) (obj)).getJSONObject("likedislike").getString("my_like_rss"), ((JSONObject) (obj)).getJSONObject("likedislike").getString("my_fav_rss")));
    ...
    {
        Log.e("mArrayListDataRSS", String.valueOf(FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).size()));
        progressbar_RSSFav.setVisibility(8);
        FavoritArtikelBerita.access$1(FavoritArtikelBerita.this).removeAllViewsInLayout();
        FavoritArtikelBerita.access$1(FavoritArtikelBerita.this).removeAllViews();
        if (FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).size() <= 0)
        {
...
_L7:
        ...
        try
        {
            if (i >= FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).size())
            {
                return;
            }
        }
        ...
        id_rss = ((ItemRSS)FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).get(i)).getId();
        rss_id = ((ItemRSS)FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).get(i)).getRss_id();
        rss_title = ((ItemRSS)FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).get(i)).getRss_title();
        rss_portal = ((ItemRSS)FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).get(i)).getRss_portal();
        rss_desc = ((ItemRSS)FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).get(i)).getRss_desc();
        rss_content = ((ItemRSS)FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).get(i)).getRss_content();
        rss_srclink = ((ItemRSS)FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).get(i)).getRss_srclink();
        rss_date = ((ItemRSS)FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).get(i)).getRss_date();
        rss_img_ava = ((ItemRSS)FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).get(i)).getRss_img_ava();
        rss_img = ((ItemRSS)FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).get(i)).getRss_img();
        total_like = ((ItemRSS)FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).get(i)).getRss_tot_like();
        like_stat = ((ItemRSS)FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).get(i)).getRss_like_stat();
        total_komen = ((ItemRSS)FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).get(i)).getRss_tot_komen();
        fav_stat = ((ItemRSS)FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).get(i)).getRss_fav_stat();
        txt_fav_news_1.setText(fav_stat);
        Log.e("fav471", fav_stat);
...
_L9:
        imageLoader2.displayImage((new StringBuilder()).append(((ItemRSS)FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).get(i)).getRss_img_ava().toString().trim()).toString(), img_kom_picture, FavoritArtikelBerita.access$2(FavoritArtikelBerita.this), FavoritArtikelBerita.access$3(FavoritArtikelBerita.this));
        if (!((ItemRSS)FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).get(i)).getRss_img().trim().equals("")) goto _L6; else goto _L5
_L5:
        imageMedia.setVisibility(8);
_L10:
        txtWaktu.setText(Utility.convertDate(((ItemRSS)FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).get(i)).getRss_date()));
        FavoritArtikelBerita.access$1(FavoritArtikelBerita.this).addView(void1);
        imageMedia.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            {
                this$1 = FavoritArtikelBerita.FavoritRSSTask.this;
                rss_img = s;
                super();
            }
        });
        ...
        list_lay_like.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                if (userFunctions.isUserLoggedIn(this$0))
                {
                    ...
                    {
                        (new FavoritArtikelBerita.PostBagusKurangRSSTask(this$0)).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Void[0]);
                        return;
                    } else
                    {
                        (new FavoritArtikelBerita.PostBagusKurangRSSTask(this$0)).execute(new Void[0]);
                        return;
                    }
                } else
                {
                ...
                super();
                    ...
                    } else
                    {
                        ...
                        view.setPositiveButton("Ya", new android.content.DialogInterface.OnClickListener() {
                            ...
                            {
                                stat = "1";
                                (new FavoritArtikelBerita.FavoritRSSTask(null)).execute(new String[0]);
                            }
...
label1:
        ...
        imageview1.setBackgroundResource(0x7f020302);
          goto _L9
_L6:
        imageLoader2.displayImage((new StringBuilder()).append(((ItemRSS)FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).get(i)).getRss_img().toString().trim()).toString(), imageMedia, FavoritArtikelBerita.access$4(FavoritArtikelBerita.this), FavoritArtikelBerita.access$3(FavoritArtikelBerita.this));
          goto _L10
        progressbar_RSSFav.setVisibility(8);
    ...
    protected void onPreExecute()
    {
        ...
        FavoritArtikelBerita.access$0(FavoritArtikelBerita.this).clear();
        db.resetRSSTables();
    }
