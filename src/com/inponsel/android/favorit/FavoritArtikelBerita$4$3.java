    ...
    implements android.content.stener
{
    ...
    final ritRSSTask.execute this$1;

    public void onClick(DialogInterface dialoginterface, int i)
    {
        stat = "1";
        (new ritRSSTask(_fld0, null)).execute(new String[0]);
    }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/inponsel/android/favorit/FavoritArtikelBerita$4$7

/* anonymous class */
        class FavoritArtikelBerita._cls4._cls7
            implements android.content.DialogInterface.OnClickListener
        {
