    ...
    implements android.widget.ckListener
{
    ...
    public void onItemClick(AdapterView adapterview, View view, int i, long l)
    {
        ...
        adapterview.putExtra("tag_key", (new StringBuilder("op:")).append(langgananOpAdapter.getListModel(i).getId_hp()).toString());
        adapterview.putExtra("kategori_tag", langgananOpAdapter.getListModel(i).getMerk());
        startActivityForResult(adapterview, 0);
        overridePendingTransition(0x7f040003, 0x7f040004);
    }

    stlanggananOpAdapter()
    {
