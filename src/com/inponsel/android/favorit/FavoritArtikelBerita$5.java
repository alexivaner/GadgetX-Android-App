...
class val.total_komen
    implements android.view.ArtikelBerita._cls5
{
    ...
    public void onClick(View view)
    {
        ...
        view = new Intent(FavoritArtikelBerita.this, com/inponsel/android/rssfeeddetail/RSSDetailTab);
