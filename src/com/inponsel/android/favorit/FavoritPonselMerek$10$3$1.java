...
class val.id extends AsyncHttpResponseHandler
{
    ...
    public void onSuccess(int i, Header aheader[], byte abyte0[])
    {
        ...
        FavoritPonselMerek.access$6(_fld0);
        if (fav_stat.equals("1"))
        {
            notificationLikeHelper.completed(val$kategori, "Berhasil menambahkan ke favorit");
        } else
        {
            notificationLikeHelper.completed(val$kategori, "Berhasil menghapus ke favorit");
        }
...
_L3:
            ...
            aheader.setOnClickListener(new FavoritPonselMerek._cls10._cls2());
            ll_fav_apps.setOnClickListener(kategori. new FavoritPonselMerek._cls10._cls3());
            i++;
              goto _L7
        }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/inponsel/android/favorit/FavoritPonselMerek$10$2

/* anonymous class */
        class FavoritPonselMerek._cls10._cls2
