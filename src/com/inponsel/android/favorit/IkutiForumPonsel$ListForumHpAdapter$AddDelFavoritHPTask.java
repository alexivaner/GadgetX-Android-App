...
public class this._cls1 extends AsyncTask
{
    ...
    protected transient Void doInBackground(Void avoid[])
    {
        try
        {
            doInBackground(this._cls1.this).querydel = (new StringBuilder("idhp=")).append(this._mth1(this._cls1.this).id_hp_del).append("&idusr=").append(this._mth1(this._cls1.this).user_id).append("&idconv=").append(this._mth1(this._cls1.this).codename).append("&stat=0").append("&type=").append("all").append("&t=").append(_fld1).toString();
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        try
        {
            if (onPostExecute(this._cls1.this).postStatusSubsNews.equals("1") || this._mth1(this._cls1.this).postStatusSubsNews.equals("10"))
            {
                _fld1.dismiss();
        ...
        {
            Toast.makeText(this._mth1(this._cls1.this), this._mth1(this._cls1.this).postMessageSubsNews, 1).show();
            this._mth1(this._cls1.this).ForumHpAdapter.();
            .dismiss();
            return;
        }
        if ((this._cls1.this).postStatusSubsNews.equals("40404"))
        {
            Toast.makeText(this._mth1(this._cls1.this), this._mth1(this._cls1.this).postMessageSubsNews, 1).show();
            _fld1.dismiss();
            return;
