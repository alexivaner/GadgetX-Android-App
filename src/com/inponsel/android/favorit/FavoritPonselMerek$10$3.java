...
class val.kategori
    implements android.view.onselMerek._cls10._cls3
{
    ...
    {
        Log.e("postfav", val$myfav);
        Log.e("id", val$id);
        Log.e("kategori", val$kategori);
        fav_stat = "0";
        urlPost = (new StringBuilder(String.valueOf(Util.BASE_PATH_STORE))).append("add_fav_applist.php?").append("t=").append(t).append("&id_user=").append(user_id).append("&status=").append(fav_stat).append("&id_kat=").append(val$id).toString();
        (new AsyncHttpClient()).get(urlPost, new AsyncHttpResponseHandler() {
            ...
            {
                this$2 = FavoritPonselMerek._cls10._cls3.this;
                kategori = s;
                urlPost = s1;
                id = s2;
                super();
