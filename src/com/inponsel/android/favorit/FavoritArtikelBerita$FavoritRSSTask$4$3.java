...
class this._cls2
    implements android.content.tRSSTask._cls4._cls3
{
    ...
    {
        ss._mth3(_fld1).stat = "1";
        (new t>(ss._mth3(_fld1), null)).ute(new String[0]);
    }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/inponsel/android/favorit/FavoritArtikelBerita$FavoritRSSTask$4$4

/* anonymous class */
        class FavoritArtikelBerita.FavoritRSSTask._cls4._cls4
            implements android.content.DialogInterface.OnClickListener
        {
