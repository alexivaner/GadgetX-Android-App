...
_L5:
    ...
    // Unreferenced inner class com/inponsel/android/favorit/LanggananBeritaAll$5

/* anonymous class */
    class LanggananBeritaAll._cls5
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            listSearchAdapter = new LanggananBeritaAll.ListSearchAdapter(LanggananBeritaAll.this, LanggananBeritaAll.this, 0x7f0300c2, listSearchArrayList);
            listFindDev.setAdapter(listSearchAdapter);
            edtAuto.setSingleLine(true);
            edtAuto.setOnEditorActionListener(new LanggananBeritaAll._cls5._cls1());
            edtAuto.addTextChangedListener(new LanggananBeritaAll._cls5._cls2(2000L));
        ...
        // Unreferenced inner class com/inponsel/android/favorit/LanggananBeritaAll$5$2

/* anonymous class */
        class LanggananBeritaAll._cls5._cls2 extends DelayedTextWatcher
        {

            final LanggananBeritaAll._cls5 this$1;
...
_L3:
                    ...
                    {
                        this$1 = LanggananBeritaAll._cls5.this;
                        super(l);
                    }
        }
