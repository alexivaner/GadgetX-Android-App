    ...
    implements android.widget.ckListener
{
    ...
    public void onItemClick(AdapterView adapterview, View view, int i, long l)
    {
        ...
        adapterview.putExtra("tag_key", (new StringBuilder("br:")).append(mereknAdapter.getListModel(i).getId_hp()).toString());
        adapterview.putExtra("kategori_tag", mereknAdapter.getListModel(i).getMerk());
