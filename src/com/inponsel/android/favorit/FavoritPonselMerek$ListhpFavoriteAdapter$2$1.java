...
class this._cls2
    implements android.content.eAdapter._cls2._cls1
{
    ...
    public void onClick(DialogInterface dialoginterface, int i)
    {
        ...
        {
            (new elFavoritHPTask(_fld1)).execute(new Void[0]);
            return;
        } else
        {
...
/* anonymous class */
        ...
        implements android.view.View.OnClickListener
    {
        ...
        // Unreferenced inner class com/inponsel/android/favorit/FavoritPonselMerek$ListhpFavoriteAdapter$2$2

/* anonymous class */
        class FavoritPonselMerek.ListhpFavoriteAdapter._cls2._cls2
