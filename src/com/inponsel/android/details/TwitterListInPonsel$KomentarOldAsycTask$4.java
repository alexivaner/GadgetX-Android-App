...
class val.avatar
    implements android.view.arOldAsycTask._cls4
{
    ...
    {
        view = new ArrayList();
        view.add((new StringBuilder(String.valueOf(Util.BASE_PATH_AVATAR))).append(val$avatar.toString().trim()).toString());
