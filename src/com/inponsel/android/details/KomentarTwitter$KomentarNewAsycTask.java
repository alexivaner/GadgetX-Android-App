            ...
            txtbtnheader.setOnClickListener(new android.view.View.OnClickListener() {
                ...
                public void onClick(View view)
                {
                    try
                    {
                        ...
                        {
                            (new KomentarTwitter.KomentarNewAsycTask()).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
                            return;
                        }
                    }
                    ...
                    (new KomentarTwitter.KomentarNewAsycTask()).execute(new String[0]);
                    return;
                }

            
            {
                this$1 = KomentarTwitter.KomentarNewAsycTask.this;
                super();
            }
            });
