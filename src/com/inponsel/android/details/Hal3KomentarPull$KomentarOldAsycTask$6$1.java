    ...
    implements android.content.AsycTask._cls6._cls1
{
    ...
    // Unreferenced inner class com/inponsel/android/details/Hal3KomentarPull$KomentarOldAsycTask$6

/* anonymous class */
    class Hal3KomentarPull.KomentarOldAsycTask._cls6
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                view = new Intent(Hal3KomentarPull.KomentarOldAsycTask.access$2(Hal3KomentarPull.KomentarOldAsycTask.this).getActivity(), com/inponsel/android/v2/ReplyFormActivity);
                ...
                view.putExtra("nmlengkap", Hal3KomentarPull.KomentarOldAsycTask.access$2(Hal3KomentarPull.KomentarOldAsycTask.this).namalengkap);
                view.putExtra("userpict", usr_pict_komen);
                view.putExtra("codename", codename);
                view.putExtra("top_id", Hal3KomentarPull.KomentarOldAsycTask.access$2(Hal3KomentarPull.KomentarOldAsycTask.this).top_id);
                Hal3KomentarPull.KomentarOldAsycTask.access$2(Hal3KomentarPull.KomentarOldAsycTask.this).startActivityForResult(view, Hal3KomentarPull.access$3());
                return;
            } else
            {
                ...
                view.setPositiveButton("Tutup", new Hal3KomentarPull.KomentarOldAsycTask._cls6._cls1());
                view.setNeutralButton("Register", new Hal3KomentarPull.KomentarOldAsycTask._cls6._cls2());
                view.setNegativeButton("Login", new Hal3KomentarPull.KomentarOldAsycTask._cls6._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/details/Hal3KomentarPull$KomentarOldAsycTask$6$2

/* anonymous class */
        class Hal3KomentarPull.KomentarOldAsycTask._cls6._cls2
        ...
        // Unreferenced inner class com/inponsel/android/details/Hal3KomentarPull$KomentarOldAsycTask$6$3

/* anonymous class */
        class Hal3KomentarPull.KomentarOldAsycTask._cls6._cls3
            implements android.content.DialogInterface.OnClickListener
        {
