    ...
    implements android.content.ClickListener
{
    ...
    // Unreferenced inner class com/inponsel/android/details/Hal1Ikhtisar$14

/* anonymous class */
    class Hal1Ikhtisar._cls14
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            if (userFunction.isUserLoggedIn(getActivity()))
            {
                ...
                builder.setSingleChoiceItems(view, -1, view. new Hal1Ikhtisar._cls14._cls1());
                builder.show();
                return;
            } else
            {
                ...
                view.setPositiveButton("Login", new Hal1Ikhtisar._cls14._cls2());
                view.setNeutralButton("Register", new Hal1Ikhtisar._cls14._cls3());
                view.setNegativeButton("Tutup", new Hal1Ikhtisar._cls14._cls4());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/details/Hal1Ikhtisar$14$2

/* anonymous class */
        class Hal1Ikhtisar._cls14._cls2
        ...
        // Unreferenced inner class com/inponsel/android/details/Hal1Ikhtisar$14$3

/* anonymous class */
        class Hal1Ikhtisar._cls14._cls3
            implements android.content.DialogInterface.OnClickListener
        {
        ...
        // Unreferenced inner class com/inponsel/android/details/Hal1Ikhtisar$14$4

/* anonymous class */
        class Hal1Ikhtisar._cls14._cls4
            implements android.content.DialogInterface.OnClickListener
        {
