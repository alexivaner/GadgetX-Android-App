        ...
        txtbtnheader.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                try
                {
                    ...
                    {
                        (new Hal3KomentarPull.KomentarNextAsycTask(this$0)).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
                        return;
                    }
                }
                ...
                (new Hal3KomentarPull.KomentarNextAsycTask(this$0)).execute(new String[0]);
                return;
            }

            
            {
                this$1 = Hal3KomentarPull.KomentarAsycTask.this;
                super();
            }
        });
...
_L4:
        ...
        if (!((ItemKomenHp)Hal3KomentarPull.access$1(Hal3KomentarPull.this).get(i)).getReply_to().toString().trim().equals("0")) goto _L9; else goto _L8
_L8:
        lay_quote.setVisibility(8);
_L14:
        if (!((ItemKomenHp)Hal3KomentarPull.access$1(Hal3KomentarPull.this).get(i)).getMy_like_kom().toString().equals("1")) goto _L11; else goto _L10
_L10:
...
_L15:
        if (((ItemKomenHp)Hal3KomentarPull.access$1(Hal3KomentarPull.this).get(i)).getUsr_pict_komen().trim().contains(".jpg") || ((ItemKomenHp)Hal3KomentarPull.access$1(Hal3KomentarPull.this).get(i)).getUsr_pict_komen().toString().trim().contains(".png")) goto _L13; else goto _L12
_L12:
...
_L16:
        ...
        try
        {
            ...
            Hal3KomentarPull.access$0(Hal3KomentarPull.this).addView(void1);
...
_L18:
    ...
    protected void onPreExecute()
    {
        ...
        Log.e("KomentarAsycTask", "onPreExecute");
        layout_empty.setVisibility(0);
        Hal3KomentarPull.access$0(Hal3KomentarPull.this).removeAllViewsInLayout();
