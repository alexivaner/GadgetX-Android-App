...
_L1:
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        Log.e("mArrayListDataRep", String.valueOf(Hal3KomentarPull.access$1(Hal3KomentarPull.this).size()));
        if (!jum_komen.equals("-"))
        {
...
_L3:
        ...
        Log.e("mArrayListDataAfterRep", String.valueOf(Hal3KomentarPull.access$1(Hal3KomentarPull.this).size()));
_L12:
        txtbtnheader.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            {
                this$1 = Hal3KomentarPull.KomentarReplyAsycTask.this;
                super();
            }
        });
...
_L15:
    ...
    protected void onPreExecute()
    {
        ...
        Log.e("mArrayListDataBefore", String.valueOf(Hal3KomentarPull.access$1(Hal3KomentarPull.this).size()));
        Hal3KomentarPull.access$1(Hal3KomentarPull.this).clear();
