...
_L1:
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        Log.e("mArrayListDataOld", String.valueOf(TwitterInPonsel.access$0(TwitterInPonsel.this).size()));
        if (!strKonekStat.equals("-"))
        {
            ...
            {
                this$1 = TwitterInPonsel.KomentarOldAsycTask.this;
                super();
            }
                    });
                    txtbtnfooter.setOnClickListener(new android.view.View.OnClickListener() {
                        ...
                        public void onClick(View view)
                        {
                            try
                            {
                                ...
                                if (android.os.Build.VERSION.SDK_INT >= 11)
                                {
                                    (new TwitterInPonsel.KomentarOldAsycTask()).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
                                    return;
                                }
                            }
                            // Misplaced declaration of an exception variable
                            ...
                            (new TwitterInPonsel.KomentarOldAsycTask()).execute(new String[0]);
                            return;
                        }
            ...
            
            {
                ...
                TwitterInPonsel.access$1(TwitterInPonsel.this).addView(void1, TwitterInPonsel.access$1(TwitterInPonsel.this).getChildCount());
    ...
    protected void onPreExecute()
    {
        ...
        Log.e("mArrayListDataOld", String.valueOf(TwitterInPonsel.access$0(TwitterInPonsel.this).size()));
        TwitterInPonsel.access$0(TwitterInPonsel.this).clear();
        Log.e("mArrayListDataOld", String.valueOf(TwitterInPonsel.access$0(TwitterInPonsel.this).size()));
    }
