    ...
    implements android.view.Listener
{
    ...
    public void onClick(final View dialog)
    {
        ...
        {
            dialog = new android.app.Builder(wrapper);
            dialog.setTitle("Perhatian");
            dialog.setMessage("Untuk memberi komentar anda harus login terlebih dahulu");
            dialog.setPositiveButton("Login", new android.content.DialogInterface.OnClickListener() {
            ...
            dialog.setNeutralButton("Register", new android.content.DialogInterface.OnClickListener() {
            ...
            dialog.setNegativeButton("Tutup", new android.content.DialogInterface.OnClickListener() {
