        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(final View items)
        {
            if (userFunction.isUserLoggedIn(getActivity()))
            {
                ...
                builder.setSingleChoiceItems(items, -1, new Hal2Spek._cls23._cls1());
                builder.show();
                return;
            } else
            {
                ...
                items.setPositiveButton("Login", new Hal2Spek._cls23._cls2());
                items.setNeutralButton("Register", new Hal2Spek._cls23._cls3());
                items.setNegativeButton("Tutup", new Hal2Spek._cls23._cls4());
                items.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/details/Hal2Spek$23$1

/* anonymous class */
        class Hal2Spek._cls23._cls1
