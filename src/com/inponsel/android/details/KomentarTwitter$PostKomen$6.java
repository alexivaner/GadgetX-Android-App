...
class val.user_photo
    implements android.view.ter.PostKomen._cls6
{
    ...
    public void onClick(View view)
    {
        ...
        {
            view = new android.app.tter.access._cls2(cess._mth2(this._cls1.this).wrapperLight);
            view.ge("Untuk memberi penilaian harus login terlebih dahulu.");
