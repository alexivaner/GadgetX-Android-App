...
public class TwitterListInPonsel extends SherlockFragmentActivity
    implements Observer
{
        ...
        protected void onPostExecute(Void void1)
        {
            ...
            
            {
                ...
                super();
                    ...
                    try
                    {
                        Picasso.with(TwitterListInPonsel.this).load(((ItemTwitter)mArrayListData.get(i)).getAvatar().toString().trim()).into(img_kom_picture, new Callback() {
            ...
            
            {
                ...
                super();
                    ...
                    } else
                    {
                        try
                        {
                            Picasso.with(TwitterListInPonsel.this).load(((ItemTwitter)mArrayListData.get(i)).getMedia_url().toString().trim()).into(imageMedia, new Callback() {
...
_L2:
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        listtwitter = extras.getString("list");
        int i;
        int j;
        try
        {
        ...
        if (listtwitter.equals("media"))
        {
            getSupportActionBar().setTitle(Html.fromHtml((new StringBuilder("<font color='#FFFFFF'>")).append(URLDecoder.decode("Twitter Media")).append("</font>").toString()));
        } else
        {
            getSupportActionBar().setTitle(Html.fromHtml((new StringBuilder("<font color='#FFFFFF'>")).append(URLDecoder.decode("Twitter Akun Resmi")).append("</font>").toString()));
        }
        ...
        try
        {
            urlKomen = (new StringBuilder(String.valueOf(Util.BASE_PATH2))).append("vendor_twitter_list").append(Utility.BASE_FORMAT).append("?slug=").append(listtwitter).append("&screen_name=").append(twitter).append("&lmt=").append(limit).append("&t=").append(t).append("&idusr=").append(user_id).toString();
