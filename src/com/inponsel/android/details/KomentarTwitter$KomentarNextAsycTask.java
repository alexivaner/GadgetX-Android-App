...
_L1:
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        i = 0;
_L3:
        if (i < KomentarTwitter.access$0(KomentarTwitter.this).size()) goto _L2; else goto _L1
_L1:
        txtbtnheader.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            {
                this$1 = KomentarTwitter.KomentarNextAsycTask.this;
                super();
            }
        });
        txtbtnfooter.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                try
                {
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= 11)
                    {
                        (new KomentarTwitter.KomentarNextAsycTask()).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
                        return;
                    }
                }
                // Misplaced declaration of an exception variable
                ...
                (new KomentarTwitter.KomentarNextAsycTask()).execute(new String[0]);
                return;
            }
...
_L2:
        ...
        KomentarTwitter.access$3(KomentarTwitter.this, (LinearLayout)void1.findViewById(0x7f0b0766));
        ...
        if (i == 0)
        {
            KomentarTwitter.access$4(KomentarTwitter.this).setVisibility(0);
            KomentarTwitter.access$4(KomentarTwitter.this).setBackgroundColor(0xffff0000);
        } else
        {
            KomentarTwitter.access$4(KomentarTwitter.this).setVisibility(8);
        }
    ...
    protected void onPreExecute()
    {
        ...
        Log.e("mArrayListDataNext", String.valueOf(KomentarTwitter.access$0(KomentarTwitter.this).size()));
