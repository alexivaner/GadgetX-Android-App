    ...
    implements android.content.nAdapter._cls2._cls2
{
    ...
    // Unreferenced inner class com/inponsel/android/details/PilihPonselBanding$ListPencarianAdapter$2

/* anonymous class */
    class PilihPonselBanding.ListPencarianAdapter._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new PilihPonselBanding.ListPencarianAdapter._cls2._cls1());
                view.setNeutralButton("Register", new PilihPonselBanding.ListPencarianAdapter._cls2._cls2());
                view.setNegativeButton("Login", new PilihPonselBanding.ListPencarianAdapter._cls2._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/details/PilihPonselBanding$ListPencarianAdapter$2$1

/* anonymous class */
        class PilihPonselBanding.ListPencarianAdapter._cls2._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final PilihPonselBanding.ListPencarianAdapter._cls2 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = PilihPonselBanding.ListPencarianAdapter._cls2.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/details/PilihPonselBanding$ListPencarianAdapter$2$3

/* anonymous class */
        class PilihPonselBanding.ListPencarianAdapter._cls2._cls3
            implements android.content.DialogInterface.OnClickListener
        {
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface = new Intent(PilihPonselBanding.ListPencarianAdapter.access$0(this$1), com/inponsel/android/v2/LoginActivity);
