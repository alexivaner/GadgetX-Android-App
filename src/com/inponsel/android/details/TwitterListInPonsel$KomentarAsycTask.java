    ...
    protected void onPostExecute(Void void1)
    {
        if (!strKonekStat.equals("-"))
        {
                    ...
                    txtbtnheader.setOnClickListener(new android.view.View.OnClickListener() {
                        ...
                        public void onClick(View view)
                        {
                            try
                            {
                                ...
                                {
                                    (new TwitterListInPonsel.KomentarNextAsycTask(this$0)).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
                                    return;
                                }
                            }
                            ...
                            (new TwitterListInPonsel.KomentarNextAsycTask(this$0)).execute(new String[0]);
                            return;
                        }

            
            {
                this$1 = TwitterListInPonsel.KomentarAsycTask.this;
                super();
            }
                    });
            ...
            
            {
                ...
                TwitterListInPonsel.access$1(TwitterListInPonsel.this).addView(void1);
