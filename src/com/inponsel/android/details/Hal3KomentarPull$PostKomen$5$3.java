    ...
    implements android.content.
{
    ...
    // Unreferenced inner class com/inponsel/android/details/Hal3KomentarPull$PostKomen$5

/* anonymous class */
    class Hal3KomentarPull.PostKomen._cls5
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                Hal3KomentarPull.PostKomen.access$2(Hal3KomentarPull.PostKomen.this).statuslike = "0";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new Hal3KomentarPull.PostKomen._cls5._cls1());
                view.setNeutralButton("Register", new Hal3KomentarPull.PostKomen._cls5._cls2());
                view.setNegativeButton("Login", new Hal3KomentarPull.PostKomen._cls5._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/details/Hal3KomentarPull$PostKomen$5$1

/* anonymous class */
        class Hal3KomentarPull.PostKomen._cls5._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final Hal3KomentarPull.PostKomen._cls5 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = Hal3KomentarPull.PostKomen._cls5.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/details/Hal3KomentarPull$PostKomen$5$2

/* anonymous class */
        class Hal3KomentarPull.PostKomen._cls5._cls2
            implements android.content.DialogInterface.OnClickListener
        {
