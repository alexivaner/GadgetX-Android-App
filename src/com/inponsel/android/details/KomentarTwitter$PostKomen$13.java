...
class this._cls1
    implements android.view.er.PostKomen._cls13
{
    ...
    public void onClick(View view)
    {
        ...
        {
            (new it>(ess._mth2(this._cls1.this))).cuteOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Void[0]);
            return;
        } else
        {
            (new it>(ess._mth2(this._cls1.this))).cute(new Void[0]);
            return;
        }
    }
