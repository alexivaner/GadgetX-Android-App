    ...
    implements android.content.ClickListener
{
    ...
    final ilaiTask.execute this$1;

    public void onClick(DialogInterface dialoginterface, int i)
    {
        if (android.os.INT >= 11)
        {
            (new ilaiTask(_fld0)).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Void[0]);
            return;
        }
        if (android.os.INT >= 11)
        {
        ...
        {
            (new ilaiTask(_fld0)).execute(new Void[0]);
            return;
        }
    }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/inponsel/android/details/Hal1Ikhtisar$19$4

/* anonymous class */
        class Hal1Ikhtisar._cls19._cls4
            implements android.content.DialogInterface.OnClickListener
        {
