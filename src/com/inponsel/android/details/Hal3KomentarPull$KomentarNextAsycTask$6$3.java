    ...
    implements android.content.AsycTask._cls6._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/details/Hal3KomentarPull$KomentarNextAsycTask$6

/* anonymous class */
    class Hal3KomentarPull.KomentarNextAsycTask._cls6
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                view = new Intent(Hal3KomentarPull.KomentarNextAsycTask.access$2(Hal3KomentarPull.KomentarNextAsycTask.this).getActivity(), com/inponsel/android/v2/ReplyFormActivity);
                ...
                view.putExtra("nmlengkap", Hal3KomentarPull.KomentarNextAsycTask.access$2(Hal3KomentarPull.KomentarNextAsycTask.this).namalengkap);
                view.putExtra("userpict", usr_pict_komen);
                view.putExtra("codename", codename);
                view.putExtra("top_id", Hal3KomentarPull.KomentarNextAsycTask.access$2(Hal3KomentarPull.KomentarNextAsycTask.this).top_id);
                Hal3KomentarPull.KomentarNextAsycTask.access$2(Hal3KomentarPull.KomentarNextAsycTask.this).startActivityForResult(view, Hal3KomentarPull.access$3());
                return;
            } else
            {
                ...
                view.setPositiveButton("Tutup", new Hal3KomentarPull.KomentarNextAsycTask._cls6._cls1());
                view.setNeutralButton("Register", new Hal3KomentarPull.KomentarNextAsycTask._cls6._cls2());
                view.setNegativeButton("Login", new Hal3KomentarPull.KomentarNextAsycTask._cls6._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/details/Hal3KomentarPull$KomentarNextAsycTask$6$1

/* anonymous class */
        class Hal3KomentarPull.KomentarNextAsycTask._cls6._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final Hal3KomentarPull.KomentarNextAsycTask._cls6 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = Hal3KomentarPull.KomentarNextAsycTask._cls6.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/details/Hal3KomentarPull$KomentarNextAsycTask$6$2

/* anonymous class */
        class Hal3KomentarPull.KomentarNextAsycTask._cls6._cls2
            implements android.content.DialogInterface.OnClickListener
        {
