        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            if (userFunction.isUserLoggedIn(getActivity()))
            {
                ...
                builder.setSingleChoiceItems(view, -1, view. new Hal2Spek._cls25._cls1());
                builder.show();
                return;
            } else
            {
                ...
                view.setPositiveButton("Login", new Hal2Spek._cls25._cls2());
                view.setNeutralButton("Register", new Hal2Spek._cls25._cls3());
                view.setNegativeButton("Tutup", new Hal2Spek._cls25._cls4());
                view.show();
                return;
            }
        }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/inponsel/android/details/Hal2Spek$25$4

/* anonymous class */
        class Hal2Spek._cls25._cls4
            implements android.content.DialogInterface.OnClickListener
        {
