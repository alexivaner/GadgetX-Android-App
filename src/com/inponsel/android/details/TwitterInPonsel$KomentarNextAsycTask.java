    ...
    protected void onPostExecute(Void void1)
    {
        ...
        if (!strKonekStat.equals("-"))
        {
                    ...
                    txtbtnheader.setOnClickListener(new android.view.View.OnClickListener() {
                        ...
                        public void onClick(View view)
                        {
                            try
                            {
                                ...
                                {
                                    (new TwitterInPonsel.KomentarNextAsycTask()).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
                                    return;
                                }
                            }
                            ...
                            (new TwitterInPonsel.KomentarNextAsycTask()).execute(new String[0]);
                            return;
                        }

            
            {
                this$1 = TwitterInPonsel.KomentarNextAsycTask.this;
                super();
            }
                    });
            ...
            
            {
                ...
                TwitterInPonsel.access$1(TwitterInPonsel.this).addView(void1, 0);
