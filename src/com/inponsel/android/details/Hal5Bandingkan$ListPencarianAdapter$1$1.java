...
class this._cls2
    implements android.content.nAdapter._cls1._cls1
{
    ...
    // Unreferenced inner class com/inponsel/android/details/Hal5Bandingkan$ListPencarianAdapter$1

/* anonymous class */
    class Hal5Bandingkan.ListPencarianAdapter._cls1
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            if (userFunctions.isUserLoggedIn(Hal5Bandingkan.ListPencarianAdapter.access$0(Hal5Bandingkan.ListPencarianAdapter.this)))
            {
                ...
                ponselBaseApp.getObserver().setId_hp(Hal5Bandingkan.ListPencarianAdapter.access$1(Hal5Bandingkan.ListPencarianAdapter.this).indexhp);
                try
                {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new Hal5Bandingkan.ListPencarianAdapter._cls1._cls1());
                view.setNeutralButton("Register", new Hal5Bandingkan.ListPencarianAdapter._cls1._cls2());
                view.setNegativeButton("Login", new Hal5Bandingkan.ListPencarianAdapter._cls1._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/details/Hal5Bandingkan$ListPencarianAdapter$1$2

/* anonymous class */
        class Hal5Bandingkan.ListPencarianAdapter._cls1._cls2
            implements android.content.DialogInterface.OnClickListener
        {

            final Hal5Bandingkan.ListPencarianAdapter._cls1 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                ...
                Hal5Bandingkan.ListPencarianAdapter.access$0(this$1).startActivity(dialoginterface);
                    ...
                    {
                        this$2 = Hal5Bandingkan.ListPencarianAdapter._cls1.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/details/Hal5Bandingkan$ListPencarianAdapter$1$3

/* anonymous class */
        class Hal5Bandingkan.ListPencarianAdapter._cls1._cls3
            implements android.content.DialogInterface.OnClickListener
        {
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface = new Intent(Hal5Bandingkan.ListPencarianAdapter.access$0(this$1), com/inponsel/android/v2/LoginActivity);
