        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(final View items)
        {
            if (userFunction.isUserLoggedIn(getActivity()))
            {
                ...
                builder.setSingleChoiceItems(items, -1, new Hal1Ikhtisar._cls14._cls1());
                builder.show();
                return;
            } else
            {
                ...
                items.setPositiveButton("Login", new Hal1Ikhtisar._cls14._cls2());
                items.setNeutralButton("Register", new Hal1Ikhtisar._cls14._cls3());
                items.setNegativeButton("Tutup", new Hal1Ikhtisar._cls14._cls4());
                items.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/details/Hal1Ikhtisar$14$1

/* anonymous class */
        class Hal1Ikhtisar._cls14._cls1
