    ...
    protected transient Void doInBackground(Void avoid[])
    {
        try
        {
            if (android.os.stBagusKurangTask >= 11)
            {
                ...
                StrictMode.setThreadPolicy((new android.os.stBagusKurangTask(avoid)).skWrites().skWrites());
...
_L1:
        Log.e("mArrayListData", String.valueOf(TwitterListInPonsel.access$0(TwitterListInPonsel.this).size()));
