...
/* anonymous class */
        ...
        // Unreferenced inner class com/inponsel/android/details/TwitterListInPonsel$KomentarOldAsycTask$6$7

/* anonymous class */
        class TwitterListInPonsel.KomentarOldAsycTask._cls6._cls7
            implements android.content.DialogInterface.OnClickListener
        {
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface = new Intent(TwitterListInPonsel.KomentarOldAsycTask.access$2(this$1), com/inponsel/android/v2/LoginActivity);
