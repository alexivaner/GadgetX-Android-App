...
class this._cls2
    implements android.content.AsycTask._cls2._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/details/Hal3KomentarPull$KomentarReplyAsycTask$2

/* anonymous class */
    class Hal3KomentarPull.KomentarReplyAsycTask._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                Hal3KomentarPull.KomentarReplyAsycTask.access$2(Hal3KomentarPull.KomentarReplyAsycTask.this).statuslike = "1";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new Hal3KomentarPull.KomentarReplyAsycTask._cls2._cls1());
                view.setNeutralButton("Register", new Hal3KomentarPull.KomentarReplyAsycTask._cls2._cls2());
                view.setNegativeButton("Login", new Hal3KomentarPull.KomentarReplyAsycTask._cls2._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/details/Hal3KomentarPull$KomentarReplyAsycTask$2$1

/* anonymous class */
        class Hal3KomentarPull.KomentarReplyAsycTask._cls2._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final Hal3KomentarPull.KomentarReplyAsycTask._cls2 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = Hal3KomentarPull.KomentarReplyAsycTask._cls2.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/details/Hal3KomentarPull$KomentarReplyAsycTask$2$2

/* anonymous class */
        class Hal3KomentarPull.KomentarReplyAsycTask._cls2._cls2
            implements android.content.DialogInterface.OnClickListener
        {
