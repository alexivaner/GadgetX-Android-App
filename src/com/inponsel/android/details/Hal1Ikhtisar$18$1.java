        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            if (userFunction.isUserLoggedIn(getActivity()))
            {
                ...
                builder.setSingleChoiceItems(view, -1, view. new Hal1Ikhtisar._cls18._cls1());
                builder.show();
                return;
            } else
            {
                ...
                view.setPositiveButton("Login", new Hal1Ikhtisar._cls18._cls2());
                view.setNeutralButton("Register", new Hal1Ikhtisar._cls18._cls3());
                view.setNegativeButton("Tutup", new Hal1Ikhtisar._cls18._cls4());
                view.show();
                return;
            }
        }
...
/* anonymous class */
        ...
        // Unreferenced inner class com/inponsel/android/details/Hal1Ikhtisar$18$3

/* anonymous class */
        class Hal1Ikhtisar._cls18._cls3
            implements android.content.DialogInterface.OnClickListener
        {
