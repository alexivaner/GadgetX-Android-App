...
class this._cls2
    implements android.content.aAdapter._cls1._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/details/RivalTerdekatActivity$ListTurunHargaAdapter$1

/* anonymous class */
    class RivalTerdekatActivity.ListTurunHargaAdapter._cls1
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new RivalTerdekatActivity.ListTurunHargaAdapter._cls1._cls1());
                view.setNeutralButton("Register", new RivalTerdekatActivity.ListTurunHargaAdapter._cls1._cls2());
                view.setNegativeButton("Login", new RivalTerdekatActivity.ListTurunHargaAdapter._cls1._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/details/RivalTerdekatActivity$ListTurunHargaAdapter$1$1

/* anonymous class */
        class RivalTerdekatActivity.ListTurunHargaAdapter._cls1._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final RivalTerdekatActivity.ListTurunHargaAdapter._cls1 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = RivalTerdekatActivity.ListTurunHargaAdapter._cls1.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/details/RivalTerdekatActivity$ListTurunHargaAdapter$1$2

/* anonymous class */
        class RivalTerdekatActivity.ListTurunHargaAdapter._cls1._cls2
            implements android.content.DialogInterface.OnClickListener
        {
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface = new Intent(RivalTerdekatActivity.ListTurunHargaAdapter.access$0(this$1), com/inponsel/android/v2/RegisterActivity);
