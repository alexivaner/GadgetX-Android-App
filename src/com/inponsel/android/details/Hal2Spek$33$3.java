    ...
    implements android.view.stener
{
    ...
    {
        if (android.os.SDK_INT >= 11)
        {
            (new omen(_fld0)).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Void[0]);
        } else
        {
            (new omen(_fld0)).execute(new Void[0]);
        }
        val$dialog.dismiss();
    }
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(final View dialog)
        {
            if (userFunction.isUserLoggedIn(getActivity()))
            {
                ...
                btnSubmit.setOnClickListener(dialog. new Hal2Spek._cls33._cls3());
                dialog.show();
                return;
            } else
            {
...
/* anonymous class */
        ...
        // Unreferenced inner class com/inponsel/android/details/Hal2Spek$33$6

/* anonymous class */
        class Hal2Spek._cls33._cls6
            implements android.content.DialogInterface.OnClickListener
        {
