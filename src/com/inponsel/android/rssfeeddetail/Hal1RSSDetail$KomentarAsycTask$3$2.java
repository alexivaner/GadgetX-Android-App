...
class this._cls2
    implements android.content.mentarAsycTask._cls3._cls2
{
    ...
    // Unreferenced inner class com/inponsel/android/rssfeeddetail/Hal1RSSDetail$KomentarAsycTask$3

/* anonymous class */
    class Hal1RSSDetail.KomentarAsycTask._cls3
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                Hal1RSSDetail.KomentarAsycTask.access$2(Hal1RSSDetail.KomentarAsycTask.this).statuslike = "1";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new Hal1RSSDetail.KomentarAsycTask._cls3._cls1());
                view.setNeutralButton("Register", new Hal1RSSDetail.KomentarAsycTask._cls3._cls2());
                view.setNegativeButton("Login", new Hal1RSSDetail.KomentarAsycTask._cls3._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/rssfeeddetail/Hal1RSSDetail$KomentarAsycTask$3$1

/* anonymous class */
        class Hal1RSSDetail.KomentarAsycTask._cls3._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final Hal1RSSDetail.KomentarAsycTask._cls3 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = Hal1RSSDetail.KomentarAsycTask._cls3.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/rssfeeddetail/Hal1RSSDetail$KomentarAsycTask$3$3

/* anonymous class */
        class Hal1RSSDetail.KomentarAsycTask._cls3._cls3
            implements android.content.DialogInterface.OnClickListener
        {
