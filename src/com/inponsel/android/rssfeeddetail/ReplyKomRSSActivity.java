...
public class ReplyKomRSSActivity extends SherlockFragmentActivity
    implements Observer
{
    private static class EmoticonAdapter extends BaseAdapter
    {
        ...
        public int getCount()
        {
            return ReplyKomRSSActivity.emotname.length;
        }
        ...
        public View getView(int j, View view, ViewGroup viewgroup)
        {
            ...
            ((ViewHolder) (viewgroup)).mTextView.setText(ReplyKomRSSActivity.emotname[j]);
            return view;
        }
...
_L8:
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        try
        {
            ...
            bundle.setScreenName((new StringBuilder("Tanggapan Komentar Berita ")).append(rss_title).toString());
        ...
        id_rss_to = extras.getString("id_rss");
        ...
        listEmot.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
            ...
            {
                edt_pop_komen.setImageInsertGrid(ReplyKomRSSActivity.emotname[l]);
            }
            ...
            public void onClick(View view)
            {
                if (photo_upload == null)
                {
                    if (imgAskHp.getVisibility() == 0)
                    {
                        ...
                        mBuilder = new android.support.v4.app.NotificationCompat.Builder(ReplyKomRSSActivity.this);
        ...
        img_tanggap_picture.setOnLongClickListener(new android.view.View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view)
            {
                ...
                Intent intent = new Intent(ReplyKomRSSActivity.this, com/inponsel/android/v2/ImagePagerActivity);
