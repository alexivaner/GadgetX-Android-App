...
class this._cls2
    implements android.content.tarOldAsycTask._cls3._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/rssfeeddetail/Hal2RSSKomen$KomentarOldAsycTask$3

/* anonymous class */
    class Hal2RSSKomen.KomentarOldAsycTask._cls3
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                Hal2RSSKomen.KomentarOldAsycTask.access$2(Hal2RSSKomen.KomentarOldAsycTask.this).statuslike = "1";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new Hal2RSSKomen.KomentarOldAsycTask._cls3._cls1());
                view.setNeutralButton("Register", new Hal2RSSKomen.KomentarOldAsycTask._cls3._cls2());
                view.setNegativeButton("Login", new Hal2RSSKomen.KomentarOldAsycTask._cls3._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/rssfeeddetail/Hal2RSSKomen$KomentarOldAsycTask$3$1

/* anonymous class */
        class Hal2RSSKomen.KomentarOldAsycTask._cls3._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final Hal2RSSKomen.KomentarOldAsycTask._cls3 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = Hal2RSSKomen.KomentarOldAsycTask._cls3.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/rssfeeddetail/Hal2RSSKomen$KomentarOldAsycTask$3$2

/* anonymous class */
        class Hal2RSSKomen.KomentarOldAsycTask._cls3._cls2
            implements android.content.DialogInterface.OnClickListener
        {
