...
public class Hal2RSSKomen extends SherlockFragment
    implements Observer
{
            ...
            list_lay_rep.setOnClickListener(s1. new android.view.View.OnClickListener() {
                ...
                public void onClick(View view)
                {
                    if (userFunctions.isUserLoggedIn(getActivity()))
                    {
                        ...
                        startActivityForResult(view, Hal2RSSKomen.POST_STAT);
                        return;
                    } else
                    {
...
_L1:
            ...
            obj.countKomOld = ((Hal2RSSKomen) (obj)).countKomOld + 1;
            obj = as.getJSONObject(i);
            mArrayListData.add(mArrayListData.size(), new ItemRSSKomen(((JSONObject) (obj)).getString("id_komrss"), ((JSONObject) (obj)).getString("id_rss"), ((JSONObject) (obj)).getString("id_user"), ((JSONObject) (obj)).getString("id_user_to"), ((JSONObject) (obj)).getString("komen_rss"), ((JSONObject) (obj)).getString("tanggal_kom"), ((JSONObject) (obj)).getString("user_photo"), ((JSONObject) (obj)).getString("user_name"), ((JSONObject) (obj)).getString("tanggal_to"), ((JSONObject) (obj)).getString("total_like"), ((JSONObject) (obj)).getString("total_dislike"), ((JSONObject) (obj)).getString("my_like_kom"), ((JSONObject) (obj)).getString("user_name_to"), ((JSONObject) (obj)).getString("komen_to"), ((JSONObject) (obj)).getString("img_kom"), ((JSONObject) (obj)).getString("img_kom_rep")));
            i++;
              goto _L1
            as;
            as.printStackTrace();
...
_L1:
            ...
            obj.countKomOld = ((Hal2RSSKomen) (obj)).countKomOld + 1;
            obj = as.getJSONObject(i);
            mArrayListData.add(0, new ItemRSSKomen(((JSONObject) (obj)).getString("id_komrss"), ((JSONObject) (obj)).getString("id_rss"), ((JSONObject) (obj)).getString("id_user"), ((JSONObject) (obj)).getString("id_user_to"), ((JSONObject) (obj)).getString("komen_rss"), ((JSONObject) (obj)).getString("tanggal_kom"), ((JSONObject) (obj)).getString("user_photo"), ((JSONObject) (obj)).getString("user_name"), ((JSONObject) (obj)).getString("tanggal_to"), ((JSONObject) (obj)).getString("total_like"), ((JSONObject) (obj)).getString("total_dislike"), ((JSONObject) (obj)).getString("my_like_kom"), ((JSONObject) (obj)).getString("user_name_to"), ((JSONObject) (obj)).getString("komen_to"), ((JSONObject) (obj)).getString("img_kom"), ((JSONObject) (obj)).getString("img_kom_rep")));
            i++;
              goto _L1
            as;
            as.printStackTrace();
...
_L7:
            ...
            if (i != 0)
            {
                break MISSING_BLOCK_LABEL_1751;
            }
...
_L2:
            ...
            s = jArray.getJSONObject(i);
            mArrayListData.add(mArrayListData.size(), new ItemRSSKomen(s.getString("id_komrss"), s.getString("id_rss"), s.getString("id_user"), s.getString("id_user_to"), s.getString("komen_rss"), s.getString("tanggal_kom"), s.getString("user_photo"), s.getString("user_name"), s.getString("tanggal_to"), s.getString("total_like"), s.getString("total_dislike"), s.getString("my_like_kom"), s.getString("user_name_to"), s.getString("komen_to"), s.getString("img_kom"), s.getString("img_kom_rep")));
            i++;
...
_L4:
            ...
            } else
            {
                ...
                final String id_rss = ((ItemRSSKomen)mArrayListData.get(i)).getId_rss();
            ...
            
            {
                ...
                txtbtnfooter.setOnClickListener(id_rss. new android.view.View.OnClickListener() {
...
_L3:
    ...
    public void KomentarNextAsycTask()
    {
        if (mLinearListView.getChildCount() == 0)
        {
            try
            {
                urlKomen = (new StringBuilder(String.valueOf(Util.BASE_PATH2))).append("komen_list_rss_rev").append(Utility.BASE_FORMAT).append("?id_rss=").append(id_rss).append("&t=").append(t).append("&id_usr=").append(user_id).append("&sortkom=").append(sortkom).toString();
