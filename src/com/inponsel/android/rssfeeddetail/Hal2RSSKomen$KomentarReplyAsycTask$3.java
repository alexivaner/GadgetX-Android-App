...
class val.user_photo
    implements android.view.mentarReplyAsycTask._cls3
{
    ...
    public void onClick(View view)
    {
        ...
        {
            view = new android.app.ccess._cls5(cess._mth2(this._cls1.this).wrapperLight);
            view.rapperLight("Untuk memberi penilaian harus login terlebih dahulu.");
