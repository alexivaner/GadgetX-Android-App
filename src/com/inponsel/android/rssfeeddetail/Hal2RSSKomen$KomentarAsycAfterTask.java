...
_L3:
        txtbtnheader.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            {
                this$1 = Hal2RSSKomen.KomentarAsycAfterTask.this;
                super();
            }
        });
...
_L4:
        ...
        if (!((ItemRSSKomen)Hal2RSSKomen.access$1(Hal2RSSKomen.this).get(i)).getUser_name_to().toString().trim().equals("-") && !((ItemRSSKomen)Hal2RSSKomen.access$1(Hal2RSSKomen.this).get(i)).getUser_name_to().toString().trim().equals("")) goto _L7; else goto _L6
_L6:
        lay_quote.setVisibility(8);
_L13:
        if (!((ItemRSSKomen)Hal2RSSKomen.access$1(Hal2RSSKomen.this).get(i)).getMy_like_kom().toString().equals("1")) goto _L9; else goto _L8
_L8:
...
_L14:
        if (!((ItemRSSKomen)Hal2RSSKomen.access$1(Hal2RSSKomen.this).get(i)).getUser_photo().trim().contains(".jpg") && !((ItemRSSKomen)Hal2RSSKomen.access$1(Hal2RSSKomen.this).get(i)).getUser_photo().toString().trim().contains(".png") && !((ItemRSSKomen)Hal2RSSKomen.access$1(Hal2RSSKomen.this).get(i)).getUser_photo().toString().trim().contains(".jpeg")) goto _L11; else goto _L10
_L10:
...
_L2:
    ...
    protected void onPreExecute()
    {
        ...
        Log.e("KomentarAsycTask", "onPreExecute");
        layout_empty.setVisibility(0);
        Hal2RSSKomen.access$0(Hal2RSSKomen.this).removeAllViewsInLayout();
