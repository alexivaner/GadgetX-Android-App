...
class val.user_photo
    implements android.view.il.KomentarAsycTask._cls5
{
    ...
    public void onClick(View view)
    {
        if (cess._mth2(this._cls1.this).userFunctions.isUserLoggedIn(cess._mth2(this._cls1.this).getActivity()))
        {
            ...
            cess._mth2(this._cls1.this).startActivityForResult(view, Hal1RSSDetail.access$9());
            return;
        } else
        {
            view = new android.app.ail.access._cls9(cess._mth2(this._cls1.this).wrapperLight);
