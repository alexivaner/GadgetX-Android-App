...
class this._cls2
    implements android.content.rAsycAfterTask._cls5._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/rssfeeddetail/Hal2RSSKomen$KomentarAsycAfterTask$5

/* anonymous class */
    class Hal2RSSKomen.KomentarAsycAfterTask._cls5
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new Hal2RSSKomen.KomentarAsycAfterTask._cls5._cls1());
                view.setNeutralButton("Register", new Hal2RSSKomen.KomentarAsycAfterTask._cls5._cls2());
                view.setNegativeButton("Login", new Hal2RSSKomen.KomentarAsycAfterTask._cls5._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/rssfeeddetail/Hal2RSSKomen$KomentarAsycAfterTask$5$1

/* anonymous class */
        class Hal2RSSKomen.KomentarAsycAfterTask._cls5._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final Hal2RSSKomen.KomentarAsycAfterTask._cls5 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = Hal2RSSKomen.KomentarAsycAfterTask._cls5.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/rssfeeddetail/Hal2RSSKomen$KomentarAsycAfterTask$5$2

/* anonymous class */
        class Hal2RSSKomen.KomentarAsycAfterTask._cls5._cls2
            implements android.content.DialogInterface.OnClickListener
        {
