...
/* anonymous class */
    ...
    // Unreferenced inner class com/inponsel/android/rssfeeddetail/Hal2RSSKomen$9$1

/* anonymous class */
    class Hal2RSSKomen._cls9._cls1
        implements Callback
    {

        final Hal2RSSKomen._cls9 this$1;
        private final ImageView val$imgKomentar;
        private final String val$img_media;
        private final RelativeLayout val$ll_img_komen;
        private final ProgressBar val$progressbar_imgkomen;
        ...
        public void onSuccess()
        {
            ...
            imgKomentar.setOnClickListener(img_media. new Hal2RSSKomen._cls9._cls1._cls1());
        }
