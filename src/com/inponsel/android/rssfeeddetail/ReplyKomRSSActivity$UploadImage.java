...
private class <init> extends AsyncTask
{
    ...
    private String uploadFile()
    {
        ...
        try
        {
            AndroidMultiPartEntity androidmultipartentity = new AndroidMultiPartEntity(new com.inponsel.android.utils.AndroidMultiPartEntity.ProgressListener() {
                ...
                final ReplyKomRSSActivity.UploadImage this$1;
            ...
            {
                this$1 = ReplyKomRSSActivity.UploadImage.this;
                super();
            }
            });
    ...
    protected void onPostExecute(String s)
    {
        ...
        if (resp.contains(".jpeg") || resp.contains(".jpg"))
        {
            try
            {
                ...
                querypopkomen = (new StringBuilder("rplto=")).append(id_komrss_to).append("&komen=").append(s).append("&id_rss=").append(id_rss_to).append("&top_id=").append(top_id).append("&t=").append(t).append("&id_usr=").append(user_id).append("&img=").append(resp).toString();
            }
            ...
            (new nit>(ReplyKomRSSActivity.this)).ecute(new Void[0]);
            return;
        } else
        {
            notifGagal();
    ...
    protected void onPreExecute()
    {
        ...
        ReplyKomRSSActivity.access$0(ReplyKomRSSActivity.this).ogress(99, 0, false);
        ReplyKomRSSActivity.access$1(ReplyKomRSSActivity.this).notify(notif_id, ReplyKomRSSActivity.access$0(ReplyKomRSSActivity.this).());
    }
    ...
    protected transient void onProgressUpdate(Integer ainteger[])
    {
        ...
        {
            ReplyKomRSSActivity.access$0(ReplyKomRSSActivity.this).ogress(99, 99, false);
            ReplyKomRSSActivity.access$0(ReplyKomRSSActivity.this).ntentTitle("InPonsel").going(true).ntentText((new StringBuilder("Mengirim komentar... - ")).append(String.valueOf(99)).append("%").toString()).allIcon(0x7f0201e4);
        } else
        {
            ReplyKomRSSActivity.access$0(ReplyKomRSSActivity.this).ogress(99, ainteger[0].intValue(), false);
            ReplyKomRSSActivity.access$0(ReplyKomRSSActivity.this).ntentTitle("InPonsel").going(true).ntentText((new StringBuilder("Mengunggah gambar... - ")).append(String.valueOf(ainteger[0])).append("%").toString()).allIcon(0x7f0201e4);
        }
        ReplyKomRSSActivity.access$1(ReplyKomRSSActivity.this).notify(notif_id, ReplyKomRSSActivity.access$0(ReplyKomRSSActivity.this).());
    }
