...
_L1:
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        id_user = ((ItemRSSKomen)Hal2RSSKomen.access$1(Hal2RSSKomen.this).get(i)).getId_user();
        ...
        s = ((ItemRSSKomen)Hal2RSSKomen.access$1(Hal2RSSKomen.this).get(i)).getImg_media();
        s1 = ((ItemRSSKomen)Hal2RSSKomen.access$1(Hal2RSSKomen.this).get(i)).getImg_media_to();
        ...
        if (!((ItemRSSKomen)Hal2RSSKomen.access$1(Hal2RSSKomen.this).get(i)).getUser_name_to().toString().trim().equals("-") && !((ItemRSSKomen)Hal2RSSKomen.access$1(Hal2RSSKomen.this).get(i)).getUser_name_to().toString().trim().equals("")) goto _L2; else goto _L1
_L1:
        lay_quote.setVisibility(8);
_L5:
        if (!((ItemRSSKomen)Hal2RSSKomen.access$1(Hal2RSSKomen.this).get(i)).getMy_like_kom().toString().equals("1")) goto _L4; else goto _L3
_L3:
...
_L7:
        ...
        img_kom_picture.setOnLongClickListener(new android.view.View.OnLongClickListener() {
            ...
            {
                this$1 = Hal2RSSKomen.KomentarOldAsycTask.this;
                user_photo = s;
                super();
            }
        });
