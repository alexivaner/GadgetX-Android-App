    ...
    implements android.content.lickListener
{
    ...
    // Unreferenced inner class com/inponsel/android/rssfeeddetail/Hal1RSSDetail$16

/* anonymous class */
    class Hal1RSSDetail._cls16
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            if (userFunctions.isUserLoggedIn(getActivity()))
            {
                ...
                Hal1RSSDetail.access$16(Hal1RSSDetail.this, title, tag_name, lName, subs_status_push, "general");
                return;
            } else
            {
                view = new android.app.AlertDialog.Builder(getActivity());
                view.setMessage("Untuk menambahkan ke favorit harus login terlebih dahulu.");
                view.setPositiveButton("Tutup", new Hal1RSSDetail._cls16._cls1());
                view.setNeutralButton("Register", new Hal1RSSDetail._cls16._cls2());
                view.setNegativeButton("Login", new Hal1RSSDetail._cls16._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/rssfeeddetail/Hal1RSSDetail$16$2

/* anonymous class */
        class Hal1RSSDetail._cls16._cls2
        ...
        // Unreferenced inner class com/inponsel/android/rssfeeddetail/Hal1RSSDetail$16$3

/* anonymous class */
        class Hal1RSSDetail._cls16._cls3
            implements android.content.DialogInterface.OnClickListener
        {
