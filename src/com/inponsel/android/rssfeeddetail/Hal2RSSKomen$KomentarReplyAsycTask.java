...
_L1:
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        Log.e("mArrayListDataRep", String.valueOf(Hal2RSSKomen.access$1(Hal2RSSKomen.this).size()));
        jum_komen.equals("-");
...
_L3:
        ...
        Log.e("mArrayListDataAfterRep", String.valueOf(Hal2RSSKomen.access$1(Hal2RSSKomen.this).size()));
        Hal2RSSKomen.access$0(Hal2RSSKomen.this).removeViewAt(Hal2RSSKomen.access$0(Hal2RSSKomen.this).getChildCount());
_L13:
        txtbtnheader.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            {
                this$1 = Hal2RSSKomen.KomentarReplyAsycTask.this;
                super();
            }
        });
