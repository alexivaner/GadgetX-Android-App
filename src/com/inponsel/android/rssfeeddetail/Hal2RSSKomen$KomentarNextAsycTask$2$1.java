...
class this._cls2
    implements android.content.arNextAsycTask._cls2._cls1
{
    ...
    // Unreferenced inner class com/inponsel/android/rssfeeddetail/Hal2RSSKomen$KomentarNextAsycTask$2

/* anonymous class */
    class Hal2RSSKomen.KomentarNextAsycTask._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                Hal2RSSKomen.KomentarNextAsycTask.access$2(Hal2RSSKomen.KomentarNextAsycTask.this).statuslike = "0";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new Hal2RSSKomen.KomentarNextAsycTask._cls2._cls1());
                view.setNeutralButton("Register", new Hal2RSSKomen.KomentarNextAsycTask._cls2._cls2());
                view.setNegativeButton("Login", new Hal2RSSKomen.KomentarNextAsycTask._cls2._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/rssfeeddetail/Hal2RSSKomen$KomentarNextAsycTask$2$2

/* anonymous class */
        class Hal2RSSKomen.KomentarNextAsycTask._cls2._cls2
            implements android.content.DialogInterface.OnClickListener
        {

            final Hal2RSSKomen.KomentarNextAsycTask._cls2 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                ...
                Hal2RSSKomen.KomentarNextAsycTask.access$2(this$1).startActivity(dialoginterface);
                    ...
                    {
                        this$2 = Hal2RSSKomen.KomentarNextAsycTask._cls2.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/rssfeeddetail/Hal2RSSKomen$KomentarNextAsycTask$2$3

/* anonymous class */
        class Hal2RSSKomen.KomentarNextAsycTask._cls2._cls3
            implements android.content.DialogInterface.OnClickListener
        {
