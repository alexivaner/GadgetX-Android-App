    ...
    implements android.content.AsycTask._cls4._cls2
{
    ...
    // Unreferenced inner class com/inponsel/android/tlforum/InteraksiForumHP$KomentarAsycTask$4

/* anonymous class */
    class InteraksiForumHP.KomentarAsycTask._cls4
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                InteraksiForumHP.KomentarAsycTask.access$2(InteraksiForumHP.KomentarAsycTask.this).statuslike = "1";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new InteraksiForumHP.KomentarAsycTask._cls4._cls1());
                view.setNeutralButton("Register", new InteraksiForumHP.KomentarAsycTask._cls4._cls2());
                view.setNegativeButton("Login", new InteraksiForumHP.KomentarAsycTask._cls4._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/tlforum/InteraksiForumHP$KomentarAsycTask$4$1

/* anonymous class */
        class InteraksiForumHP.KomentarAsycTask._cls4._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final InteraksiForumHP.KomentarAsycTask._cls4 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = InteraksiForumHP.KomentarAsycTask._cls4.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/tlforum/InteraksiForumHP$KomentarAsycTask$4$3

/* anonymous class */
        class InteraksiForumHP.KomentarAsycTask._cls4._cls3
            implements android.content.DialogInterface.OnClickListener
        {
