...
class val.tl_id
    implements android.view.arOldAsycTask._cls5
{
    ...
    public void onClick(View view)
    {
        ...
        {
            view = new android.app.agusKurangTask.execute(cess._mth2(this._cls1.this));
            view.tarOldAsycTask("Untuk memberi penilaian harus login terlebih dahulu.");
            view.tarOldAsycTask("Tutup", new android.content.DialogInterface.OnClickListener() {
