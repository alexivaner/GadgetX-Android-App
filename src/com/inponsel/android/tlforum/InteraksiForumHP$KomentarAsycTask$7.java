...
class this._cls1
    implements android.view.entarAsycTask._cls7
{
    ...
    public void onClick(View view)
    {
        try
        {
            ...
            cess._mth2(this._cls1.this).urlKomenOld = (new StringBuilder(String.valueOf(Util.BASE_PATH2))).append("timeline_interaksi_hp").append(Utility.BASE_FORMAT).append("?id_hp=").append(cess._mth2(this._cls1.this).id_hp).append("&code=").append(cess._mth2(this._cls1.this).codename).append("&top_id=").append(cess._mth2(this._cls1.this).top_id).append("&t=").append(cess._mth2(this._cls1.this).t).append("&id_usr=").append(cess._mth2(this._cls1.this).user_id).append("&sortkom=").append(cess._mth2(this._cls1.this).sortkom).toString();
            Log.e("urlKomenOld", cess._mth2(this._cls1.this).urlKomenOld);
            if (android.os.rlKomenOld >= 11)
            {
