...
class val.tl_id
    implements android.view.ReplyAsycTask._cls4
{
    ...
    public void onClick(View view)
    {
        ...
        } else
        {
            ...
            view.rReplyAsycTask("Untuk memberi penilaian harus login terlebih dahulu.");
            view.rReplyAsycTask("Tutup", new android.content.DialogInterface.OnClickListener() {
