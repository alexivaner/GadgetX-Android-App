    ...
    implements android.content.AsycTask._cls5._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/tlforum/InteraksiForumHP$KomentarOldAsycTask$5

/* anonymous class */
    class InteraksiForumHP.KomentarOldAsycTask._cls5
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                InteraksiForumHP.KomentarOldAsycTask.access$2(InteraksiForumHP.KomentarOldAsycTask.this).statuslike = "0";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new InteraksiForumHP.KomentarOldAsycTask._cls5._cls1());
                view.setNeutralButton("Register", new InteraksiForumHP.KomentarOldAsycTask._cls5._cls2());
                view.setNegativeButton("Login", new InteraksiForumHP.KomentarOldAsycTask._cls5._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/tlforum/InteraksiForumHP$KomentarOldAsycTask$5$1

/* anonymous class */
        class InteraksiForumHP.KomentarOldAsycTask._cls5._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final InteraksiForumHP.KomentarOldAsycTask._cls5 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = InteraksiForumHP.KomentarOldAsycTask._cls5.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/tlforum/InteraksiForumHP$KomentarOldAsycTask$5$2

/* anonymous class */
        class InteraksiForumHP.KomentarOldAsycTask._cls5._cls2
            implements android.content.DialogInterface.OnClickListener
        {
