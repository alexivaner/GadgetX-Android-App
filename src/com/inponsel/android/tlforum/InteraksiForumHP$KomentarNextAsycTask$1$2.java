...
class this._cls2
    implements android.content.AsycTask._cls1._cls2
{
    ...
    // Unreferenced inner class com/inponsel/android/tlforum/InteraksiForumHP$KomentarNextAsycTask$1

/* anonymous class */
    class InteraksiForumHP.KomentarNextAsycTask._cls1
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                InteraksiForumHP.KomentarNextAsycTask.access$2(InteraksiForumHP.KomentarNextAsycTask.this).statuslike = "1";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new InteraksiForumHP.KomentarNextAsycTask._cls1._cls1());
                view.setNeutralButton("Register", new InteraksiForumHP.KomentarNextAsycTask._cls1._cls2());
                view.setNegativeButton("Login", new InteraksiForumHP.KomentarNextAsycTask._cls1._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/tlforum/InteraksiForumHP$KomentarNextAsycTask$1$1

/* anonymous class */
        class InteraksiForumHP.KomentarNextAsycTask._cls1._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final InteraksiForumHP.KomentarNextAsycTask._cls1 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = InteraksiForumHP.KomentarNextAsycTask._cls1.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/tlforum/InteraksiForumHP$KomentarNextAsycTask$1$3

/* anonymous class */
        class InteraksiForumHP.KomentarNextAsycTask._cls1._cls3
            implements android.content.DialogInterface.OnClickListener
        {
