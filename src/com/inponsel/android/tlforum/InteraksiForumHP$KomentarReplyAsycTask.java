...
_L1:
    ...
    protected void onPostExecute(Void void1)
    {
        ...
        Log.e("mArrayListDataRep", String.valueOf(InteraksiForumHP.access$1(InteraksiForumHP.this).size()));
        jum_komen.equals("-");
        if (strKonekStat.equals("-")) goto _L2; else goto _L1
_L1:
        Log.e("countAllKom", String.valueOf(countAllKom));
        Log.e("mArrayListDataold", String.valueOf(InteraksiForumHP.access$1(InteraksiForumHP.this).size()));
        int i = 0;
_L9:
        if (i < InteraksiForumHP.access$1(InteraksiForumHP.this).size()) goto _L4; else goto _L3
_L3:
        void1 = InteraksiForumHP.this;
        void1.removeNextIndex = ((InteraksiForumHP) (void1)).removeNextIndex + countRemIndex;
        Log.e("mArrayListDataAfterRep", String.valueOf(InteraksiForumHP.access$1(InteraksiForumHP.this).size()));
        InteraksiForumHP.access$0(InteraksiForumHP.this).removeViewAt(InteraksiForumHP.access$0(InteraksiForumHP.this).getChildCount());
_L13:
        txtbtnheader.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            {
                this$1 = InteraksiForumHP.KomentarReplyAsycTask.this;
                super();
            }
        });
...
_L4:
        ...
        void1 = InteraksiForumHP.this;
        void1.countRemIndex = ((InteraksiForumHP) (void1)).countRemIndex + 1;
        ...
        ((ItemInteraksiKomen)InteraksiForumHP.access$1(InteraksiForumHP.this).get(i)).getId_user();
        ...
        if (!((ItemInteraksiKomen)InteraksiForumHP.access$1(InteraksiForumHP.this).get(i)).getUser_name_to().toString().trim().equals("-") && !((ItemInteraksiKomen)InteraksiForumHP.access$1(InteraksiForumHP.this).get(i)).getUser_name_to().toString().trim().equals("")) goto _L6; else goto _L5
_L5:
        lay_quote.setVisibility(8);
_L10:
        if (!((ItemInteraksiKomen)InteraksiForumHP.access$1(InteraksiForumHP.this).get(i)).getMy_like_kom().toString().equals("1")) goto _L8; else goto _L7
_L7:
...
_L2:
    ...
    protected void onPreExecute()
    {
        ...
        Log.e("mArrayListDataNext", String.valueOf(InteraksiForumHP.access$1(InteraksiForumHP.this).size()));
    }
