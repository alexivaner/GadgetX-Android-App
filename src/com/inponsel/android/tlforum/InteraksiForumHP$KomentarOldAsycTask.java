...
_L9:
        ...
        try
        {
            if (i >= InteraksiForumHP.access$1(InteraksiForumHP.this).size())
            {
                void1 = InteraksiForumHP.this;
                void1.removeIndex = ((InteraksiForumHP) (void1)).removeIndex + 3;
                Log.e("removeIndexBef", String.valueOf((new StringBuilder(String.valueOf(removeStartOld))).append(",").append(removeIndex).toString()));
                void1 = InteraksiForumHP.this;
                void1.removeStartOld = ((InteraksiForumHP) (void1)).removeStartOld + 3;
...
_L12:
        ...
        txtKomentar.setMovementMethod(com.inponsel.android.widget.mentMethod.getInstance());
        ...
        txtKomentarQoute.setMovementMethod(com.inponsel.android.widget.mentMethod.getInstance());
        ...
        InteraksiForumHP.access$0(InteraksiForumHP.this).addView(void1, 0);
        img_kom_picture.setOnLongClickListener(new android.view.View.OnLongClickListener() {
            ...
            {
                this$1 = InteraksiForumHP.KomentarOldAsycTask.this;
                user_photo = s;
                super();
            }
        });
