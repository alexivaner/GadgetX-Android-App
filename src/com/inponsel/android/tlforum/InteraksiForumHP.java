...
public class InteraksiForumHP extends SherlockFragmentActivity
    implements Observer
{
            ...
            list_lay_rep.setOnClickListener(s2. new android.view.View.OnClickListener() {
                ...
                public void onClick(View view)
                {
                    if (userFunctions.isUserLoggedIn(_fld0))
                    {
                        ...
                        Log.e("tl_id", tl_id);
                        startActivityForResult(view, InteraksiForumHP.POST_STAT);
                        return;
                    } else
                    {
...
_L1:
    ...
    String nama_asli;
    String namalengkap;
    LinearLayout nativeAdContainerHome1;
    String notif;
    ...
    public void KomentarNextAsycTask()
    {
        if (mLinearListView.getChildCount() == 0)
        {
            try
            {
                urlKomen = (new StringBuilder(String.valueOf(Util.BASE_PATH2))).append("timeline_interaksi_hp").append(Utility.BASE_FORMAT).append("?id_hp=").append(id_hp).append("&code=").append(codename).append("&t=").append(t).append("&id_usr=").append(user_id).append("&sortkom=").append(sortkom).toString();
...
_L2:
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        try
        {
            ...
            bundle.setScreenName((new StringBuilder("Interaksi Forum ")).append(namalengkap).toString());
        ...
        bundle.setText("Interaksi Forum");
        bundle.setEllipsize(android.text.TextUtils.TruncateAt.MARQUEE);
        getSupportActionBar().setTitle(Html.fromHtml((new StringBuilder("<font color='#FFFFFF'>Interaksi Forum ")).append(namalengkap).append("</font>").toString()));
