...
class this._cls2
    implements android.content.fterTask._cls2._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/tlforum/InteraksiForumHP$KomentarAsycAfterTask$2

/* anonymous class */
    class InteraksiForumHP.KomentarAsycAfterTask._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                InteraksiForumHP.KomentarAsycAfterTask.access$2(InteraksiForumHP.KomentarAsycAfterTask.this).statuslike = "1";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new InteraksiForumHP.KomentarAsycAfterTask._cls2._cls1());
                view.setNeutralButton("Register", new InteraksiForumHP.KomentarAsycAfterTask._cls2._cls2());
                view.setNegativeButton("Login", new InteraksiForumHP.KomentarAsycAfterTask._cls2._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/tlforum/InteraksiForumHP$KomentarAsycAfterTask$2$1

/* anonymous class */
        class InteraksiForumHP.KomentarAsycAfterTask._cls2._cls1
        ...
        // Unreferenced inner class com/inponsel/android/tlforum/InteraksiForumHP$KomentarAsycAfterTask$2$2

/* anonymous class */
        class InteraksiForumHP.KomentarAsycAfterTask._cls2._cls2
            implements android.content.DialogInterface.OnClickListener
        {
