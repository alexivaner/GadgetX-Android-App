    ...
    implements android.view.arOldAsycTask._cls6
{
    ...
    public void onClick(View view)
    {
        if (cess._mth2(this._cls1.this).userFunctions.isUserLoggedIn(cess._mth2(this._cls1.this)))
        {
            ...
            cess._mth2(this._cls1.this).startActivityForResult(view, InteraksiForumHP.access$4());
            return;
        } else
        {
            view = new android.app.s._cls4(cess._mth2(this._cls1.this).wrapperLight);
            view.erLight("Untuk membalas komentar harus login terlebih dahulu.");
