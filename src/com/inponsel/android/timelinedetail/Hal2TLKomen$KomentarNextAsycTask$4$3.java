...
class this._cls2
    implements android.content.tarNextAsycTask._cls4._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/timelinedetail/Hal2TLKomen$KomentarNextAsycTask$4

/* anonymous class */
    class Hal2TLKomen.KomentarNextAsycTask._cls4
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new Hal2TLKomen.KomentarNextAsycTask._cls4._cls1());
                view.setNeutralButton("Register", new Hal2TLKomen.KomentarNextAsycTask._cls4._cls2());
                view.setNegativeButton("Login", new Hal2TLKomen.KomentarNextAsycTask._cls4._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/timelinedetail/Hal2TLKomen$KomentarNextAsycTask$4$1

/* anonymous class */
        class Hal2TLKomen.KomentarNextAsycTask._cls4._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final Hal2TLKomen.KomentarNextAsycTask._cls4 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = Hal2TLKomen.KomentarNextAsycTask._cls4.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/timelinedetail/Hal2TLKomen$KomentarNextAsycTask$4$2

/* anonymous class */
        class Hal2TLKomen.KomentarNextAsycTask._cls4._cls2
            implements android.content.DialogInterface.OnClickListener
        {
