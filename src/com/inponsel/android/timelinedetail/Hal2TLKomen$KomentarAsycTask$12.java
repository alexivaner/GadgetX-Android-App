...
class this._cls1
    implements android.view.en.KomentarAsycTask._cls12
{
    ...
    public void onClick(View view)
    {
        try
        {
            ...
            ess._mth2(this._cls1.this).querypopkomen = (new StringBuilder("rplto=0&komen=")).append(view).append("&tl_id=").append(ess._mth2(this._cls1.this).tl_id).append("&top_id=").append(ess._mth2(this._cls1.this).top_id).append("&t=").append(ess._mth2(this._cls1.this).t).append("&id_usr=").append(ess._mth2(this._cls1.this).user_id).toString();
        }
