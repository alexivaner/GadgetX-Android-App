...
class this._cls2
    implements android.content.arReplyAsycTask._cls2._cls1
{
    ...
    // Unreferenced inner class com/inponsel/android/timelinedetail/Hal2TLKomen$KomentarReplyAsycTask$2

/* anonymous class */
    class Hal2TLKomen.KomentarReplyAsycTask._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                Hal2TLKomen.KomentarReplyAsycTask.access$2(Hal2TLKomen.KomentarReplyAsycTask.this).statuslike = "0";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new Hal2TLKomen.KomentarReplyAsycTask._cls2._cls1());
                view.setNeutralButton("Register", new Hal2TLKomen.KomentarReplyAsycTask._cls2._cls2());
                view.setNegativeButton("Login", new Hal2TLKomen.KomentarReplyAsycTask._cls2._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/timelinedetail/Hal2TLKomen$KomentarReplyAsycTask$2$2

/* anonymous class */
        class Hal2TLKomen.KomentarReplyAsycTask._cls2._cls2
            implements android.content.DialogInterface.OnClickListener
        {

            final Hal2TLKomen.KomentarReplyAsycTask._cls2 this$2;

            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface = new Intent(Hal2TLKomen.KomentarReplyAsycTask.access$2(this$1).getActivity(), com/inponsel/android/v2/RegisterActivity);
                Hal2TLKomen.KomentarReplyAsycTask.access$2(this$1).startActivity(dialoginterface);
            }

                    
                    {
                        this$2 = Hal2TLKomen.KomentarReplyAsycTask._cls2.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/timelinedetail/Hal2TLKomen$KomentarReplyAsycTask$2$3

/* anonymous class */
        class Hal2TLKomen.KomentarReplyAsycTask._cls2._cls3
            implements android.content.DialogInterface.OnClickListener
        {
