...
class this._cls2
    implements android.content.arAsycAfterTask._cls4._cls1
{
    ...
    // Unreferenced inner class com/inponsel/android/timelinedetail/Hal2TLKomen$KomentarAsycAfterTask$4

/* anonymous class */
    class Hal2TLKomen.KomentarAsycAfterTask._cls4
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                Hal2TLKomen.KomentarAsycAfterTask.access$2(Hal2TLKomen.KomentarAsycAfterTask.this).statuslike = "0";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new Hal2TLKomen.KomentarAsycAfterTask._cls4._cls1());
                view.setNeutralButton("Register", new Hal2TLKomen.KomentarAsycAfterTask._cls4._cls2());
                view.setNegativeButton("Login", new Hal2TLKomen.KomentarAsycAfterTask._cls4._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/timelinedetail/Hal2TLKomen$KomentarAsycAfterTask$4$2

/* anonymous class */
        class Hal2TLKomen.KomentarAsycAfterTask._cls4._cls2
            implements android.content.DialogInterface.OnClickListener
        {

            final Hal2TLKomen.KomentarAsycAfterTask._cls4 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                ...
                Hal2TLKomen.KomentarAsycAfterTask.access$2(this$1).startActivity(dialoginterface);
                    ...
                    {
                        this$2 = Hal2TLKomen.KomentarAsycAfterTask._cls4.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/timelinedetail/Hal2TLKomen$KomentarAsycAfterTask$4$3

/* anonymous class */
        class Hal2TLKomen.KomentarAsycAfterTask._cls4._cls3
            implements android.content.DialogInterface.OnClickListener
        {
