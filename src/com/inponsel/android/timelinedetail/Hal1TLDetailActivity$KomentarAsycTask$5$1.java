    ...
    implements android.content.omentarAsycTask._cls5._cls1
{
    ...
    // Unreferenced inner class com/inponsel/android/timelinedetail/Hal1TLDetailActivity$KomentarAsycTask$5

/* anonymous class */
    class Hal1TLDetailActivity.KomentarAsycTask._cls5
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new Hal1TLDetailActivity.KomentarAsycTask._cls5._cls1());
                view.setNeutralButton("Register", new Hal1TLDetailActivity.KomentarAsycTask._cls5._cls2());
                view.setNegativeButton("Login", new Hal1TLDetailActivity.KomentarAsycTask._cls5._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/timelinedetail/Hal1TLDetailActivity$KomentarAsycTask$5$2

/* anonymous class */
        class Hal1TLDetailActivity.KomentarAsycTask._cls5._cls2
            implements android.content.DialogInterface.OnClickListener
        {

            final Hal1TLDetailActivity.KomentarAsycTask._cls5 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                ...
                Hal1TLDetailActivity.KomentarAsycTask.access$2(this$1).startActivity(dialoginterface);
                    ...
                    {
                        this$2 = Hal1TLDetailActivity.KomentarAsycTask._cls5.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/timelinedetail/Hal1TLDetailActivity$KomentarAsycTask$5$3

/* anonymous class */
        class Hal1TLDetailActivity.KomentarAsycTask._cls5._cls3
            implements android.content.DialogInterface.OnClickListener
        {
