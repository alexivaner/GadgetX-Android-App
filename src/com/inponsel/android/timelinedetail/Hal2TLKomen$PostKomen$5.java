...
class val.user_photo
    implements android.view.al2TLKomen.PostKomen._cls5
{
    ...
    public void onClick(View view)
    {
        ...
        {
            view = new android.app.t>(cess._mth2(this._cls1.this).wrapperLight);
            view.essage("Untuk membalas komentar harus login terlebih dahulu.");
