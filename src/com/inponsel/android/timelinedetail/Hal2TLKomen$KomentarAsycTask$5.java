...
class val.user_photo
    implements android.view.men.KomentarAsycTask._cls5
{
    ...
    public void onClick(View view)
    {
        ...
        {
            view = new android.app.omen.access._cls5(cess._mth2(this._cls1.this).wrapperLight);
            view.wrapperLight("Untuk membalas komentar harus login terlebih dahulu.");
            view.Button("Tutup", new android.content.DialogInterface.OnClickListener() {
            ...
            view.utton("Register", new android.content.DialogInterface.OnClickListener() {
            ...
            view.Button("Login", new android.content.DialogInterface.OnClickListener() {
