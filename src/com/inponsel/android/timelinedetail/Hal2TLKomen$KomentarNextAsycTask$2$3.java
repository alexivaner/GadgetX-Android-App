...
class this._cls2
    implements android.content.tarNextAsycTask._cls2._cls3
{
    ...
    // Unreferenced inner class com/inponsel/android/timelinedetail/Hal2TLKomen$KomentarNextAsycTask$2

/* anonymous class */
    class Hal2TLKomen.KomentarNextAsycTask._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                Hal2TLKomen.KomentarNextAsycTask.access$2(Hal2TLKomen.KomentarNextAsycTask.this).statuslike = "0";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new Hal2TLKomen.KomentarNextAsycTask._cls2._cls1());
                view.setNeutralButton("Register", new Hal2TLKomen.KomentarNextAsycTask._cls2._cls2());
                view.setNegativeButton("Login", new Hal2TLKomen.KomentarNextAsycTask._cls2._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/timelinedetail/Hal2TLKomen$KomentarNextAsycTask$2$1

/* anonymous class */
        class Hal2TLKomen.KomentarNextAsycTask._cls2._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final Hal2TLKomen.KomentarNextAsycTask._cls2 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = Hal2TLKomen.KomentarNextAsycTask._cls2.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/timelinedetail/Hal2TLKomen$KomentarNextAsycTask$2$2

/* anonymous class */
        class Hal2TLKomen.KomentarNextAsycTask._cls2._cls2
            implements android.content.DialogInterface.OnClickListener
        {
