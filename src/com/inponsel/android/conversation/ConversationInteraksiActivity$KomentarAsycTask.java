...
_L7:
        if (i >= ConversationInteraksiActivity.access$1(ConversationInteraksiActivity.this).size())
        {
            ...
            {
                this$1 = ConversationInteraksiActivity.KomentarAsycTask.this;
                super();
            }
            });
...
_L10:
        ...
        try
        {
            ...
            txtKomentar.setMovementMethod(com.inponsel.android.widget..getInstance());
            ...
            txtKomentarQoute.setMovementMethod(com.inponsel.android.widget..getInstance());
