...
class this._cls2
    implements android.content.entarAsycTask._cls5._cls2
{
    ...
    // Unreferenced inner class com/inponsel/android/conversation/ConversationDetailActivity$KomentarAsycTask$5

/* anonymous class */
    class ConversationDetailActivity.KomentarAsycTask._cls5
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                ConversationDetailActivity.KomentarAsycTask.access$2(ConversationDetailActivity.KomentarAsycTask.this).statuslike = "0";
                ...
                Log.e("querylikeKomen", ConversationDetailActivity.KomentarAsycTask.access$2(ConversationDetailActivity.KomentarAsycTask.this).querylikeKomen);
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new ConversationDetailActivity.KomentarAsycTask._cls5._cls1());
                view.setNeutralButton("Register", new ConversationDetailActivity.KomentarAsycTask._cls5._cls2());
                view.setNegativeButton("Login", new ConversationDetailActivity.KomentarAsycTask._cls5._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/conversation/ConversationDetailActivity$KomentarAsycTask$5$1

/* anonymous class */
        class ConversationDetailActivity.KomentarAsycTask._cls5._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final ConversationDetailActivity.KomentarAsycTask._cls5 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = ConversationDetailActivity.KomentarAsycTask._cls5.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/conversation/ConversationDetailActivity$KomentarAsycTask$5$3

/* anonymous class */
        class ConversationDetailActivity.KomentarAsycTask._cls5._cls3
            implements android.content.DialogInterface.OnClickListener
        {
