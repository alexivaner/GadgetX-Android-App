...
class this._cls2
    implements android.content.entarAsycTask._cls6._cls2
{
    ...
    // Unreferenced inner class com/inponsel/android/conversation/ConversationInteraksiActivity$KomentarAsycTask$6

/* anonymous class */
    class ConversationInteraksiActivity.KomentarAsycTask._cls6
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                ConversationInteraksiActivity.KomentarAsycTask.access$2(ConversationInteraksiActivity.KomentarAsycTask.this).statuslike = "0";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new ConversationInteraksiActivity.KomentarAsycTask._cls6._cls1());
                view.setNeutralButton("Register", new ConversationInteraksiActivity.KomentarAsycTask._cls6._cls2());
                view.setNegativeButton("Login", new ConversationInteraksiActivity.KomentarAsycTask._cls6._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/conversation/ConversationInteraksiActivity$KomentarAsycTask$6$1

/* anonymous class */
        class ConversationInteraksiActivity.KomentarAsycTask._cls6._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final ConversationInteraksiActivity.KomentarAsycTask._cls6 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = ConversationInteraksiActivity.KomentarAsycTask._cls6.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/conversation/ConversationInteraksiActivity$KomentarAsycTask$6$3

/* anonymous class */
        class ConversationInteraksiActivity.KomentarAsycTask._cls6._cls3
            implements android.content.DialogInterface.OnClickListener
        {
