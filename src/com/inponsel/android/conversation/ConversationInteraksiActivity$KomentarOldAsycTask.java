...
_L9:
        flag = ((ItemInteraksiKomen)ConversationInteraksiActivity.access$1(ConversationInteraksiActivity.this).get(i)).getUser_photo().toString().trim().contains(".jpeg");
        if (!flag)
        {
...
_L10:
        Picasso.with(ConversationInteraksiActivity.this).load(((ItemInteraksiKomen)ConversationInteraksiActivity.access$1(ConversationInteraksiActivity.this).get(i)).getUser_photo().toString().trim()).into(img_kom_picture, new Callback() {
            ...
            {
                this$1 = ConversationInteraksiActivity.KomentarOldAsycTask.this;
                super();
            }
        });
_L14:
        ...
        txtKomentar.setMovementMethod(com.inponsel.android.widget.tInstance());
        ...
        txtKomentarQoute.setMovementMethod(com.inponsel.android.widget.tInstance());
        ...
        ConversationInteraksiActivity.access$0(ConversationInteraksiActivity.this).addView(void1, 0);
