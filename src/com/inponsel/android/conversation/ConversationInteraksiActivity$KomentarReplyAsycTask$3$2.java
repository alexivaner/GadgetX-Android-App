...
class this._cls2
    implements android.content.ReplyAsycTask._cls3._cls2
{
    ...
    // Unreferenced inner class com/inponsel/android/conversation/ConversationInteraksiActivity$KomentarReplyAsycTask$3

/* anonymous class */
    class ConversationInteraksiActivity.KomentarReplyAsycTask._cls3
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                ConversationInteraksiActivity.KomentarReplyAsycTask.access$2(ConversationInteraksiActivity.KomentarReplyAsycTask.this).statuslike = "1";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new ConversationInteraksiActivity.KomentarReplyAsycTask._cls3._cls1());
                view.setNeutralButton("Register", new ConversationInteraksiActivity.KomentarReplyAsycTask._cls3._cls2());
                view.setNegativeButton("Login", new ConversationInteraksiActivity.KomentarReplyAsycTask._cls3._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/conversation/ConversationInteraksiActivity$KomentarReplyAsycTask$3$1

/* anonymous class */
        class ConversationInteraksiActivity.KomentarReplyAsycTask._cls3._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final ConversationInteraksiActivity.KomentarReplyAsycTask._cls3 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = ConversationInteraksiActivity.KomentarReplyAsycTask._cls3.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/conversation/ConversationInteraksiActivity$KomentarReplyAsycTask$3$3

/* anonymous class */
        class ConversationInteraksiActivity.KomentarReplyAsycTask._cls3._cls3
            implements android.content.DialogInterface.OnClickListener
        {
