...
class val.user_photo
    implements android.view.y.KomentarAsycTask._cls7
{
    ...
    public void onClick(View view)
    {
        ...
        {
            view = new android.app.ty.access._cls2(cess._mth2(this._cls1.this).wrapperLight);
            view.wrapperLight("Untuk membalas komentar harus login terlebih dahulu.");
            view.wrapperLight("Tutup", new android.content.DialogInterface.OnClickListener() {
            ...
            view._mth7("Register", new android.content.DialogInterface.OnClickListener() {
            ...
            view._mth7("Login", new android.content.DialogInterface.OnClickListener() {
