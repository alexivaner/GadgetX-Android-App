...
class val.like_stat
    implements android.view.versationActivity._cls19
{
    ...
    {
        idkom_pos = val$tl_id;
        view = new Intent(ConversationActivity.this, com/inponsel/android/conversation/ConversationDetailActivity);
