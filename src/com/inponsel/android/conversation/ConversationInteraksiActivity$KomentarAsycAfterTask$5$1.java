...
class this._cls2
    implements android.content.AsycAfterTask._cls5._cls1
{
    ...
    // Unreferenced inner class com/inponsel/android/conversation/ConversationInteraksiActivity$KomentarAsycAfterTask$5

/* anonymous class */
    class ConversationInteraksiActivity.KomentarAsycAfterTask._cls5
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                ConversationInteraksiActivity.KomentarAsycAfterTask.access$2(ConversationInteraksiActivity.KomentarAsycAfterTask.this).statuslike = "0";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new ConversationInteraksiActivity.KomentarAsycAfterTask._cls5._cls1());
                view.setNeutralButton("Register", new ConversationInteraksiActivity.KomentarAsycAfterTask._cls5._cls2());
                view.setNegativeButton("Login", new ConversationInteraksiActivity.KomentarAsycAfterTask._cls5._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/conversation/ConversationInteraksiActivity$KomentarAsycAfterTask$5$2

/* anonymous class */
        class ConversationInteraksiActivity.KomentarAsycAfterTask._cls5._cls2
            implements android.content.DialogInterface.OnClickListener
        {

            final ConversationInteraksiActivity.KomentarAsycAfterTask._cls5 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                ...
                ConversationInteraksiActivity.KomentarAsycAfterTask.access$2(this$1).startActivity(dialoginterface);
                    ...
                    {
                        this$2 = ConversationInteraksiActivity.KomentarAsycAfterTask._cls5.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/conversation/ConversationInteraksiActivity$KomentarAsycAfterTask$5$3

/* anonymous class */
        class ConversationInteraksiActivity.KomentarAsycAfterTask._cls5._cls3
            implements android.content.DialogInterface.OnClickListener
        {
