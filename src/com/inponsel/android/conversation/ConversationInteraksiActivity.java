...
public class ConversationInteraksiActivity extends SherlockFragmentActivity
    implements Observer
{
...
_L7:
            ...
            if (!((ItemInteraksiKomen)mArrayListData.get(i)).getUser_name_to().toString().trim().equals("-") && !((ItemInteraksiKomen)mArrayListData.get(i)).getUser_name_to().toString().trim().equals("")) goto _L2; else goto _L1
_L1:
            lay_quote.setVisibility(8);
_L8:
            if (!((ItemInteraksiKomen)mArrayListData.get(i)).getMy_like_kom().toString().equals("1")) goto _L4; else goto _L3
_L3:
...
_L9:
            if (((ItemInteraksiKomen)mArrayListData.get(i)).getUser_photo().trim().contains(".jpg") || ((ItemInteraksiKomen)mArrayListData.get(i)).getUser_photo().toString().trim().contains(".png")) goto _L6; else goto _L5
_L5:
            boolean flag = ((ItemInteraksiKomen)mArrayListData.get(i)).getUser_photo().toString().trim().contains(".jpeg");
            if (!flag)
            {
                break MISSING_BLOCK_LABEL_1777;
            }
_L6:
            Picasso.with(ConversationInteraksiActivity.this).load(((ItemInteraksiKomen)mArrayListData.get(i)).getUser_photo().toString().trim()).into(img_kom_picture, new Callback() {
                ...
                list_lay_rep.setOnClickListener(s2. new android.view.View.OnClickListener() {
                    ...
                    public void onClick(View view)
                    {
                        if (userFunctions.isUserLoggedIn(_fld0))
                        {
                            ...
                            Log.e("tl_id", tl_id);
                            startActivityForResult(view, ConversationInteraksiActivity.POST_STAT);
                            return;
                        } else
                        {
...
_L7:
            ...
            
            {
                ...
                break MISSING_BLOCK_LABEL_1801;
            }
            final String id_komrss;
            final String tl_id;
            final String tl_judul_art;
...
_L3:
            void1 = ConversationInteraksiActivity.this;
            void1.removeNextIndex = ((ConversationInteraksiActivity) (void1)).removeNextIndex + countRemIndex;
...
_L4:
            ...
            ImageView imageview1;
            void1 = ConversationInteraksiActivity.this;
            void1.countRemIndex = ((ConversationInteraksiActivity) (void1)).countRemIndex + 1;
            void1 = ((LayoutInflater)getSystemService("layout_inflater")).inflate(0x7f0300fa, null);
            txtTitleArtikel = (TextView)void1.findViewById(0x7f0b0764);
            txtUsername = (TextView)void1.findViewById(0x7f0b0419);
            lay_quote = (LinearLayout)void1.findViewById(0x7f0b063a);
...
_L7:
            ...
            list_lay_dislike.setEnabled(true);
_L13:
            if (((ItemInteraksiKomen)mArrayListData.get(i)).getUser_photo().trim().contains(".jpg") || ((ItemInteraksiKomen)mArrayListData.get(i)).getUser_photo().toString().trim().contains(".png")) goto _L10; else goto _L9
_L9:
            boolean flag = ((ItemInteraksiKomen)mArrayListData.get(i)).getUser_photo().toString().trim().contains(".jpeg");
            if (!flag)
            {
                break MISSING_BLOCK_LABEL_1791;
            }
_L10:
            Picasso.with(ConversationInteraksiActivity.this).load(((ItemInteraksiKomen)mArrayListData.get(i)).getUser_photo().toString().trim()).into(img_kom_picture, new Callback() {
...
_L11:
            ...
            try
            {
                ...
                {
                    void1 = ConversationInteraksiActivity.this;
                    void1.removeIndex = ((ConversationInteraksiActivity) (void1)).removeIndex + 3;
                    Log.e("removeIndexBef", String.valueOf((new StringBuilder(String.valueOf(removeStartOld))).append(",").append(removeIndex).toString()));
                    void1 = ConversationInteraksiActivity.this;
                    void1.removeStartOld = ((ConversationInteraksiActivity) (void1)).removeStartOld + 3;
...
_L13:
            if (((ItemInteraksiKomen)mArrayListData.get(i)).getUser_photo().trim().contains(".jpg") || ((ItemInteraksiKomen)mArrayListData.get(i)).getUser_photo().toString().trim().contains(".png")) goto _L10; else goto _L9
_L9:
            flag = ((ItemInteraksiKomen)mArrayListData.get(i)).getUser_photo().toString().trim().contains(".jpeg");
            if (!flag)
            {
...
_L14:
                ...
                public void onClick(View view)
                {
                    ...
                    } else
                    {
                        ...
                        view.setPositiveButton("Tutup", new android.content.DialogInterface.OnClickListener() {
                            ...
                            final KomentarOldAsycTask._cls7 this$2;
            ...
            {
                this$2 = KomentarOldAsycTask._cls7.this;
                super();
            }
                        });
                        view.setNeutralButton("Register", new android.content.DialogInterface.OnClickListener() {
...
_L14:
                ...
                public void onClick(View view)
                {
                    ...
                    } else
                    {
                        ...
                        view.setPositiveButton("Tutup", new android.content.DialogInterface.OnClickListener() {
                            ...
                            final KomentarReplyAsycTask._cls6 this$2;
            ...
            {
                this$2 = KomentarReplyAsycTask._cls6.this;
                super();
            }
                        });
                        view.setNeutralButton("Register", new android.content.DialogInterface.OnClickListener() {
...
_L1:
    ...
    public ConversationInteraksiActivity()
    {
        urlKomen = "";
        urlKomenOld = "";
        urlKomenLast = "";
    ...
    public void KomentarNextAsycTask()
    {
        if (mLinearListView.getChildCount() == 0)
        {
            try
            {
                urlKomen = (new StringBuilder(String.valueOf(Util.BASE_PATH2))).append("conversation_interaksi").append(Utility.BASE_FORMAT).append("?type=").append(type_art).append("&tag=").append(tag_art).append("&t=").append(t).append("&id_usr=").append(user_id).append("&sortkom=").append(sortkom).toString();
...
_L2:
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        bundle.setText("Interaksi Conversation");
        bundle.setEllipsize(android.text.TextUtils.TruncateAt.MARQUEE);
        getSupportActionBar().setTitle(Html.fromHtml("<font color='#FFFFFF'>Interaksi Conversation</font>"));
        ...
        try
        {
            ...
            bundle.setScreenName("Interaksi Conversation");
