...
class this._cls0
    implements android.view.tionDetailActivity._cls8
{
    ...
    {
        view = new android.app.stener(ConversationDetailActivity.this);
        view.e("Laporkan konten ini karena tidak sesuai atau mengandung SARA?");
        view.veButton("Ya", new android.content.DialogInterface.OnClickListener() {
        ...
        view.veButton("Batal", new android.content.DialogInterface.OnClickListener() {
