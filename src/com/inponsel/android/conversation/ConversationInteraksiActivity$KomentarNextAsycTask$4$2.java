...
class this._cls2
    implements android.content.rNextAsycTask._cls4._cls2
{
    ...
    // Unreferenced inner class com/inponsel/android/conversation/ConversationInteraksiActivity$KomentarNextAsycTask$4

/* anonymous class */
    class ConversationInteraksiActivity.KomentarNextAsycTask._cls4
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                ConversationInteraksiActivity.KomentarNextAsycTask.access$2(ConversationInteraksiActivity.KomentarNextAsycTask.this).statuslike = "0";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new ConversationInteraksiActivity.KomentarNextAsycTask._cls4._cls1());
                view.setNeutralButton("Register", new ConversationInteraksiActivity.KomentarNextAsycTask._cls4._cls2());
                view.setNegativeButton("Login", new ConversationInteraksiActivity.KomentarNextAsycTask._cls4._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/conversation/ConversationInteraksiActivity$KomentarNextAsycTask$4$1

/* anonymous class */
        class ConversationInteraksiActivity.KomentarNextAsycTask._cls4._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final ConversationInteraksiActivity.KomentarNextAsycTask._cls4 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = ConversationInteraksiActivity.KomentarNextAsycTask._cls4.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/conversation/ConversationInteraksiActivity$KomentarNextAsycTask$4$3

/* anonymous class */
        class ConversationInteraksiActivity.KomentarNextAsycTask._cls4._cls3
            implements android.content.DialogInterface.OnClickListener
        {
