    ...
    implements android.content.entarAsycTask._cls7._cls2
{
    ...
    // Unreferenced inner class com/inponsel/android/conversation/ConversationDetailActivity$KomentarAsycTask$7

/* anonymous class */
    class ConversationDetailActivity.KomentarAsycTask._cls7
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new ConversationDetailActivity.KomentarAsycTask._cls7._cls1());
                view.setNeutralButton("Register", new ConversationDetailActivity.KomentarAsycTask._cls7._cls2());
                view.setNegativeButton("Login", new ConversationDetailActivity.KomentarAsycTask._cls7._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/conversation/ConversationDetailActivity$KomentarAsycTask$7$1

/* anonymous class */
        class ConversationDetailActivity.KomentarAsycTask._cls7._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final ConversationDetailActivity.KomentarAsycTask._cls7 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = ConversationDetailActivity.KomentarAsycTask._cls7.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/conversation/ConversationDetailActivity$KomentarAsycTask$7$3

/* anonymous class */
        class ConversationDetailActivity.KomentarAsycTask._cls7._cls3
            implements android.content.DialogInterface.OnClickListener
        {
