    ...
    implements android.view.y.KomentarAsycTask._cls7
{
    ...
    public void onClick(View view)
    {
        if (cess._mth2(this._cls1.this).userFunctions.isUserLoggedIn(cess._mth2(this._cls1.this)))
        {
            ...
            cess._mth2(this._cls1.this).startActivityForResult(view, ConversationDetailActivity.access$6());
            return;
        } else
        {
            view = new android.app.ty.access._cls6(cess._mth2(this._cls1.this));
