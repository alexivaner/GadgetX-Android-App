...
_L1:
        ...
        Log.e("mArrayListDataold", String.valueOf(ConversationInteraksiActivity.access$1(ConversationInteraksiActivity.this).size()));
        i = 0;
_L11:
        if (i < ConversationInteraksiActivity.access$1(ConversationInteraksiActivity.this).size()) goto _L4; else goto _L3
_L3:
...
_L15:
        txtbtnheader.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            {
                this$1 = ConversationInteraksiActivity.KomentarNextAsycTask.this;
                super();
            }
        });
        txtbtnfooter.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                try
                {
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= 11)
                    {
                        (new ConversationInteraksiActivity.KomentarNextAsycTask()).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
                        return;
                    }
                }
                // Misplaced declaration of an exception variable
                ...
                (new ConversationInteraksiActivity.KomentarNextAsycTask()).execute(new String[0]);
                return;
            }
...
_L4:
        ...
        ((ItemInteraksiKomen)ConversationInteraksiActivity.access$1(ConversationInteraksiActivity.this).get(i)).getId_user();
        ...
        if (!((ItemInteraksiKomen)ConversationInteraksiActivity.access$1(ConversationInteraksiActivity.this).get(i)).getUser_name_to().toString().trim().equals("-") && !((ItemInteraksiKomen)ConversationInteraksiActivity.access$1(ConversationInteraksiActivity.this).get(i)).getUser_name_to().toString().trim().equals("")) goto _L6; else goto _L5
_L5:
        lay_quote.setVisibility(8);
_L12:
        if (!((ItemInteraksiKomen)ConversationInteraksiActivity.access$1(ConversationInteraksiActivity.this).get(i)).getMy_like_kom().toString().equals("1")) goto _L8; else goto _L7
_L7:
...
_L13:
        if (((ItemInteraksiKomen)ConversationInteraksiActivity.access$1(ConversationInteraksiActivity.this).get(i)).getUser_photo().trim().contains(".jpg") || ((ItemInteraksiKomen)ConversationInteraksiActivity.access$1(ConversationInteraksiActivity.this).get(i)).getUser_photo().toString().trim().contains(".png")) goto _L10; else goto _L9
_L9:
...
_L14:
        ...
        txtKomentar.setMovementMethod(com.inponsel.android.widget.Instance());
        ...
        txtKomentarQoute.setMovementMethod(com.inponsel.android.widget.Instance());
...
_L2:
    ...
    protected void onPreExecute()
    {
        ...
        Log.e("mArrayListDataNext", String.valueOf(ConversationInteraksiActivity.access$1(ConversationInteraksiActivity.this).size()));
