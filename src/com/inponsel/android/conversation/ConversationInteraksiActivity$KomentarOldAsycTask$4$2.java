...
class this._cls2
    implements android.content.arOldAsycTask._cls4._cls2
{
    ...
    // Unreferenced inner class com/inponsel/android/conversation/ConversationInteraksiActivity$KomentarOldAsycTask$4

/* anonymous class */
    class ConversationInteraksiActivity.KomentarOldAsycTask._cls4
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                ConversationInteraksiActivity.KomentarOldAsycTask.access$2(ConversationInteraksiActivity.KomentarOldAsycTask.this).statuslike = "1";
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new ConversationInteraksiActivity.KomentarOldAsycTask._cls4._cls1());
                view.setNeutralButton("Register", new ConversationInteraksiActivity.KomentarOldAsycTask._cls4._cls2());
                view.setNegativeButton("Login", new ConversationInteraksiActivity.KomentarOldAsycTask._cls4._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/conversation/ConversationInteraksiActivity$KomentarOldAsycTask$4$1

/* anonymous class */
        class ConversationInteraksiActivity.KomentarOldAsycTask._cls4._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final ConversationInteraksiActivity.KomentarOldAsycTask._cls4 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = ConversationInteraksiActivity.KomentarOldAsycTask._cls4.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/conversation/ConversationInteraksiActivity$KomentarOldAsycTask$4$3

/* anonymous class */
        class ConversationInteraksiActivity.KomentarOldAsycTask._cls4._cls3
            implements android.content.DialogInterface.OnClickListener
        {
