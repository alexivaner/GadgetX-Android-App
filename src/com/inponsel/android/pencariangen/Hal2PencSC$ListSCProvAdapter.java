...
public class t extends BaseAdapter
{
    ...
    public View getView(final int position, View view, final ViewGroup holder)
    {
        ...
        if (lm != null)
        {
            ...
            Picasso.with(activity).load(lms.getSc_logo().trim()).tag(activity).into(((ViewHolder) (holder)).imageHp, new Callback() {
    ...
    public _cls4.val.position(Activity activity1, int i, ArrayList arraylist)
    {
