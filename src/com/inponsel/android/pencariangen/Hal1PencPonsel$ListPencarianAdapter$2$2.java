...
class this._cls2
    implements android.content.carianAdapter._cls2._cls2
{
    ...
    // Unreferenced inner class com/inponsel/android/pencariangen/Hal1PencPonsel$ListPencarianAdapter$2

/* anonymous class */
    class Hal1PencPonsel.ListPencarianAdapter._cls2
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            } else
            {
                ...
                view.setPositiveButton("Tutup", new Hal1PencPonsel.ListPencarianAdapter._cls2._cls1());
                view.setNeutralButton("Register", new Hal1PencPonsel.ListPencarianAdapter._cls2._cls2());
                view.setNegativeButton("Login", new Hal1PencPonsel.ListPencarianAdapter._cls2._cls3());
                view.show();
                return;
            }
        }
        ...
        // Unreferenced inner class com/inponsel/android/pencariangen/Hal1PencPonsel$ListPencarianAdapter$2$1

/* anonymous class */
        class Hal1PencPonsel.ListPencarianAdapter._cls2._cls1
            implements android.content.DialogInterface.OnClickListener
        {

            final Hal1PencPonsel.ListPencarianAdapter._cls2 this$2;
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface.dismiss();
                    ...
                    {
                        this$2 = Hal1PencPonsel.ListPencarianAdapter._cls2.this;
                        super();
                    }
        }


        // Unreferenced inner class com/inponsel/android/pencariangen/Hal1PencPonsel$ListPencarianAdapter$2$3

/* anonymous class */
        class Hal1PencPonsel.ListPencarianAdapter._cls2._cls3
            implements android.content.DialogInterface.OnClickListener
        {
            ...
            public void onClick(DialogInterface dialoginterface, int i)
            {
                dialoginterface = new Intent(Hal1PencPonsel.ListPencarianAdapter.access$0(this$1), com/inponsel/android/v2/LoginActivity);
