    ...
    implements Parcelable
{
    ...
    public static void createFromNativeLinkingIntent(Intent intent, String s, AccessTokenCreationCallback accesstokencreationcallback)
    {
        ...
        String s1 = intent.getString("user_id");
        if (s1 == null || s1.isEmpty())
        {
            Utility.getGraphMeRequestWithCacheAsync(intent.getString("access_token"), new com.facebook.internal.Utility.GraphMeRequestWithCacheCallback(intent, accesstokencreationcallback, s) {
