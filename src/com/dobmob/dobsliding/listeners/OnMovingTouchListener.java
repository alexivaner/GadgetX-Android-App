...
public class OnMovingTouchListener
...
_L4:
        slidingLayoutParams.topMargin = (int)f - slidingParent.getHeight();
        slidingParent.setLayoutParams(slidingLayoutParams);
        continue; /* Loop/switch isn't completed */
_L3:
        if (f > vSlidingMenuController.getJumpLine())
        {
            vSlidingMenuController.animateSliding((int)f, slidingParent.getHeight());
        } else
        {
