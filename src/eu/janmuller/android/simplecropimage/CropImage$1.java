...
_L1:
                CropImage.access$0(this$0).invalidate();
                if (CropImage.access$0(this$0).mHighlightViews.size() == 1)
                {
                    mCrop = (HighlightView)CropImage.access$0(this$0).mHighlightViews.get(0);
                    mCrop.setFocus(true);
                }
                if (mNumFaces > 1)
                {
...
_L2:
    ...
    _cls1.this._cls1()
    {
        ...
        super();
        mScale = 1.0F;
        mFaces = new android.media..Face[3];
    }
}
