    ...
    implements IDisposable
{
    public static final class DisplayType extends Enum
    {
        ...
        private static final DisplayType ENUM$VALUES[];
        ...
        {
            DisplayType adisplaytype[] = ENUM$VALUES;
            int i = adisplaytype.length;
            DisplayType adisplaytype1[] = new DisplayType[i];
            System.arraycopy(adisplaytype, 0, adisplaytype1, 0, i);
            return adisplaytype1;
        }
    ...
    protected float computeMaxZoom()
    {
        ...
        {
            return Math.max((float)drawable.getIntrinsicWidth() / (float)mThisWidth, (float)drawable.getIntrinsicHeight() / (float)mThisHeight) * 3F;
        }
    }
...
_L8:
    ...
    public void printMatrix(Matrix matrix)
    {
        ...
        Log.d("ImageViewTouchBase", (new StringBuilder("matrix: { x: ")).append(f2).append(", y: ").append(f3).append(", scalex: ").append(f).append(", scaley: ").append(f1).append(" }").toString());
    }
...
label0:
    ...
    protected void updateRect(RectF rectf, RectF rectf1)
    {
        if (rectf != null)
        {
            ...
            if (rectf.left >= 0.0F && rectf.right <= (float)mThisWidth)
            {
                rectf1.left = 0.0F;
            }
            ...
            if (rectf.bottom + rectf1.top <= (float)(mThisHeight + 0) && rectf.top < 0.0F)
            {
            ...
            if (rectf.right + rectf1.left <= (float)(mThisWidth + 0))
            {
