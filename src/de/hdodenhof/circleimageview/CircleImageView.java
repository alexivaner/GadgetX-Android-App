...
public class CircleImageView extends ImageView
{
    ...
    public CircleImageView(Context context, AttributeSet attributeset, int i)
    {
        ...
        mBorderWidth = context.getDimensionPixelSize(R.styleable.CircleImageView_border_width, 0);
        mBorderColor = context.getColor(R.styleable.CircleImageView_border_color, 0xff000000);
        context.recycle();
        init();
    }
